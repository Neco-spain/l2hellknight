    ...
    protected void onEvtDead(Creature killer) {
        ...
        if (killer != null) {
            if (i_ai2 == 0)
                ...
                actor.broadcastPacket(new MagicSkillUse(actor, actor, 0, s_display_jackpot_firework.getId(), 1, s_display_jackpot_firework.getHitTime(), 0, s_display_jackpot_firework.getReuseGroupId()));
