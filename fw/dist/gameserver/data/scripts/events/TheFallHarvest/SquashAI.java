        ...
        switch (_tryCount) {
            case 0:
                ...
                if (Rnd.chance(50)) {
                    ...
                    actor.broadcastPacket(new MagicSkillUse(actor, actor, 0, Squash_Level_up, 1, NECTAR_REUSE, 0, -1));
                } else {
                    Functions.npcSay(actor, textFail0[Rnd.get(textFail0.length)]);
                    actor.broadcastPacket(new MagicSkillUse(actor, actor, 0, Squash_Poisoned, 1, NECTAR_REUSE, 0, -1));
                }
                break;
            case 1:
