            ...
            try {
                switch (_taskId) {
                    ...
                    case 15:
                        ...
                        frintezza.broadcastPacket(new MagicSkillUse(frintezza, frintezza, 0, 5006, 1, 34000, 0, -1));
                    ...
                    case 18:
                        ...
                        weakScarlet.broadcastPacket(new MagicSkillUse(weakScarlet, weakScarlet, 0, 5016, 1, 3000, 0, -1));
    ...
    private class Music extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            ...
            if (!frintezza.isBlocked()) {
                ...
                frintezza.broadcastPacket(new MagicSkillUse(frintezza, frintezza, 0, 5007, song, _intervalOfFrintezzaSongs, 0, -1));
