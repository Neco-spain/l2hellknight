    ...
    public static class TaskAfterDead extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            ...
            if (_actor != null && _actor.getNpcId() == FANTASY_MUSHROOM) {
                _actor.broadcastPacket(new MagicSkillUse(_actor, _actor, 0, _skill.getId(), _skill.getLevel(), 0, 0, -1));
            ...
            if (_killer != null && _killer.isPlayer() && !_killer.isDead()) {
                ...
                targets.add(_killer);
                _killer.broadcastPacket(new MagicSkillUse(_killer, _killer, 0, _skill.getId(), _skill.getLevel(), 0, 0, -1));
