...
public class Config {
    ...
    public static final String COMMUNITY_CONFIGURATION_FILE = "config/CommunityBoard.properties";
    ...
    /**
     * Second authenticftion on char select screen
     */
    ...
    /**
     * Alternative gameing - loss of EXP on death
     */
    ...
    public static void loadCommunityConfig() {
        ...
        COMMUNITYBOARD_ENABLED = communitySettings.getProperty("AllowCommunityBoard", true);
        BBS_DEFAULT = communitySettings.getProperty("BBSDefault", "_bbshome");

        CB_PLAYER_IN_COMBAT = communitySettings.getProperty("PlayerInCombat", false);
        CB_PLAYER_ON_EVENT = communitySettings.getProperty("PlayerOnEvent", false);
        CB_PLAYER_ON_OLYMPIAD = communitySettings.getProperty("PlayerOnOlympiad", false);
        ALLOW_CB_SERVICES = communitySettings.getProperty("AllowCBServices", true);
        ALLOW_CB_BUFFER = communitySettings.getProperty("AllowCBBuffer", true);
        ALLOW_CB_BUFFER_IN_INSTANCE = communitySettings.getProperty("AllowCBBufferInInstance", false);
        ALLOW_CB_BUFFER_ON_SIEGE = communitySettings.getProperty("AllowCBBufferOnSiege", true);
        CB_BUFFER_PRICE_ITEM = communitySettings.getProperty("CBBufferPriceItem", 57);
        CB_BUFFER_PRICE = communitySettings.getProperty("CBBufferPrice", 1000);
        CB_BUFFER_BUFF_TIME = communitySettings.getProperty("CBBufferBuffTime", 60) * 60 * 1000;
        ALLOW_CB_SHOP = communitySettings.getProperty("AllowCBShop", true);
    }
