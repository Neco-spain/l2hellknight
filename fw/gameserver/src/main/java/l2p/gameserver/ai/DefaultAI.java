...
public class DefaultAI extends CharacterAI {
    ...
    @Deprecated
    /*
    *   TODO: Разобрать на два метода. Первый checkAggression(Creature) - проверяет, можно ли сагриться на цель
    *   TODO: Второй doAggression(Creature) - инициализирует атаку на цель
    */
    ...
    @Deprecated
    /*
    * TODO: Разделить на два метода. Первый будет очищать перемененные, и устанавливать аи в дефолтное положение
    * TODO: Второй, returnHome(boolean, boolean) - будет выполнять операцию по возвращению на точку спауна.
    * */
    protected void returnHome(boolean clearAggro, boolean teleport) {
        ...
        if (teleport) {
            actor.broadcastPacketToOthers(new MagicSkillUse(actor, actor, 0, 2036, 1, 500, 0, -1));
