...
public class CommissionShopManager {
    ...
    public void registerItem(Player player, int objectId, String item_name, long price, long count, int sale_days) {
        ...
        try {
            ...
            CommissionShopDAO.getInstance().saveNewItem(cItem.getObjectId(), player.getObjectId(), item_name, price, cItem.getTemplate().getExItemType(),
                    sale_days, System.currentTimeMillis() + days * 86400000, player.getName());
