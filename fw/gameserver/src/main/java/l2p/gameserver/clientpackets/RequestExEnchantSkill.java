...
public class RequestExEnchantSkill extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (Rnd.chance(rate)) {
            ...
            activeChar.sendPacket(new SystemMessage(SystemMessage.SP_HAS_DECREASED_BY_S1).addNumber(requiredSp), new SystemMessage(SystemMessage.SUCCEEDED_IN_ENCHANTING_SKILL_S1).addSkillName(_skillId, _skillLvl));
