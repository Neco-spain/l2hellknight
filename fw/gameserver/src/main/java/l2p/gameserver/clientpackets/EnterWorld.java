...
public class EnterWorld extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (!first) {
            if (activeChar.isCastingNow()) {
                ...
                if (castingSkill != null && castingTarget != null && castingTarget.isCreature() && activeChar.getAnimationEndTime() > 0)
                    sendPacket(new MagicSkillUse(activeChar, castingTarget, 0, castingSkill.getId(), castingSkill.getLevel(), (int) (animationEndTime - System.currentTimeMillis()), 0, castingSkill.getReuseGroupId()));
            }
        ...
        /*
        activeChar.sendPacket(new ExChangeMPCost(1, -3));// TODO: Unknown params
        activeChar.sendPacket(new ExChangeMPCost(1, -5));// TODO: Unknown params
        activeChar.sendPacket(new ExChangeMPCost(0, 20));// TODO: Unknown params
        activeChar.sendPacket(new ExChangeMPCost(1, -10));// TODO: Unknown params
        activeChar.sendPacket(new ExChangeMPCost(3, -20));// TODO: Unknown params
        activeChar.sendPacket(new ExChangeMPCost(22, -20));// TODO: Unknown params
        */
