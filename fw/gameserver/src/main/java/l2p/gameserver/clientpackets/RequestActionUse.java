...
public class RequestActionUse extends L2GameClientPacket {
    ...
    public static enum Action {
        ...
        ACTION1103(1103, 1, 0, 0), // Пассивность. Пет не реагирует на атаки врагов
        ACTION1104(1104, 1, 0, 0), // Защита. Пет отвечает, если атакован он или хозяин
        ...
        ACTION1114(1114, 2, 10052, 0),// Lion's Claw
        ACTION1115(1115, 2, 10053, 0),// Lion's Dash
        ACTION1116(1116, 2, 10054, 0),// Lion's Red Flame

        ACTION1117(1117, 1, 0, 0),// Thunder Flight
        ACTION1118(1118, 1, 0, 0),// Thunder Purity
        ACTION1120(1120, 1, 0, 0),// Thunder Feather
        ACTION1121(1121, 1, 0, 0),// Thunder Sharp Claw
            ...
            case PLAYER_ACTION: // Действия игроков
                switch (action.id) {
                    ...
                    case 85:
                        ...
                        break;
                    case 86:
                        boolean searchParty = FindPartyManager.isSearchParty(activeChar);
                        if (searchParty) {
