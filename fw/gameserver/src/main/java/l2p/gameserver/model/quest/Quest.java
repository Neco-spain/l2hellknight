...
import l2p.gameserver.model.quest.startcondition.impl.ClassLevelCondition;
import l2p.gameserver.model.quest.startcondition.impl.PlayerLevelCondition;
import l2p.gameserver.model.quest.startcondition.impl.QuestCompletedCondition;
...
public class Quest {
    ...
    /**
     * Добавляет нпц масив для слушателя при их убийстве, и обновлении пакетом {@link l2p.gameserver.serverpackets.ExQuestNpcLogList}
     *
     * @param cond
     * @param varName
     * @param killIds
