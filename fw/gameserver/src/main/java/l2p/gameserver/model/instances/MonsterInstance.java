...
public class MonsterInstance extends NpcInstance {
    ...
    private double[] calculateExpAndSp(int level, long damage) {
        ...
        //При охоте персонажами 85+ уровня на монстров выше уровнем на 3 и более, на персонажа налагается штраф пропорционально разнице в уровнях.
        if (level > 84 && diff < -2) {
        ...
        //Персонаж не будет получать опыт, при охоте на монстров, уровень которых ниже уровня персонажа на 11 и более.
        if (diff > 10)
            xp = 0.;
