...
public enum ClassId {
    ...
    dummyEntry35(137, false, null, null, null, 0, null),
    dummyEntry36(138, false, null, null, null, 0, null),

    /**
     * 4 profession
     */
    sigelKnight(139, false, null, null, null, 5, null),
    tyrrWarrior(140, false, null, null, null, 5, null),
    othellRogue(141, false, null, null, null, 5, null),
    yulArcher(142, false, null, null, null, 5, null),

    feohWizard(143, true, null, null, null, 5, null),
    issEnchanter(144, false, null, null, null, 5, null),
    wynnSummoner(145, true, null, null, null, 5, null),
    aeoreHealer(146, true, null, null, null, 5, null);
     ...
     */
    private static final Map<ClassId,EnumSet<ClassId>> _childClasses = new HashMap<ClassId, EnumSet<ClassId>>() {{
        put(ClassId.sigelKnight, EnumSet.of(ClassId.phoenixKnight, ClassId.hellKnight, ClassId.evaTemplar, ClassId.shillienTemplar));
        put(ClassId.tyrrWarrior, EnumSet.of(ClassId.duelist, ClassId.dreadnought, ClassId.titan, ClassId.grandKhauatari, ClassId.maestro, ClassId.doombringer));
        put(ClassId.othellRogue, EnumSet.of(ClassId.adventurer, ClassId.windRider, ClassId.ghostHunter, ClassId.fortuneSeeker));
        put(ClassId.yulArcher, EnumSet.of(ClassId.sagittarius, ClassId.moonlightSentinel, ClassId.ghostSentinel, ClassId.trickster));
        put(ClassId.feohWizard, EnumSet.of(ClassId.archmage, ClassId.soultaker, ClassId.mysticMuse, ClassId.stormScreamer, ClassId.maleSoulhound, ClassId.femaleSoulhound));
        put(ClassId.issEnchanter, EnumSet.of(ClassId.hierophant, ClassId.swordMuse, ClassId.spectralDancer, ClassId.dominator, ClassId.doomcryer, ClassId.judicator));
        put(ClassId.wynnSummoner, EnumSet.of(ClassId.arcanaLord, ClassId.elementalMaster, ClassId.spectralMaster));
        put(ClassId.aeoreHealer, EnumSet.of(ClassId.cardinal, ClassId.evaSaint, ClassId.shillienSaint));
    }};
