...
public class Reflection {
    ...
    public void onPlayerEnter(Player player) {
        ...
        // Выключение автоподбора группы, если включен
        if (FindPartyManager.isSearchParty(player))
            FindPartyManager.searchPartyOff(player);
    }
    ...
    public void onPlayerExit(Player player) {
        ...
        // Включение автоподбора группы, если выключено
        if (!FindPartyManager.isSearchParty(player))
            FindPartyManager.searchPartyOn(player);
    }
