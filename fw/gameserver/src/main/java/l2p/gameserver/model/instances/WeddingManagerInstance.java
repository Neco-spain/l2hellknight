...
public class WeddingManagerInstance extends NpcInstance {
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        } else if (player.isMaried()) // already married ?
        {
            ...
            //wedding march
            player.broadcastPacket(new MagicSkillUse(player, player, 0, 2230, 1, 1, 0, -1));
            ptarget.broadcastPacket(new MagicSkillUse(ptarget, ptarget, 0, 2230, 1, 1, 0, -1));

            // fireworks
            player.broadcastPacket(new MagicSkillUse(player, player, 0, 2025, 1, 1, 0, -1));
            ptarget.broadcastPacket(new MagicSkillUse(ptarget, ptarget, 0, 2025, 1, 1, 0, -1));
