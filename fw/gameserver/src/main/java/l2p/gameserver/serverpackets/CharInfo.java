...
public class CharInfo extends L2GameServerPacket {
    ...
    private int curHP, maxHP, curMP, maxMP;
    ...
    public CharInfo(Creature cha) {
        ...
        maccuracy = player.getMAccuracy(null);
    ...
    protected final void writeImpl() {
        ...
        writeD(0x00);// Unknown5 (GOD)
        writeC(0x00);// Unknown6 (GOD)
    }
