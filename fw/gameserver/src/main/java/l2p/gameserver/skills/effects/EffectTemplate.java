...
public final class EffectTemplate extends StatTemplate {
    ...
    public EffectTemplate(StatsSet set) {
        ...
        _abnormalEffect = set.getEnum("abnormal", AbnormalEffect.class, AbnormalEffect.NULL);
        _abnormalEffect2 = set.getEnum("abnormal2", AbnormalEffect.class, AbnormalEffect.NULL);
        _abnormalEffect3 = set.getEnum("abnormal3", AbnormalEffect.class, AbnormalEffect.NULL);
        ...
        _alterData = set.getInteger("alterData", 0);
        _paramSet = set;
    }
