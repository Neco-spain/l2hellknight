...
import static l2rt.gameserver.model.L2Zone.ZoneType.no_restart;
import static l2rt.gameserver.model.L2Zone.ZoneType.no_summon;
...
public class Wedding implements IVoicedCommandHandler, ScriptFile
{
	...
	public boolean goToLove(L2Player activeChar)
	{
		...
		if(partner.isInOlympiadMode() || activeChar.isMovementDisabled() || activeChar.isPMuted() || activeChar.isInOlympiadMode() || activeChar.getDuel() != null || partner.isInZone(no_summon))
		{
