...
public class TvTArena3 extends TvTTemplate
{
	...
	public void onLoad()
	{
		...
		{
			spawnEventManagers();
			System.out.println("Loaded Event: TvT Arena 3 [state: activated]");
		}
		if(!isActive())
			System.out.println("Loaded Event: TvT Arena 3 [state: deactivated]");
	...
	private GArray<L2NpcInstance> _spawns = new GArray<L2NpcInstance>();
