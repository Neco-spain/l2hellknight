...
public class _642_APowerfulPrimevalCreature extends Quest implements ScriptFile
{
	...
	private static int[] Rewards2 = {9967,9968,9969,9970,9971,9972,9973,9974,9975};
	// Quest Items
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("dindin_q0642_10.htm") && _state == STARTED && Config.ALT_100_RECIPES_A)
