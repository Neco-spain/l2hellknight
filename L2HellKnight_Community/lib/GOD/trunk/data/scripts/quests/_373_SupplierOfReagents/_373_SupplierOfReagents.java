...
import quests._235_MimirsElixir._235_MimirsElixir;
...
public class _373_SupplierOfReagents extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = { { 1, 0, Crendion, 0, QUICKSILVER, 0, 38, 1 },
			{ 1, 0, Crendion, 0, ROTTEN_BONE, 0, 62, 1 }, { 1, 0, LavaWyrm, 0, WYRMS_BLOOD, 0, 50, 1 },
			{ 1, 0, LavaWyrm, 0, LAVA_STONE, 0, 25, 1 }, { 1, 0, HallatesGuardian, 0, DEMONS_BLOOD, 0, 73, 1 },
			{ 1, 0, HallatesGuardian, 0, MOONSTONE_SHARD, 0, 11, 1 }, { 1, 0, HamesOrcShaman, 0, REAGENT_POUCH3, 0, 47, 1 },
			{ 1, 0, PlatinumTribeShaman, 0, REAGENT_POUCH2, 0, 68, 1 },
			{ 1, 0, PlatinumTribeShaman, 0, QUICKSILVER, 0, 32, 1 },
			{ 1, 0, PlatinumGuardianShaman, 0, REAGENT_BOX, 0, 44, 1 }, { 1, 0, HallatesMaid, 0, VOLCANIC_ASH, 0, 18, 1 },
	...
	private static final Object[][] ITEMS = {
			...
			{ 2464, "armor_t66_g_i00", "Avadon Gloves", "Gloves" }, { 554, "armor_t64_b_i00", "Zubei's Boots", "Boots" },
			{ 600, "armor_t66_b_i00", "Avadon Boots", "Boots" }, { 601, "armor_t68_b_i00", "Blue Wolf Boots", "Boots" },
			{ 2439, "armor_t71_b_i00", "Boots of Doom", "Boots" }, { 2475, "armor_t68_g_i00", "Blue Wolf Gloves", "Gloves" },
			{ 2487, "armor_t71_g_i00", "Doom Gloves", "Gloves" }, { 6011, "etc_reagent_red_i00", "Wyrm's Blood", "" },
	...
	private static final int[][] FORMULAS = { { DRACOPLASM, WYRMS_BLOOD, 10, BLOOD_ROOT, 1 },
			{ MAGMA_DUST, LAVA_STONE, 10, VOLCANIC_ASH, 1 }, { MOON_DUST, MOONSTONE_SHARD, 10, VOLCANIC_ASH, 1 },
			{ NECROPLASM, ROTTEN_BONE, 10, BLOOD_ROOT, 1 }, { DEMONPLASM, DEMONS_BLOOD, 10, BLOOD_ROOT, 1 },
			{ INFERNO_DUST, INFERNIUM_ORE, 10, VOLCANIC_ASH, 1 }, { DRACONIC_ESSENCE, DRACOPLASM, 10, QUICKSILVER, 1 },
			{ FIRE_ESSENCE, MAGMA_DUST, 10, SULFUR, 1 }, { LUNARGENT, MOON_DUST, 10, QUICKSILVER, 1 },
			{ MIDNIGHT_OIL, NECROPLASM, 10, QUICKSILVER, 1 }, { DEMONIC_ESSENCE, DEMONPLASM, 10, SULFUR, 1 },
			{ ABYSS_OIL, INFERNO_DUST, 10, SULFUR, 1 }, { HELLFIRE_OIL, FIRE_ESSENCE, 1, DEMONIC_ESSENCE, 1 },
			{ NIGHTMARE_OIL, LUNARGENT, 1, MIDNIGHT_OIL, 1 }, { PURE_SILVER, LUNARGENT, 1, QUICKSILVER, 1 },
			{ MIMIRS_ELIXIR, PURE_SILVER, 1, TRUE_GOLD, 1 } };

	private static final int[][] TEMPERATURE = { { 1, 100, 1 }, { 2, 53, 2 }, { 3, 36, 3 } };
	...
	{
		L2Multisell.getInstance().parseFile(new File(Config.DATAPACK_ROOT, "data/scripts/quests/_373_SupplierOfReagents/31149.xml"));
	}
