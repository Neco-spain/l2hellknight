...
import quests._10285_MeetingSirra._10285_MeetingSirra;
...
public class _10286_ReunionWithSirra extends Quest implements ScriptFile
{
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == _rafforty)
		{
			...
			{
				case CREATED:
					QuestState _prev = st.getPlayer().getQuestState(_10285_MeetingSirra.class);
	...
	public String onFirstTalk(L2NpcInstance npc, L2Player player)
	{
		...
		QuestState _prev = player.getQuestState(_10285_MeetingSirra.class);
