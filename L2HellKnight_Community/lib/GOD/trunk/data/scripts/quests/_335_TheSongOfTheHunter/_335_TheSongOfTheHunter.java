package quests._335_TheSongOfTheHunter;
...
public class _335_TheSongOfTheHunter extends Quest implements ScriptFile
{
	...
	private static final int[] q_blood_crystal_lizardmen = { 20578, 20579, 20580, 20581, 20582, 20641, 20642, 20643,
			20644, 20645 };
	private static final int[][][] Items_1st_Circle = { { { Guardian_Basilisk_Scale }, { 40 }, { 20550, 75 } },
			{ { Karut_Weed }, { 20 }, { 20581, 50 } }, { { Hakas_Head, Jakas_Head, Markas_Head }, { 3 } },
			{ { Windsus_Aleph_Skin }, { 1 }, { Windsus_Aleph, 100 } },
			{ { Indigo_Runestone }, { 20 }, { 20563, 50 }, { 20565, 50 } }, { { Sporesea_Seed }, { 30 }, { 20555, 70 } } };
	private static final int[][][] Items_2nd_Circle = { { { Timak_Orc_Totem }, { 20 }, { 20586, 50 } },
			{ { Trisalim_Silk }, { 20 }, { 20560, 50 }, { 20561, 50 } },
			{ { Ambrosius_Fruit }, { 30 }, { 20591, 75 }, { 20597, 75 } }, { { Balefire_Crystal }, { 20 }, { 20675, 50 } },
	...
	private static final Request[] Requests1 = {
			...
			new Request(3747, 3789, 1, 20560, "A: Book of Shunaiman").addSpawn(20600, 27164, 10).addDrop(27164, 100) }; // karul_chief_orooto
			...
			if(st.getQuestItemsCount(_1st_Test_Instructions) > 0)
			{
				...
				else if(npcId == Breka_Overlord_Haka)
				{
					if(Hakas_Head_count == 0)
						st.rollAndGive(Hakas_Head, 1, 1, 1, 100, false);
				}
				else if(npcId == Breka_Overlord_Jaka)
				{
					if(Jakas_Head_count == 0)
						st.rollAndGive(Jakas_Head, 1, 1, 1, 100, false);
				}
				else if(npcId == Breka_Overlord_Marka)
				{
					if(Markas_Head_count == 0)
						st.rollAndGive(Markas_Head, 1, 1, 1, 100, false);
				}
	...
	public static class Request
	{
		...
		public final FastMap<Integer, Integer> droplist = new FastMap<Integer, Integer>();
		public final FastMap<Integer, int[]> spawnlist = new FastMap<Integer, int[]>();
