...
public class _241_PossessorOfaPreciousSoul1 extends Quest implements ScriptFile
{
	...
	public _241_PossessorOfaPreciousSoul1()
	{
		...
		addQuestItem(new int[] { LEGENG_OF_SEVENTEEN, MALRUK_SUCCUBUS_CLAW, FADED_POETRY_BOOK, ECHO_CRYSTAL, MEDICINE,
				CRIMSON_MOSS });
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 31740)
		{
			...
			else if(cond == 20 && st.getQuestItemsCount(LUNARGENT) < 5 && st.getQuestItemsCount(HELLFIRE_OIL) < 1)
