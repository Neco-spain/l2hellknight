...
public class _736_WeakenMagic extends Quest implements ScriptFile
{
	private static final List<ClassId> ClassList = Arrays.asList(new ClassId[] { ClassId.sorceror, ClassId.warlock,
			ClassId.spellsinger, ClassId.elementalSummoner, ClassId.spellhowler, ClassId.phantomSummoner, ClassId.archmage,
			ClassId.arcanaLord, ClassId.mysticMuse, ClassId.elementalMaster, ClassId.stormScreamer, ClassId.spectralMaster });

	private static final int REWARD = 10;
	private static final int RANDOM_MIN = 10;
	private static final int RANDOM_MAX = 15;
	private static final String[] Text = new String[] { "Out of MAX Wizards and Summoners you have defeated KILL.",
