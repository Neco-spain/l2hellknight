...
public class _234_FatesWhisper extends Quest implements ScriptFile
{
	...
	public _234_FatesWhisper()
	{
		...
		addQuestItem(new int[] { REIRIAS_SOUL_ORB, HALLATES_INFERNIUM_SCEPTER, KERNONS_INFERNIUM_SCEPTER,
				GOLCONDAS_INFERNIUM_SCEPTER, INFERNIUM_VARNISH, REORINS_HAMMER, REORINS_MOLD, PIPETTE_KNIFE, RED_PIPETTE_KNIFE });
	}
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		if(newweapon != 0)
		{
			...
			if(itemtotake != null)
			{
				st.getPlayer().getInventory().destroyItem(itemtotake, 1, true);
