...
public class _734_PierceThroughAShield extends Quest implements ScriptFile
{
	private static final List<ClassId> ClassList = Arrays.asList(new ClassId[] { ClassId.darkAvenger, ClassId.hellKnight,
			ClassId.paladin, ClassId.phoenixKnight, ClassId.templeKnight, ClassId.evaTemplar, ClassId.shillienKnight,
			ClassId.shillienTemplar });

	private static final int REWARD = 10;
	private static final int RANDOM_MIN = 10;
	private static final int RANDOM_MAX = 15;
	private static final String[] Text = new String[] { "Out of MAX Knights you have defeated KILL.",
