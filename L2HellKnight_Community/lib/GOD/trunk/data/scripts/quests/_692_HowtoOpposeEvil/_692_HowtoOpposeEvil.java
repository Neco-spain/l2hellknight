...
public class _692_HowtoOpposeEvil extends Quest implements ScriptFile
{
	...
	private final static int[] DESTRUCTION_MOBS = new int[] { 22536, 22537, 22538, 22539, 22540, 22541, 22542, 22543,
			22544, 22546, 22547, 22548, 22549, 22550, 22551, 22552, 22593, 22596, 22597 };

	private final static int[] IMMORTALITY_MOBS = new int[] { 22509, 22510, 22511, 22512, 22513, 22514, 22515, 22516,
			22517, 22518, 22519, 22520, 22521, 22522, 22524, 22526, 22528, 22530, 22532, 22534 };
	private final static int[] ANNIHILATION_MOBS = new int[] { 22750, 22751, 22752, 22753, 22757, 22758, 22759, 22763,
			22764, 22765 };
	...
	{
		L2Multisell.getInstance().parseFile(new File(Config.DATAPACK_ROOT, "data/scripts/quests/_692_HowtoOpposeEvil/32550.xml"));
	}
