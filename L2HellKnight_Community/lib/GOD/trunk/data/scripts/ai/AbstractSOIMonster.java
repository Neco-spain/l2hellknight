...
{
	private static final L2Skill[] skill_list1 = { SkillTable.getInstance().getInfo(5915, 1),
			SkillTable.getInstance().getInfo(5915, 2), SkillTable.getInstance().getInfo(5915, 3),
			SkillTable.getInstance().getInfo(5915, 4), SkillTable.getInstance().getInfo(5915, 5),
			SkillTable.getInstance().getInfo(5915, 6), SkillTable.getInstance().getInfo(5915, 7),
			SkillTable.getInstance().getInfo(5915, 8), SkillTable.getInstance().getInfo(5915, 9) };
	private static final L2Skill[] skill_list2 = { SkillTable.getInstance().getInfo(5916, 1),
			SkillTable.getInstance().getInfo(5916, 2), SkillTable.getInstance().getInfo(5916, 3),
			SkillTable.getInstance().getInfo(5916, 4), SkillTable.getInstance().getInfo(5916, 5),
			SkillTable.getInstance().getInfo(5916, 6), SkillTable.getInstance().getInfo(5916, 7),
			SkillTable.getInstance().getInfo(5916, 8), SkillTable.getInstance().getInfo(5916, 9) };
	private static final L2Skill[] skill_list3 = { SkillTable.getInstance().getInfo(5917, 1),
			SkillTable.getInstance().getInfo(5917, 2), SkillTable.getInstance().getInfo(5917, 3),
			SkillTable.getInstance().getInfo(5917, 4), SkillTable.getInstance().getInfo(5917, 5),
			SkillTable.getInstance().getInfo(5917, 6), SkillTable.getInstance().getInfo(5917, 7),
			SkillTable.getInstance().getInfo(5917, 8), SkillTable.getInstance().getInfo(5917, 9) };
	...
	protected void onEvtAttacked(L2Character attacker, int damage)
	{
		...
		{
			chars = true;
			NpcSay say = new NpcSay(npc, 0, messeg);
