...
import ccpGuard.commons.utils.NetList;
	...
	public static void load()
	{
		...
		if(PROTECT_ENABLE)
			try
			{
				...
				PROTECT_SERVER_TITLE_COLOR = getIntProperty(protectSettings, "ServerTitleColor", 0xFF00FF00);
				...
				PROTECT_ONLINE_PACKET_COLOR = getIntProperty(protectSettings, "OnlinePacketColor", 0xFF00FF00);
				...
				PROTECT_PING_PACKET_COLOR = getIntProperty(protectSettings, "PingPacketColor", 0xFF00FF00);
