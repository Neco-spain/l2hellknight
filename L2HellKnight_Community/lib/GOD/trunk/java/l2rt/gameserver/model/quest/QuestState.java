...
public final class QuestState
{
	...
	public float getRateQuestsDrop(boolean prof)
	{
		...
		return (prof ? Config.RATE_QUESTS_DROP_PROF : Config.RATE_QUESTS_DROP) * Bonus * ConfigSystem.getQuestDropRates(_quest);
	}
	...
	public float getRateQuestsReward()
	{
		...
		return Config.RATE_QUESTS_REWARD * Bonus * ConfigSystem.getQuestRewardRates(_quest);
	}
	...
	public void showTutorialHTML(String html)
	{
		...
		player.sendPacket(new TutorialShowHtml(text, TutorialShowHtml.NORMAL_WINDOW));
	}
