...
public class FriendsBBSManager extends BaseBBSManager
{
	...
	private void showBlockList(L2Player activeChar, int page)
	{
		...
		htmlCode.append("<td width=99><button value=\"&$993;\" action=\"bypass _blockadd_ $block\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=95 height=22 fore=\"L2UI_CT1.Button_DF_Small\"></td>");
		if(pages > 0)
		{
			String bt_prev = page > 0 ? "<button value=\"&$543;\" action=\"bypass _blocklist_" + String.valueOf(page - 1) + "_\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=80 height=25 fore=\"L2UI_CT1.Button_DF_Small\">" : "";
			String bt_next = pages > page ? "<button value=\"&$544;\" action=\"bypass _blocklist_" + String.valueOf(page + 1) + "_\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=80 height=25 fore=\"L2UI_CT1.Button_DF_Small\">" : "";
	...
	private void showFriendsList(L2Player activeChar, int page)
	{
		...
		try
		{
			...
			if(rset.next())
			{
				...
				do
				{
					...
					htmlCode.append("<td width=99 valign=top><button value=\"&$425;\" action=\"bypass _frienddel_" + friendName + "\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=75 height=22 fore=\"L2UI_CT1.Button_DF_Small\"></td>");
					htmlCode.append("</tr>");
				} while(rset.next());
				htmlCode.append("</table></td></tr></table>");
				htmlCode.append("<br><center><img src=\"L2UI.SquareWhite\" width=625 height=1></center><br><br>");
		...
		htmlCode.append("<td width=99><button value=\"&$396;\" action=\"bypass _friendadd_ $invite\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=80 height=22 fore=\"L2UI_CT1.Button_DF_Small\"></td>");
		if(pages > 0)
		{
			String bt_prev = page > 0 ? "<button value=\"&$543;\" action=\"bypass _friendlist_" + String.valueOf(page - 1) + "_\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=80 height=25 fore=\"L2UI_CT1.Button_DF_Small\">" : "";
			String bt_next = pages > page ? "<button value=\"&$544;\" action=\"bypass _friendlist_" + String.valueOf(page + 1) + "_\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=80 height=25 fore=\"L2UI_CT1.Button_DF_Small\">" : "";
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2Player activeChar)
	{
		...
		if(ar1.equals("PM"))
		{
			...
			try
			{
				...
				if(reciever == null)
				{
					htmlCode.append("Player not found!<br><button value=\"Back\" action=\"bypass _friendinfo_" + ar2 + "\" width=40 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");
				...
				if(activeChar.getNoChannel() != 0)
				{
					...
					{
						if(activeChar.getNoChannel() > 0)
							htmlCode.append("You are banned in all chats, time remained " + Math.round(activeChar.getNoChannelRemained() / 60000) + " min.<br><button value=\"Back\" action=\"bypass _friendinfo_" + reciever.getName() + "\" width=40 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");
						else
							htmlCode.append("You are banned in all chats permanently.<br><button value=\"Back\" action=\"bypass _friendinfo_" + reciever.getName() + "\" width=40 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");
						htmlCode.append("</td></tr></table></body></html>");
						separateAndSend(htmlCode.toString(), activeChar);
						return;
					}
				...
				if(!reciever.getMessageRefusal())
				{
					...
					htmlCode.append("Message Sent<br><button value=\"Back\" action=\"bypass _friendinfo_" + reciever.getName() + "\" width=40 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");
					htmlCode.append("</td></tr></table></body></html>");
					separateAndSend(htmlCode.toString(), activeChar);
				}
				else
