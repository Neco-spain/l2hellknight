...
import l2rt.gameserver.network.serverpackets.ExVariationResult;
		...
		if(isAccessoryLifeStone)
			switch(itemGrade)
			{
				...
				case R:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 500; //FIXME
					break;
				case R95:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 1000; //FIXME
					break;
				case R99:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 2000; //FIXME
					break;
			}
		else
			switch(itemGrade)
			{
				...
				case R:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 72;
					break;
				case R95:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 144;
					break;
				case R99:
					if(player.getLevel() < 84 || gemstoneItemId != GEMSTONE_B)
						return false;
					modifyGemstoneCount = 288;
					break;
			}
