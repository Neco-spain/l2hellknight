...
public class Status extends Thread
{
	...
	public Status(int mode) throws IOException
	{
		super("Status");
		_mode = mode;
		Properties telnetSettings = Config.loadPropertiesFile(l2rt.Server.PhoenixHomeDir + (_mode == Server.MODE_GAMESERVER ? Config.TELNET_FILE : Config.LOGIN_TELNET_FILE));
