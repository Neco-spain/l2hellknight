...
public class ClanCommunity extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		else if("clbbsadmi".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("scripts/services/community/bbs_clanadmin.htm", player);
		...
		else if("mailwritepledgeform".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("scripts/services/community/bbs_pledge_mail_write.htm", player);
