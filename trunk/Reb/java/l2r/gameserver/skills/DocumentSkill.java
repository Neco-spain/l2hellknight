...
public final class DocumentSkill extends DocumentBase
{
	...
	public class Skill
	{
		...
		public List<l2r.gameserver.model.Skill> skills = new ArrayList<l2r.gameserver.model.Skill>();
		public List<l2r.gameserver.model.Skill> currentSkills = new ArrayList<l2r.gameserver.model.Skill>();
	}

	private Skill currentSkill;
	private Set<String> usedTables = new HashSet<String>();
	private List<l2r.gameserver.model.Skill> skillsInFile = new LinkedList<l2r.gameserver.model.Skill>();
	...
	protected List<l2r.gameserver.model.Skill> getSkills()
	{
		return skillsInFile;
	}
	...
	protected void parseSkill(Node n)
	{
		...
		try
		{
			...
			for(int i = 0; i < lastLvl; i++)
			{
				...
				l2r.gameserver.model.Skill current = currentSkill.currentSkills.get(i);
	...
	{
		currentSkill.currentSkills = new ArrayList<l2r.gameserver.model.Skill>(currentSkill.sets.length);
