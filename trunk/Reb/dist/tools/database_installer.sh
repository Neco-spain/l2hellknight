...
echo -ne "\nPlease enter MySQL Login Server database name (default l2r): "
read LSDB
if [ -z "$LSDB" ]; then
  LSDB="l2r"
fi
...
echo ""
echo "(C) 2011-2012 Rebellion-Team"
...
echo "visit http://rebellion-team.ru for more info about"
echo "the Rebellion-Team project."
exit 0
}
