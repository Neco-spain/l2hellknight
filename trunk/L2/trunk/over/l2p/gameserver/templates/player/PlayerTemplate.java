...
public final class PlayerTemplate extends CharTemplate
{
  ...
  {
    return (LvlUpData)_lvlUpData.get(lvl);
  }

  public StartItem[] getStartItems()
  {
    return (StartItem[])_startItems.toArray(new StartItem[_startItems.size()]);
  }

  public Location getStartLocation()
  {
    return (Location)_startLocs.get(Rnd.get(_startLocs.size()));
  }
}