...
public final class EffectTemplate extends StatTemplate
{
  ...
  public EffectTemplate(StatsSet set)
  {
    ...
    _count = (set.getInteger("count", 1) < 0 ? 2147483647 : set.getInteger("count", 1));
    _period = Math.min(2147483647, 1000 * (set.getInteger("time", 1) < 0 ? 2147483647 : set.getInteger("time", 1)));
    _abnormalEffect = ((AbnormalEffect)set.getEnum("abnormal", AbnormalEffect.class));
    _abnormalEffect2 = ((AbnormalEffect)set.getEnum("abnormal2", AbnormalEffect.class));
    _abnormalEffect3 = ((AbnormalEffect)set.getEnum("abnormal3", AbnormalEffect.class));
    ...
    _effectType = ((EffectType)set.getEnum("name", EffectType.class));
    _chance = set.getInteger("chance", 2147483647);
    _paramSet = set;
  }
  ...
  {
    return _chance == 2147483647 ? val : _chance;
  }
