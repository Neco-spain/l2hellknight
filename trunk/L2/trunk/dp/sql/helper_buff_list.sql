...
(1, 4323, 'Shield', 1, 11, 38, 'false'),
(2, 4338, 'Life Cubic', 1, 16, 34, 'false'), 
(3, 4324, 'Bless the Body', 1, 12, 37, 'false'),
(4, 4325, 'Vampiric Rage', 1, 13, 36, 'false'),
(5, 4326, 'Regeneration', 1, 14, 35, 'false'),
(6, 4327, 'Haste', 1, 15, 34, 'false'),
(7, 4322, 'WindWalk', 1, 8, 39, 'true'),
(8, 4323, 'Shield', 1, 11, 38, 'true'),
(9, 4338, 'Life Cubic', 1, 16, 34, 'true'),
(10, 4328, 'Bless the Soul', 1, 12, 37, 'true'),
(11, 4329, 'Acumen', 1, 13, 36, 'true'),
(12, 4330, 'Concentration', 1, 14, 35, 'true'),
(13, 4331, 'Empower', 1, 15, 34, 'true'),
