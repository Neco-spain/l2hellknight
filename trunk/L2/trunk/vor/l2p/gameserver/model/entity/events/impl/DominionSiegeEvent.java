...
public class DominionSiegeEvent extends SiegeEvent<Dominion, SiegeClanObject>
{
  ...
  {
    DominionSiegeEvent dominionSiegeEvent = (DominionSiegeEvent)target.getEvent(DominionSiegeEvent.class);
  ...
  public int[] calculateReward(Player player)
  {
    ...
    if (out[0] > 90.0F * Config.DOMINION_WAR_REWARD_RATE)
    {
      out[0] = (int)(90.0F * Config.DOMINION_WAR_REWARD_RATE);
      out[1] = 0;
      out[2] = 450;
    }

    out[0] = (int)(out[0] * Config.DOMINION_WAR_REWARD_RATE);
    return out;
  }
