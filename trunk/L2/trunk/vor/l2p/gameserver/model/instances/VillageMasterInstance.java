...
public final class VillageMasterInstance extends NpcInstance
{
  ...
  public void levelUpClan(Player player)
  {
    ...
    case 4:
      ...
      increaseClanLevel = true; break;
    case 5:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_6) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_6))
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_6, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 6:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_7) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_7))
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_7, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 7:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_8) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_8))
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_8, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 8:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_9) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_9) || 
        (!player.getInventory().destroyItemByItemId(Config.CLAN_LVL_UP_ITEM_FOR_9, Config.CLAN_LVL_UP_ITEM_COUNT_FOR_9)))
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_9, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 9:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_10) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_10) || 
        (!player.getInventory().destroyItemByItemId(Config.CLAN_LVL_UP_ITEM_FOR_10, Config.CLAN_LVL_UP_ITEM_COUNT_FOR_10)))
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_10, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 10:
      if ((clan.getReputationScore() < Config.CLAN_REP_FOR_LEVEL_11) || (clan.getAllSize() < Config.CLAN_MEMBERS_FOR_LEVEL_11) || (clan.getCastle() <= 0))
        break;
      ...
      if (dominion.getLordObjectId() != player.getObjectId())
        break;
      clan.incReputation(-Config.CLAN_REP_FOR_LEVEL_11, false, "LvlUpClan");
