...
public class SevenSigns
{
  ...
  protected void restoreSevenSignsData()
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        _signsSealOwners.put(Integer.valueOf(1), Integer.valueOf(rs.getInt("avarice_owner")));
        _signsSealOwners.put(Integer.valueOf(2), Integer.valueOf(rs.getInt("gnosis_owner")));
        _signsSealOwners.put(Integer.valueOf(3), Integer.valueOf(rs.getInt("strife_owner")));

        _signsDawnSealTotals.put(Integer.valueOf(1), Integer.valueOf(rs.getInt("avarice_dawn_score")));
        _signsDawnSealTotals.put(Integer.valueOf(2), Integer.valueOf(rs.getInt("gnosis_dawn_score")));
        _signsDawnSealTotals.put(Integer.valueOf(3), Integer.valueOf(rs.getInt("strife_dawn_score")));
        _signsDuskSealTotals.put(Integer.valueOf(1), Integer.valueOf(rs.getInt("avarice_dusk_score")));
        _signsDuskSealTotals.put(Integer.valueOf(2), Integer.valueOf(rs.getInt("gnosis_dusk_score")));
        _signsDuskSealTotals.put(Integer.valueOf(3), Integer.valueOf(rs.getInt("strife_dusk_score")));
      }
      Close.SR(st, rs);

      st = con.prepareStatement("UPDATE seven_signs_status SET date=? WHERE id=0");
      st.setInt(1, Calendar.getInstance().get(7));
      st.execute();
    }
  ...
  public void saveSevenSignsData(L2PcInstance player, boolean updateSettings)
  {
    ...
    try
    {
      ...
      for (StatsSet sevenDat : _signsPlayerData.values())
      {
        ...
        st = con.prepareStatement("UPDATE seven_signs SET cabal=?, seal=?, red_stones=?, green_stones=?, blue_stones=?, ancient_adena_amount=?, contribution_score=? WHERE char_obj_id=?");
      ...
      if (updateSettings)
      {
        ...
        st.setInt(8, ((Integer)_signsSealOwners.get(Integer.valueOf(1))).intValue());
        st.setInt(9, ((Integer)_signsSealOwners.get(Integer.valueOf(2))).intValue());
        st.setInt(10, ((Integer)_signsSealOwners.get(Integer.valueOf(3))).intValue());
        st.setInt(11, ((Integer)_signsDawnSealTotals.get(Integer.valueOf(1))).intValue());
        st.setInt(12, ((Integer)_signsDawnSealTotals.get(Integer.valueOf(2))).intValue());
        st.setInt(13, ((Integer)_signsDawnSealTotals.get(Integer.valueOf(3))).intValue());
        st.setInt(14, ((Integer)_signsDuskSealTotals.get(Integer.valueOf(1))).intValue());
        st.setInt(15, ((Integer)_signsDuskSealTotals.get(Integer.valueOf(2))).intValue());
        st.setInt(16, ((Integer)_signsDuskSealTotals.get(Integer.valueOf(3))).intValue());
        ...
        st.setInt(23, Calendar.getInstance().get(7));
        st.execute();
      }
    }
    catch (SQLException e)
  ...
  protected void calcNewSealOwners()
  {
    for (Integer currSeal : _signsDawnSealTotals.keySet())
    {
      ...
      case 1:
        if (newSealOwner == 2) {
          sendMessageToAll(Static.DAWN_OBTAINED_AVARICE); } else {
          if (newSealOwner != 1) break;
          sendMessageToAll(Static.DUSK_OBTAINED_AVARICE); } break;
      case 2:
        if (newSealOwner == 2) {
          sendMessageToAll(Static.DAWN_OBTAINED_GNOSIS); } else {
          if (newSealOwner != 1) break;
          sendMessageToAll(Static.DUSK_OBTAINED_GNOSIS); } break;
      case 3:
        if (newSealOwner == 2)
