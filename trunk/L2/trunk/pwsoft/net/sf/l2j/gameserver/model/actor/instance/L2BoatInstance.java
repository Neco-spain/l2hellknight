...
public class L2BoatInstance extends L2Character
{
  ...
  public void moveToLocation(int x, int y, int z, float speed)
  {
    ...
    m._ticksToMove = (int)(10.0D * distance / speed);
  ...
  public void begin()
  {
    if (_cycle == 1)
    {
      FastList knownPlayers = getKnownList().getKnownPlayersInRadius(1500);
      int i;
  ...
  {
    FastList knownPlayers = getKnownList().getKnownPlayersInRadius(2500);
    CreatureSay sm;
    PlaySound ps;
    CreatureSay sm;
    CreatureSay sm;
