...
public class L2ControlTowerInstance extends L2NpcInstance
{
  ...
  {
    return (attacker != null) && (attacker.isPlayer()) && (getCastle() != null) && (getCastle().getCastleId() > 0) && (getCastle().getSiege().getIsInProgress()) && (getCastle().getSiege().checkIsAttacker(attacker.getClan()));
  }
  ...
  public void onAction(L2PcInstance player)
  {
    ...
    else if ((isAutoAttackable(player)) && (Math.abs(player.getZ() - getZ()) < 100) && (player.canSeeTarget(this)))
    {
