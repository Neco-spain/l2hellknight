  ...
  implements IAdminCommandHandler
{
  ...
  public boolean useAdminCommand(String command, L2PcInstance activeChar) {
    ...
    if (command.equals("admin_invis_menu")) {
      ...
      try {
        ...
        if (target.isL2Character()) {
          ...
          if (type.equals("1"))
            player.startAbnormalEffect(1024);
          else {
      ...
      try {
        ...
        if (target.isL2Character()) {
          player = (L2Character)target;
          player.stopAbnormalEffect(1024);
      ...
      try {
        ...
        if (target.isL2Character()) {
          player = (L2Character)target;
          player.startAbnormalEffect(8192);
        }
      } catch (Exception e) {
      }
      ...
      try {
        ...
        if (target.isL2Character()) {
          player = (L2Character)target;
          player.stopAbnormalEffect(8192);
        }
      } catch (Exception e) {
      }
    ...
    } else if (command.startsWith("admin_setteam_close")) { int teamVal;
      try { String val = st.nextToken();
        teamVal = Integer.parseInt(val);
        for (L2PcInstance player : activeChar.getKnownList().getKnownPlayers().values())
      ...
      try {
        ...
        if (st.countTokens() == 2) {
          ...
          int abnormal = Integer.decode("0x" + parm).intValue();
          target = st.nextToken();
          if (target != null) {
            L2PcInstance player = L2World.getInstance().getPlayer(target);
            if (player != null) {
          ...
          int abnormal = Integer.decode("0x" + st.nextToken()).intValue();
          if (obj == null) {
            obj = activeChar;
          }
          if (obj != null) {
      ...
      try {
        ...
        else activeChar.sendPacket(SystemMessage.id(SystemMessageId.INCORRECT_TARGET)); 
      }
      catch (Exception e)
      {
