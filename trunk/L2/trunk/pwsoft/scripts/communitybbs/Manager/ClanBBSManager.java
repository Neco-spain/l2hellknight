...
public class ClanBBSManager extends BaseBBSManager
{
  ...
  public void parsecmd(String command, L2PcInstance activeChar)
  {
    ...
    {
      separateAndSend(new StringBuilder().append("<html><body><br><br><center>Commande : ").append(command).append(" pas encore implante</center><br><br></body></html>").toString(), activeChar);
    }
  }
