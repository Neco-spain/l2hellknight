...
public class SoIManager
{
  ...
  private static Location[] openSeedTeleportLocs = { new Location(-179537, 209551, -15504), new Location(-179779, 212540, -15520), new Location(-177028, 211135, -15520), new Location(-176355, 208043, -15520), new Location(-179284, 205990, -15520), new Location(-182268, 208218, -15520), new Location(-182069, 211140, -15520), new Location(-176036, 210002, -11948), new Location(-176039, 208203, -11949), new Location(-183288, 208205, -11939), new Location(-183290, 210004, -11939), new Location(-187776, 205696, -9536), new Location(-186327, 208286, -9536), new Location(-184429, 211155, -9536), new Location(-182811, 213871, -9504), new Location(-180921, 216789, -9536), new Location(-177264, 217760, -9536), new Location(-173727, 218169, -9536) };
  ...
  public static long getOpenedTime()
  {
    if (getCurrentStage() != 3)
      return 0L;
    return ServerVariables.getLong("SoI_opened", 0L) * 1000L - System.currentTimeMillis();
  }
  ...
  {
    p.teleToLocation(openSeedTeleportLocs[l2p.commons.util.Rnd.get(openSeedTeleportLocs.length)]);
  }
}