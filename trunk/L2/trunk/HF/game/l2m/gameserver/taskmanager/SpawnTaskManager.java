        ...
        try
        {
          ...
          synchronized (spawnTasks_lock)
          {
            ...
            for (int i = size - 1; i >= 0; i--) {
              try
              {
                SpawnTaskManager.SpawnTask container = _spawnTasks[i];
                ...
                if ((container == null) || (container.getActor() == null) || (container.endtime < 0L))
                {
                  if (i == _spawnTasksSize - 1) {
                    ...
                    _spawnTasks[i] = SpawnTaskManager.access$200(SpawnTaskManager.this)[(SpawnTaskManager.access$000(SpawnTaskManager.this) - 1)];
                    _spawnTasks[(_spawnTasksSize - 1)] = null;
                  }

                  if (_spawnTasksSize > 0)
                    SpawnTaskManager.access$010(SpawnTaskManager.this);
                }
              }
              catch (Exception e)
              {
