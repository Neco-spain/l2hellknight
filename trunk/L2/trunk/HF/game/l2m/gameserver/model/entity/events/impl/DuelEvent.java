...
import l2m.gameserver.network.serverpackets.ExDuelStart;
  ...
  implements Iterable<DuelSnapshotObject>
{
  ...
  protected IStaticPacket canDuel0(Player requestor, Player target)
  {
    ...
    else if (requestor.getEvent(DuelEvent.class) != null)
      packet = new SystemMessage2(SystemMsg.C1_CANNOT_DUEL_BECAUSE_C1_IS_ALREADY_ENGAGED_IN_A_DUEL).addName(requestor);
