...
public class ResidenceFunction
{
  ...
  {
    return (TeleportLocation[])_teleports.get(Integer.valueOf(level));
  }

  public void addTeleports(int level, TeleportLocation[] teleports)
  {
    _teleports.put(Integer.valueOf(level), teleports);
  }
  ...
  {
    return ((Integer)_leases.get(Integer.valueOf(level))).intValue();
  }

  public void addLease(int level, int lease)
  {
    _leases.put(Integer.valueOf(level), Integer.valueOf(lease));
  }
  ...
  {
    return (int[])_buylists.get(Integer.valueOf(level));
  }

  public void addBuylist(int level, int[] buylist)
  {
    _buylists.put(Integer.valueOf(level), buylist);
  }
  ...
  {
    return (Object[][])_buffs.get(Integer.valueOf(level));
  }

  public void addBuffs(int level)
  {
    _buffs.put(Integer.valueOf(level), buffs_template[level]);
  }
