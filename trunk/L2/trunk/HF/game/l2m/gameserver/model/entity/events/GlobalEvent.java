...
import l2m.gameserver.listener.event.OnStartStopListener;
...
import l2m.gameserver.model.entity.events.objects.InitableObject;
import l2m.gameserver.model.entity.events.objects.SpawnableObject;
...
import l2m.gameserver.taskmanager.actionrunner.ActionRunner;
  ...
  public void giveItem(Player player, int itemId, long count)
  {
    ...
    case -300:
      if ((this instanceof CastleSiegeEvent))
        count = aConfig.get("CastleFame", 125);
      else if ((this instanceof FortressSiegeEvent))
        count = aConfig.get("FortressFame", 31);
