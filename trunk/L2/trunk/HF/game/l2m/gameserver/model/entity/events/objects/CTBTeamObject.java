...
import l2m.gameserver.model.instances.residences.clanhall.CTBBossInstance;
  ...
  implements SpawnableObject
{
  ...
  public void spawnObject(GlobalEvent event)
  {
    ...
    else if (_mob == null)
    {
      ...
      int x = (int)(_flagLoc.x + 300.0D * Math.cos(_mob.headingToRadians(_flag.getHeading() - 32768)));
      int y = (int)(_flagLoc.y + 300.0D * Math.sin(_mob.headingToRadians(_flag.getHeading() - 32768)));
