...
import l2m.gameserver.network.serverpackets.ExPVPMatchCCMyRecord;
import l2m.gameserver.network.serverpackets.ExPVPMatchCCRecord;
import l2m.gameserver.network.serverpackets.ExPVPMatchCCRetire;
...
public class KrateisCubeEvent extends GlobalEvent
{
  ...
  public void initEvent()
  {
    ...
    CharListenerList.addGlobal(_listeners);
    super.initEvent();
  }
  ...
  private class Listeners
    implements OnKillListener, OnPlayerExitListener, OnTeleportListener, OnDeathListener
  {
    private Listeners()
    {
    }
    ...
    public void onDeath(Creature actor, Creature killer)
    {
      ...
      KrateisCubePlayerObject particlePlayer = getParticlePlayer((Player)actor);
      if (particlePlayer != null)
        particlePlayer.startRessurectTask();
    }
    ...
    {
      KrateisCubeEvent cubeEvent2 = (KrateisCubeEvent)player.getEvent(KrateisCubeEvent.class);
      if (cubeEvent2 != KrateisCubeEvent.this)
      {
        return;
      }
