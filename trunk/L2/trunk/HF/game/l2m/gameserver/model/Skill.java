...
import l2m.gameserver.network.serverpackets.FlyToLocation.FlyType;
...
import l2m.gameserver.skills.skillclasses.AIeffects;
import l2m.gameserver.skills.skillclasses.Aggression;
import l2m.gameserver.skills.skillclasses.Balance;
import l2m.gameserver.skills.skillclasses.BeastFeed;
import l2m.gameserver.skills.skillclasses.BuffCharger;
import l2m.gameserver.skills.skillclasses.CPDam;
import l2m.gameserver.skills.skillclasses.Call;
import l2m.gameserver.skills.skillclasses.ChainHeal;
import l2m.gameserver.skills.skillclasses.Charge;
import l2m.gameserver.skills.skillclasses.ChargeSoul;
import l2m.gameserver.skills.skillclasses.ClanGate;
import l2m.gameserver.skills.skillclasses.CombatPointHeal;
import l2m.gameserver.skills.skillclasses.Continuous;
import l2m.gameserver.skills.skillclasses.Craft;
import l2m.gameserver.skills.skillclasses.DeathPenalty;
import l2m.gameserver.skills.skillclasses.Decoy;
import l2m.gameserver.skills.skillclasses.Default;
import l2m.gameserver.skills.skillclasses.DefuseTrap;
import l2m.gameserver.skills.skillclasses.DeleteHate;
import l2m.gameserver.skills.skillclasses.DeleteHateOfMe;
import l2m.gameserver.skills.skillclasses.DestroySummon;
import l2m.gameserver.skills.skillclasses.DetectTrap;
import l2m.gameserver.skills.skillclasses.Disablers;
import l2m.gameserver.skills.skillclasses.Drain;
import l2m.gameserver.skills.skillclasses.DrainSoul;
import l2m.gameserver.skills.skillclasses.EffectsFromSkills;
import l2m.gameserver.skills.skillclasses.EnergyReplenish;
import l2m.gameserver.skills.skillclasses.ExtractStone;
import l2m.gameserver.skills.skillclasses.FishingSkill;
import l2m.gameserver.skills.skillclasses.Harvesting;
import l2m.gameserver.skills.skillclasses.Heal;
import l2m.gameserver.skills.skillclasses.HealPercent;
import l2m.gameserver.skills.skillclasses.KamaelWeaponExchange;
import l2m.gameserver.skills.skillclasses.LethalShot;
import l2m.gameserver.skills.skillclasses.MDam;
import l2m.gameserver.skills.skillclasses.ManaDam;
import l2m.gameserver.skills.skillclasses.ManaHeal;
import l2m.gameserver.skills.skillclasses.ManaHealPercent;
import l2m.gameserver.skills.skillclasses.NegateEffects;
import l2m.gameserver.skills.skillclasses.NegateStats;
import l2m.gameserver.skills.skillclasses.PDam;
import l2m.gameserver.skills.skillclasses.PcBangPointsAdd;
import l2m.gameserver.skills.skillclasses.PetSummon;
import l2m.gameserver.skills.skillclasses.Recall;
import l2m.gameserver.skills.skillclasses.ReelingPumping;
import l2m.gameserver.skills.skillclasses.Refill;
import l2m.gameserver.skills.skillclasses.Resurrect;
import l2m.gameserver.skills.skillclasses.Ride;
import l2m.gameserver.skills.skillclasses.SPHeal;
import l2m.gameserver.skills.skillclasses.ShiftAggression;
import l2m.gameserver.skills.skillclasses.Sowing;
import l2m.gameserver.skills.skillclasses.Spoil;
import l2m.gameserver.skills.skillclasses.StealBuff;
import l2m.gameserver.skills.skillclasses.SummonItem;
import l2m.gameserver.skills.skillclasses.SummonSiegeFlag;
import l2m.gameserver.skills.skillclasses.Sweep;
import l2m.gameserver.skills.skillclasses.TakeCastle;
import l2m.gameserver.skills.skillclasses.TakeFlag;
import l2m.gameserver.skills.skillclasses.TakeFortress;
import l2m.gameserver.skills.skillclasses.TameControl;
import l2m.gameserver.skills.skillclasses.TeleportNpc;
import l2m.gameserver.skills.skillclasses.Toggle;
import l2m.gameserver.skills.skillclasses.Transformation;
import l2m.gameserver.skills.skillclasses.Unlock;
import l2m.gameserver.skills.skillclasses.VitalityHeal;
  ...
  implements Cloneable
{
  ...
  public SystemMsg checkTarget(Creature activeChar, Creature target, Creature aimingTarget, boolean forceUse, boolean first)
  {
    if (((target == activeChar) && (isNotTargetAoE())) || ((target == activeChar.getPet()) && (_targetType == SkillTargetType.TARGET_PET_AURA)))
      return null;
    if ((_skillType == SkillType.DETECT_TRAP) && (target.isTrap()))
      return null;
  ...
  private void addTargetsToList(List<Creature> targets, Creature aimingTarget, Creature activeChar, boolean forceUse)
  {
    ...
    for (Creature target : aimingTarget.getAroundCharacters(_skillRadius, 300))
    {
      ...
      if ((checkTarget(activeChar, target, aimingTarget, forceUse, false) != null) || (
        ...
        continue;
      targets.add(target);
      if ((isOffensive()) && (targets.size() >= 20) && (!activeChar.isRaid()))
        break;
    }
  }
