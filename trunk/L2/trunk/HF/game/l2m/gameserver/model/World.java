...
public class World
{
  ...
  public static boolean isSiegeZone(int x, int y, int z, Reflection reflection)
  {
    WorldRegion region = getRegion(new Location(x, y, z));
    ...
    {
      if ((zone.checkIfInZone(x, y, z, ReflectionManager.DEFAULT)) && ((zone.getType() == Zone.ZoneType.SIEGE) || (zone.getType() == Zone.ZoneType.RESIDENCE) || (zone.getType() == Zone.ZoneType.HEADQUARTER)))
        return true;
    }
    return false;
  }
