...
import l2m.gameserver.network.serverpackets.ExSubPledgeSkillAdd;
...
public class SubUnit
{
  ...
  public UnitMember getUnitMember(int obj)
  {
    ...
    return (UnitMember)_members.get(obj);
  }
  ...
  {
    UnitMember m = (UnitMember)_members.remove(objectId);
    if (m == null)
    {
      return;
    }
  ...
  public Skill addSkill(Skill newSkill, boolean store)
  {
    ...
    if (newSkill != null)
    {
      ...
      packet = new ExSubPledgeSkillAdd(_type, newSkill.getId(), newSkill.getLevel());
