package l2m.gameserver.data.htm;
...
public class HtmCache
{
  ...
  public void reload()
  {
    ...
    case 2:
      ...
      {
        Cache c = _cache[i];
        _log.info(String.format("HtmCache: parsing %d documents; lang: %s.", new Object[] { Integer.valueOf(c.getSize()), Language.VALUES[i] }));
      }
      break;
    case 1:
  ...
  private String getCache(String file, Language lang)
  {
    ...
    if (cache == null)
    {
      ...
      case 1:
        ...
        if ((cache != null) || (lang == Language.ENGLISH)) break;
        cache = loadLazy(Language.ENGLISH, file); break;
      case 0:
