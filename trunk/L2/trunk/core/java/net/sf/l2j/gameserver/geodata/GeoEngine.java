...
public class GeoEngine extends GeoData
{
  ...
  private static final Map<Short, MappedByteBuffer> _geodata = new FastMap<Short, MappedByteBuffer>();
  private static final Map<Short, IntBuffer> _geodataIndex = new FastMap<Short, IntBuffer>();
  private static BufferedOutputStream _geoBugsOut;
  private final FastMap<Integer, FastMap<Long, Byte>> _doorGeodata = new FastMap<Integer, FastMap<Long, Byte>>();
  ...
  {
    FastMap<Long, Byte> doorGeodata = (FastMap<Long, Byte>)this._doorGeodata.get(Integer.valueOf(door.getDoorId()));

    if (doorGeodata == null) {
      this._doorGeodata.put(Integer.valueOf(door.getDoorId()), doorGeodata = new FastMap<Long, Byte>());
    }
...
public void initDoorGeodata(L2DoorInstance door)
  {
    ...
    {
      label576: for (int geoY = minY; geoY <= maxY; geoY++)
      {
