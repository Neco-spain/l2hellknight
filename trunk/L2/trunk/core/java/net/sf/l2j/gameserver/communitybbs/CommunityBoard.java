...
public class CommunityBoard
{
	...
	public void handleCommands(L2GameClient client, String command)
	{
        ...
        {
        	if (activeChar.getPvpFlag()!=0 || activeChar.getKarma() > 0 || activeChar.isDead() || activeChar.isSitting() || Olympiad.getInstance().isRegisteredInComp(activeChar) || activeChar.getOlympiadGameId() > 0 || TvTEvent.isPlayerParticipant(activeChar.getObjectId()) || activeChar.isMounted() || activeChar.getActiveTradeList() != null || activeChar.isCastingNow() || activeChar.getActiveEnchantItem() != null)
        	{
