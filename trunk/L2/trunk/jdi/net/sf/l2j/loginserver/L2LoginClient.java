...
public final class L2LoginClient extends MMOClient<MMOConnection<L2LoginClient>>
{
  ...
  public boolean decrypt(ByteBuffer buf, int size)
  {
    ...
    if (!ret)
    {
      ...
      _log.warning(new StringBuilder().append("Wrong checksum from client: ").append(toString()).toString());
      closeNow();
    }
  ...
  public void onDisconnection()
  {
    if (Config.DEBUG)
    {
      _log.info(new StringBuilder().append("DISCONNECTED: ").append(toString()).toString());
    }
  ...
  public String toString()
  {
    ...
    if (getState() == LoginClientState.AUTHED_LOGIN)
    {
      return new StringBuilder().append("[").append(getAccount()).append(" (").append(address == null ? "disconnected" : address.getHostAddress()).append(")]").toString();
    }

    return new StringBuilder().append("[").append(address == null ? "disconnected" : address.getHostAddress()).append("]").toString();
  }
