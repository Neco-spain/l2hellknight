  ...
  implements IAdminCommandHandler
{
  ...
  public boolean useAdminCommand(String command, L2PcInstance activeChar)
  {
    ...
    else if (command.startsWith("admin_edit_npc "))
    {
      try
      {
        ...
        int npcId = Integer.valueOf(commandSplit[1]).intValue();
    ...
    else if (command.startsWith("admin_show_droplist "))
    {
      ...
      if ((!Config.ALT_PRIVILEGES_ADMIN) && ((!checkLevel(activeChar.getAccessLevel())) || (!activeChar.isGM())))
        return false;
      if (command.startsWith("admin_addShopItem "))
      {
        String[] args = command.split(" ");
        if (args.length > 1)
      ...
      {
        int npcId = -1; int itemId = 0; int category = -1000;
        try
        {
          ...
          else if (st.countTokens() == 6)
          {
            ...
            {
              _log.fine(new StringBuilder().append("admin_edit_drop parements error: ").append(command).toString());
            }
          }
          else
      ...
      else if (command.startsWith("admin_add_drop "))
      {
        ...
        try
        {
          ...
          else if (st.countTokens() == 6)
          {
            ...
            {
              _log.fine(new StringBuilder().append("admin_add_drop parements error: ").append(command).toString());
            }
          }
          else {
      ...
      {
        int npcId = -1; int itemId = -1; int category = -1000;
        try
        {
          String[] input = command.substring(15).split(" ");
          if (input.length >= 3)
      ...
      else if (command.startsWith("admin_box_access"))
      {
        ...
        if ((target instanceof L2BoxInstance))
        {
          ...
          else
          {
            ...
            {
              String msg = "Access:";
              for (Iterator i$ = box.getAccess().iterator(); i$.hasNext(); ) { Object p = i$.next();
                msg = new StringBuilder().append(msg).append(" ").append((String)p).toString(); }
              activeChar.sendMessage(msg);
            }
            catch (Exception e)
            {
              _log.info(new StringBuilder().append("box_access: ").append(e).toString());
            }
          }
        }
      }
  ...
  private void editShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      ...
      activeChar.sendMessage(new StringBuilder().append("Updated price for ").append(item.getName()).append(" in Trade List ").append(tradeListID).toString());
    ...
    replyMSG.append(new StringBuilder().append("<br>Editing Item: ").append(item.getName()).toString());
    ...
    replyMSG.append(new StringBuilder().append("<tr><td>Price</td><td><edit var=\"price\" width=80></td><td>").append(tradeList.getPriceForItemId(itemID)).append("</td></tr>").toString());
    replyMSG.append("</table>");
    replyMSG.append("<center><br><br><br>");
    replyMSG.append(new StringBuilder().append("<button value=\"Save\" action=\"bypass -h admin_editShopItem ").append(tradeListID).append(" ").append(itemID).append(" $price\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append(new StringBuilder().append("<br><button value=\"Back\" action=\"bypass -h admin_showShopList ").append(tradeListID).append(" 1\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
  ...
  private void delShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      ...
      activeChar.sendMessage(new StringBuilder().append("Deleted ").append(ItemTable.getInstance().getTemplate(itemID).getName()).append(" from Trade List ").append(tradeListID).toString());
      showShopList(activeChar, tradeListID, 1);
      return;
    }
    ...
    replyMSG.append(new StringBuilder().append("<br>Item to Delete: ").append(ItemTable.getInstance().getTemplate(itemID).getName()).toString());
    replyMSG.append("<table>");
    replyMSG.append("<tr><td width=100>Property</td><td width=100>Value</td></tr>");
    replyMSG.append("<tr><td><br></td><td></td></tr>");
    replyMSG.append(new StringBuilder().append("<tr><td>Price</td><td>").append(tradeList.getPriceForItemId(itemID)).append("</td></tr>").toString());
    replyMSG.append("</table>");
    replyMSG.append("<center><br><br><br>");
    replyMSG.append(new StringBuilder().append("<button value=\"Confirm\" action=\"bypass -h admin_delShopItem ").append(tradeListID).append(" ").append(itemID).append(" 1\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append(new StringBuilder().append("<br><button value=\"Back\" action=\"bypass -h admin_showShopList ").append(tradeListID).append(" 1\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append("</center>");
    replyMSG.append("</body></html>");
  ...
  private void addShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      int order = tradeList.getItems().size() + 1;
      int itemID = Integer.parseInt(args[2]);
      int price = Integer.parseInt(args[3]);
      ...
      activeChar.sendMessage(new StringBuilder().append("Added ").append(newItem.getItem().getName()).append(" to Trade List ").append(tradeList.getListId()).toString());
      showShopList(activeChar, tradeListID, 1);
      return;
    }
    ...
    replyMSG.append("</table>");
    replyMSG.append("<center><br><br><br>");
    replyMSG.append(new StringBuilder().append("<button value=\"Save\" action=\"bypass -h admin_addShopItem ").append(tradeListID).append(" $itemID $price\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append(new StringBuilder().append("<br><button value=\"Back\" action=\"bypass -h admin_showShopList ").append(tradeListID).append(" 1\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append("</center>");
    replyMSG.append("</body></html>");
  ...
  private TextBuilder itemListHtml(L2TradeList tradeList, int page)
  {
    ...
    replyMSG.append(new StringBuilder().append("<html><title>Merchant Shop List Page: ").append(page).append("</title>").toString());
    replyMSG.append("<body>");
    ...
    {
      replyMSG.append(new StringBuilder().append("<tr><td><a action=\"bypass -h admin_editShopItem ").append(tradeList.getListId()).append(" ").append(item.getItemId()).append("\">").append(item.getItem().getName()).append("</a></td>").toString());
      replyMSG.append(new StringBuilder().append("<td>").append(item.getPriceToSell()).append("</td>").toString());
      replyMSG.append(new StringBuilder().append("<td><button value=\"Del\" action=\"bypass -h admin_delShopItem ").append(tradeList.getListId()).append(" ").append(item.getItemId()).append("\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>").toString());
      replyMSG.append("</tr>");
    }
    replyMSG.append("<tr>");
    int min = 1;
    ...
    if (page > 1)
    {
      replyMSG.append(new StringBuilder().append("<td><button value=\"Page").append(page - 1).append("\" action=\"bypass -h admin_showShopList ").append(tradeList.getListId()).append(" ").append(page - 1).append("\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>").toString());
    }
    if (page < max)
    {
      if (page <= min)
    ...
    replyMSG.append("</table>");
    replyMSG.append("<center>");
    replyMSG.append(new StringBuilder().append("<button value=\"Add\" action=\"bypass -h admin_addShopItem ").append(tradeList.getListId()).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
  ...
  {
    List tradeLists = getTradeLists(merchantID);
    if (tradeLists == null)
    {
      activeChar.sendMessage(new StringBuilder().append("Unknown npc template ID").append(merchantID).toString());
      return;
    }
    ...
    {
      if (tradeList != null) {
        replyMSG.append(new StringBuilder().append("<tr><td><a action=\"bypass -h admin_showShopList ").append(tradeList.getListId()).append(" 1\">Trade List ").append(tradeList.getListId()).append("</a></td></tr>").toString());
      }
    }
    replyMSG.append("</table>");
    replyMSG.append("<center>");
  ...
  private void storeTradeList(int itemID, int price, int tradeListID, int order)
  {
    ...
    try
    {
      ...
      PreparedStatement stmt = con.prepareStatement(new StringBuilder().append("INSERT INTO merchant_buylists (`item_id`,`price`,`shop_id`,`order`) values (").append(itemID).append(",").append(price).append(",").append(tradeListID).append(",").append(order).append(")").toString());
      stmt.execute();
      stmt.close();
    }
  ...
  private void updateTradeList(int itemID, int price, int tradeListID, int order)
  {
    ...
    {
      con = L2DatabaseFactory.getInstance().getConnection();
      PreparedStatement stmt = con.prepareStatement(new StringBuilder().append("UPDATE merchant_buylists SET `price`='").append(price).append("' WHERE `shop_id`='").append(tradeListID).append("' AND `order`='").append(order).append("'").toString());
      stmt.execute();
      stmt.close();
    }
    catch (SQLException e) {
  ...
  private void deleteTradeList(int tradeListID, int order)
  {
    ...
    {
      con = L2DatabaseFactory.getInstance().getConnection();
      PreparedStatement stmt = con.prepareStatement(new StringBuilder().append("DELETE FROM merchant_buylists WHERE `shop_id`='").append(tradeListID).append("' AND `order`='").append(order).append("'").toString());
      stmt.execute();
      stmt.close();
    }
    catch (SQLException e)
  ...
  private int findOrderTradeList(int itemID, int price, int tradeListID)
  {
    ...
    {
      con = L2DatabaseFactory.getInstance().getConnection();
      PreparedStatement stmt = con.prepareStatement(new StringBuilder().append("SELECT * FROM merchant_buylists WHERE `shop_id`='").append(tradeListID).append("' AND `item_id` ='").append(itemID).append("' AND `price` = '").append(price).append("'").toString());
  ...
  private List<L2TradeList> getTradeLists(int merchantID)
  {
    ...
    String content = HtmCache.getInstance().getHtm(new StringBuilder().append("data/html/merchant/").append(merchantID).append(".htm").toString());
    ...
    for (String line : lines)
    {
      ...
      if (pos < 0)
        continue;
      int tradeListID = Integer.decode(line.substring(pos + target.length() + 1).split("\"")[0]).intValue();
    ...
    try
    {
      ...
      if (commandSplit.length > 4)
      {
        for (int i = 0; i < commandSplit.length - 3; i++) {
          value = new StringBuilder().append(value).append(" ").append(commandSplit[(i + 4)]).toString();
        }
      }
      if (statToSet.equals("templateId")) {
        newNpcData.set("idTemplate", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("name")) {
        newNpcData.set("name", value);
      } else if (statToSet.equals("serverSideName")) {
        newNpcData.set("serverSideName", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("title")) {
        newNpcData.set("title", value);
      } else if (statToSet.equals("serverSideTitle")) {
        newNpcData.set("serverSideTitle", Integer.valueOf(value).intValue() == 1 ? 1 : 0);
      } else if (statToSet.equals("collisionRadius")) {
        newNpcData.set("collision_radius", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("collisionHeight")) {
        newNpcData.set("collision_height", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("level")) {
        newNpcData.set("level", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("sex"))
      {
        int intValue = Integer.valueOf(value).intValue();
        newNpcData.set("sex", intValue == 1 ? "female" : intValue == 0 ? "male" : "etc");
      }
      else if (statToSet.equals("type"))
      {
        Class.forName(new StringBuilder().append("net.sf.l2j.gameserver.model.actor.instance.").append(value).append("Instance").toString());
        newNpcData.set("type", value);
      }
      else if (statToSet.equals("attackRange")) {
        newNpcData.set("attackrange", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("hp")) {
        newNpcData.set("hp", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("mp")) {
        newNpcData.set("mp", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("hpRegen")) {
        newNpcData.set("hpreg", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("mpRegen")) {
        newNpcData.set("mpreg", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("str")) {
        newNpcData.set("str", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("con")) {
        newNpcData.set("con", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("dex")) {
        newNpcData.set("dex", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("int")) {
        newNpcData.set("int", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("wit")) {
        newNpcData.set("wit", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("men")) {
        newNpcData.set("men", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("exp")) {
        newNpcData.set("exp", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("sp")) {
        newNpcData.set("sp", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("pAtk")) {
        newNpcData.set("patk", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("pDef")) {
        newNpcData.set("pdef", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("mAtk")) {
        newNpcData.set("matk", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("mDef")) {
        newNpcData.set("mdef", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("pAtkSpd")) {
        newNpcData.set("atkspd", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("aggro")) {
        newNpcData.set("aggro", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("mAtkSpd")) {
        newNpcData.set("matkspd", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("rHand")) {
        newNpcData.set("rhand", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("lHand")) {
        newNpcData.set("lhand", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("armor")) {
        newNpcData.set("armor", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("runSpd")) {
        newNpcData.set("runspd", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("factionId")) {
        newNpcData.set("faction_id", value);
      } else if (statToSet.equals("factionRange")) {
        newNpcData.set("faction_range", Integer.valueOf(value).intValue());
      } else if (statToSet.equals("isUndead")) {
        newNpcData.set("isUndead", Integer.valueOf(value).intValue() == 1 ? 1 : 0);
      } else if (statToSet.equals("absorbLevel"))
      {
        int intVal = Integer.valueOf(value).intValue();
        newNpcData.set("absorb_level", intVal > 12 ? 0 : intVal < 0 ? 0 : intVal);
      }
    }
    catch (Exception e)
    {
      _log.warning(new StringBuilder().append("Error saving new npc value: ").append(e).toString());
    }
  ...
  private void showNpcDropList(L2PcInstance activeChar, int npcId)
  {
    ...
    if (npcData == null)
    {
      activeChar.sendMessage(new StringBuilder().append("unknown npc template id").append(npcId).toString());
      return;
    }

    NpcHtmlMessage adminReply = new NpcHtmlMessage(5);

    TextBuilder replyMSG = new TextBuilder(new StringBuilder().append("<html><title>NPC: ").append(npcData.name).append("(").append(npcData.npcId).append(") 's drop manage</title>").toString());
    replyMSG.append("<body>");
    ...
    for (Iterator i$ = npcData.getDropData().iterator(); i$.hasNext(); ) { cat = (L2DropCategory)i$.next();
      for (L2DropData drop : cat.getAllDrops())
      {
        replyMSG.append(new StringBuilder().append("<tr><td><a action=\"bypass -h admin_edit_drop ").append(npcData.npcId).append(" ").append(drop.getItemId()).append(" ").append(cat.getCategoryType()).append("\">").append(npcData.npcId).append(" ").append(drop.getItemId()).append(" ").append(cat.getCategoryType()).append("</a></td>").append("<td>").append(ItemTable.getInstance().getTemplate(drop.getItemId()).getName()).append("[").append(drop.getItemId()).append("]").append("</td><td>").append(cat.isSweep() ? "S" : drop.isQuestDrop() ? "Q" : "D").append("</td><td>").append("<a action=\"bypass -h admin_del_drop ").append(npcData.npcId).append(" ").append(drop.getItemId()).append(" ").append(cat.getCategoryType()).append("\">del</a></td></tr>").toString());
      }
    }
    L2DropCategory cat;
    replyMSG.append("</table>");
    replyMSG.append("<center>");
    replyMSG.append(new StringBuilder().append("<button value=\"Add DropData\" action=\"bypass -h admin_add_drop ").append(npcId).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append("<button value=\"Close\" action=\"bypass -h admin_close_window\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
    replyMSG.append("</center></body></html>");
  ...
  private void showEditDropData(L2PcInstance activeChar, int npcId, int itemId, int category)
  {
    ...
    try
    {
      ...
      PreparedStatement statement = con.prepareStatement(new StringBuilder().append("SELECT mobId, itemId, min, max, category, chance FROM droplist WHERE mobId=").append(npcId).append(" AND itemId=").append(itemId).append(" AND category=").append(category).toString());
      ResultSet dropData = statement.executeQuery();

      NpcHtmlMessage adminReply = new NpcHtmlMessage(5);

      TextBuilder replyMSG = new TextBuilder(new StringBuilder().append("<html><title>the detail of dropdata: (").append(npcId).append(" ").append(itemId).append(" ").append(category).append(")</title>").toString());
      replyMSG.append("<body>");

      if (dropData.next()) {
        replyMSG.append("<table>");
        replyMSG.append(new StringBuilder().append("<tr><td>Appertain of NPC</td><td>").append(NpcTable.getInstance().getTemplate(dropData.getInt("mobId")).name).append("</td></tr>").toString());
        replyMSG.append(new StringBuilder().append("<tr><td>ItemName</td><td>").append(ItemTable.getInstance().getTemplate(dropData.getInt("itemId")).getName()).append("(").append(dropData.getInt("itemId")).append(")</td></tr>").toString());
        replyMSG.append(new StringBuilder().append("<tr><td>Category</td><td>").append(category == -1 ? "sweep" : Integer.toString(category)).append("</td></tr>").toString());
        replyMSG.append(new StringBuilder().append("<tr><td>MIN(").append(dropData.getInt("min")).append(")</td><td><edit var=\"min\" width=80></td></tr>").toString());
        replyMSG.append(new StringBuilder().append("<tr><td>MAX(").append(dropData.getInt("max")).append(")</td><td><edit var=\"max\" width=80></td></tr>").toString());
        replyMSG.append(new StringBuilder().append("<tr><td>CHANCE(").append(dropData.getInt("chance")).append(")</td><td><edit var=\"chance\" width=80></td></tr>").toString());
        replyMSG.append("</table>");

        replyMSG.append("<center>");
        replyMSG.append(new StringBuilder().append("<button value=\"Save Modify\" action=\"bypass -h admin_edit_drop ").append(npcId).append(" ").append(itemId).append(" ").append(category).append(" $min $max $chance\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
        replyMSG.append(new StringBuilder().append("<br><button value=\"DropList\" action=\"bypass -h admin_show_droplist ").append(dropData.getInt("mobId")).append("\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
        replyMSG.append("</center>");
      }
  ...
  private void showAddDropData(L2PcInstance activeChar, L2NpcTemplate npcData) {
    ...
    TextBuilder replyMSG = new TextBuilder(new StringBuilder().append("<html><title>Add dropdata to ").append(npcData.name).append("(").append(npcData.npcId).append(")</title>").toString());
    replyMSG.append("<body>");
    replyMSG.append("<table>");
    ...
    replyMSG.append("<center>");
    replyMSG.append(new StringBuilder().append("<button value=\"SAVE\" action=\"bypass -h admin_add_drop ").append(npcData.npcId).append(" $itemId $category $min $max $chance\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append(new StringBuilder().append("<br><button value=\"DropList\" action=\"bypass -h admin_show_droplist ").append(npcData.npcId).append("\"  width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
    replyMSG.append("</center>");
    replyMSG.append("</body></html>");
    adminReply.setHtml(replyMSG.toString());
  ...
  private void updateDropData(L2PcInstance activeChar, int npcId, int itemId, int min, int max, int category, int chance)
  {
    ...
    try
    {
      ...
      if (npcId > 0)
      {
        ...
        replyMSG.append("<body>");
        replyMSG.append(new StringBuilder().append("<center><button value=\"DropList\" action=\"bypass -h admin_show_droplist ").append(npcId).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center>").toString());
        replyMSG.append("</body></html>");
  ...
  private void addDropData(L2PcInstance activeChar, int npcId, int itemId, int min, int max, int category, int chance) {
    ...
    try
    {
      ...
      replyMSG.append("<body>");
      replyMSG.append(new StringBuilder().append("<center><button value=\"Continue add\" action=\"bypass -h admin_add_drop ").append(npcId).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
      replyMSG.append(new StringBuilder().append("<br><br><button value=\"DropList\" action=\"bypass -h admin_show_droplist ").append(npcId).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">").toString());
      replyMSG.append("</center></body></html>");
  ...
  private void deleteDropData(L2PcInstance activeChar, int npcId, int itemId, int category) {
    ...
    try
    {
      ...
      if (npcId > 0)
      {
        ...
        NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
        TextBuilder replyMSG = new TextBuilder(new StringBuilder().append("<html><title>Delete drop data(").append(npcId).append(", ").append(itemId).append(", ").append(category).append(")complete</title>").toString());
        replyMSG.append("<body>");
        replyMSG.append(new StringBuilder().append("<center><button value=\"DropList\" action=\"bypass -h admin_show_droplist ").append(npcId).append("\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center>").toString());
        replyMSG.append("</body></html>");
  ...
  private void reLoadNpcDropList(int npcId) {
    ...
    try
    {
      ...
      PreparedStatement statement = con.prepareStatement(new StringBuilder().append("SELECT ").append(L2DatabaseFactory.getInstance().safetyString(new String[] { "mobId", "itemId", "min", "max", "category", "chance" })).append(" FROM droplist WHERE mobId=?").toString());
      statement.setInt(1, npcId);
