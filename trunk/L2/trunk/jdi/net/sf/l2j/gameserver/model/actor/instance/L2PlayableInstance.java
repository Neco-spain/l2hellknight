...
public abstract class L2PlayableInstance extends L2Character
{
  ...
  public boolean checkIfPvP(L2Character target)
  {
    ...
    if (!(target instanceof L2PlayableInstance)) return false;
    ...
    if (player.getKarma() != 0) return false;
    ...
    if (targetPlayer == this) return false;
    if (targetPlayer.getKarma() != 0) return false;
