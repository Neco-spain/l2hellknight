...
public class L2SummonInstance extends L2Summon
{
    ...
    implements Runnable
  {
    ...
    {
      if (Config.DEBUG) {
        L2SummonInstance.log.warning("L2SummonInstance: " + _summon.getTemplate().name + " (" + _activeChar.getName() + ") run task.");
      }
      ...
      {
        if (Config.DEBUG)
          L2SummonInstance.log.warning("Summon of player [#" + _activeChar.getName() + "] has encountered item consumption errors: " + e);
      }
    }
  }
}