...
public class TvTEvent
{
  ...
  public static void init()
  {
    ...
    if (Config.TVT_SAME_IP)
      _listedIps = new ArrayList(Config.TVT_EVENT_MAX_PLAYERS_IN_TEAMS * 2);
  }
  ...
  public static boolean startFight()
  {
    ...
    Map allParticipants = new FastMap();
  ...
  private static void rewardTeam(TvTEventTeam team)
  {
    for (L2PcInstance playerInstance : team.getParticipatedPlayers().values())
    {
      ...
      if (_canreward)
      {
        ...
        npcHtmlMessage.setHtml(HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Reward.htm"));
      ...
      else
      {
        ...
        statusUpdate.addAttribute(14, playerInstance.getCurrentLoad());
        npcHtmlMessage.setHtml(HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Reward0.htm"));
        playerInstance.sendPacket(statusUpdate);
        playerInstance.sendPacket(npcHtmlMessage);
      }
    }
  ...
  public static synchronized boolean addParticipant(L2PcInstance playerInstance)
  {
    ...
    if (!nProtect.getInstance().checkRestriction(playerInstance, nProtect.RestrictionType.RESTRICT_EVENT, new Object[] { TvTEvent.class, _teams }))
    {
      return false;
    }
    byte teamId = 0;
    ...
    if ((Config.TVT_SAME_IP) && (!playerInstance.isOffline()))
    {
  ...
  {
    for (Iterator i$ = doors.iterator(); i$.hasNext(); ) { int doorId = ((Integer)i$.next()).intValue();
  ...
  public static void onLogout(L2PcInstance playerInstance)
  {
    if ((playerInstance != null) && ((isStarting()) || (isStarted()) || (isParticipating())))
    {
      ...
      if (Config.TVT_SAME_IP)
      {
        if (playerInstance != null)
        {
          if (_listedIps.contains(_tvtIp))
          {
            _listedIps.remove(_tvtIp);
          }
        }
      }
    }
  ...
  {
    if ((playerInstance == null) || (!isParticipating()) || (playerInstance.isOffline())) {
      return;
    }
    ...
    if (command.equals("tvt_event_participation"))
    {
      ...
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/DualBox.htm");
        if (htmContent != null)
        {
      ...
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/CursedWeaponEquipped.htm");
        if (htmContent != null)
          npcHtmlMessage.setHtml(htmContent);
      }
      else if (Olympiad.getInstance().isRegistered(playerInstance))
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Olympiad.htm");
        if (htmContent != null)
          npcHtmlMessage.setHtml(htmContent);
      }
      else if (playerInstance.getKarma() > 0)
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Karma.htm");
        if (htmContent != null)
          npcHtmlMessage.setHtml(htmContent);
      }
      else if ((playerLevel < Config.TVT_EVENT_MIN_LVL) || (playerLevel > Config.TVT_EVENT_MAX_LVL))
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Level.htm");
        if (htmContent != null)
        {
          npcHtmlMessage.setHtml(htmContent);
      ...
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/TeamsFull.htm");
        if (htmContent != null)
        {
          npcHtmlMessage.setHtml(htmContent);
      ...
      {
        String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/ParticipationFee.htm");
        if (htmContent != null)
        {
          npcHtmlMessage.setHtml(htmContent);
        ...
        npcHtmlMessage.setHtml(HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Registered.htm"));
      } else {
        return;
      }
      playerInstance.sendPacket(npcHtmlMessage);
    ...
    else if (command.equals("tvt_event_remove_participation"))
    {
      ...
      npcHtmlMessage.setHtml(HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Unregistered.htm"));
      playerInstance.sendPacket(npcHtmlMessage);
    }
  }
