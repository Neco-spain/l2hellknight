...
{
  private static List<String> _autoannouncements = new FastList();
  ...
  public static void announce()
  {
    ...
    {
      Announcements.getInstance().announceToAll((String)_autoannouncements.get(i));
    }
  }
