...
public class ClanBBSManager extends BaseBBSManager
{
  ...
  public void parsecmd(String command, L2PcInstance activeChar)
  {
    ...
    {
      separateAndSend(new StringBuilder().append("<html><body><br><br><center>Command : ").append(command).append(" needs core development</center><br><br></body></html>").toString(), activeChar);
    }
  }
  ...
  private void clanNotice(L2PcInstance activeChar, int clanId)
  {
    ...
    if (cl != null)
    {
      ...
      {
        StringBuilder html = StringUtil.startAppend(2000, new String[] { "<html><body><br><br><table border=0 width=610><tr><td width=10></td><td width=600 align=left><a action=\"bypass _bbshome\">HOME</a> &gt; <a action=\"bypass _bbsclan_clanlist\"> CLAN COMMUNITY </a>  &gt; <a action=\"bypass _bbsclan_clannotice_edit;", String.valueOf(clanId), "\"> &amp;$802; </a></td></tr></table>" });

        if (activeChar.isClanLeader())
        {
          StringUtil.append(html, new String[] { "<br><br><center><table width=610 border=0 cellspacing=0 cellpadding=0><tr><td fixwidth=610><font color=\"AAAAAA\">The Clan Notice function allows the clan leader to send messages through a pop-up window to clan members at login.</font> </td></tr><tr><td height=20></td></tr>" });

          if (activeChar.getClan().isNoticeEnabled())
            StringUtil.append(html, new String[] { "<tr><td fixwidth=610> Clan Notice Function:&nbsp;&nbsp;&nbsp;on&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_disable\">off</a>" });
          else {
            StringUtil.append(html, new String[] { "<tr><td fixwidth=610> Clan Notice Function:&nbsp;&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_enable\">on</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;off" });
          }
          StringUtil.append(html, new String[] { "</td></tr></table><img src=\"L2UI.Squaregray\" width=\"610\" height=\"1\"><br> <br><table width=610 border=0 cellspacing=2 cellpadding=0><tr><td>Edit Notice: </td></tr><tr><td height=5></td></tr><tr><td><MultiEdit var =\"Content\" width=610 height=100></td></tr></table><br><table width=610 border=0 cellspacing=0 cellpadding=0><tr><td height=5></td></tr><tr><td align=center FIXWIDTH=65><button value=\"&$140;\" action=\"Write Notice Set _ Content Content Content\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\" ></td><td align=center FIXWIDTH=45></td><td align=center FIXWIDTH=500></td></tr></table></center></body></html>" });
        ...
        {
          StringUtil.append(html, new String[] { "<img src=\"L2UI.squareblank\" width=\"1\" height=\"10\"><center><table border=0 cellspacing=0 cellpadding=0><tr><td>You are not your clan's leader, and therefore cannot change the clan notice</td></tr></table>" });

          if (activeChar.getClan().isNoticeEnabled())
          {
            StringUtil.append(html, new String[] { new StringBuilder().append("<table border=0 cellspacing=0 cellpadding=0><tr><td>The current clan notice:</td></tr><tr><td fixwidth=5></td><td FIXWIDTH=600 align=left>").append(activeChar.getClan().getNotice()).append("</td>").append("<td fixqqwidth=5></td>").append("</tr>").append("</table>").toString() });
          }

          StringUtil.append(html, new String[] { "</center></body></html>" });
  ...
  private void clanlist(L2PcInstance activeChar, int index)
  {
    ...
    html.append(new StringBuilder().append("<a action=\"bypass _bbsclan_clanhome;").append(activeChar.getClan() != null ? activeChar.getClan().getClanId() : 0).append("\">[GO TO MY CLAN]</a>&nbsp;&nbsp;").toString());
    ...
    for (L2Clan cl : ClanTable.getInstance().getClans())
    {
      ...
      if (i >= (index - 1) * 7)
      {
        ...
        html.append("<tr> ");
        html.append("<td FIXWIDTH=5></td>");
        html.append(new StringBuilder().append("<td FIXWIDTH=200 align=center><a action=\"bypass _bbsclan_clanhome;").append(cl.getClanId()).append("\">").append(cl.getName()).append("</a></td>").toString());

        html.append(new StringBuilder().append("<td FIXWIDTH=200 align=center>").append(cl.getLeaderName()).append("</td>").toString());
        html.append(new StringBuilder().append("<td FIXWIDTH=100 align=center>").append(cl.getLevel()).append("</td>").toString());
        html.append(new StringBuilder().append("<td FIXWIDTH=100 align=center>").append(cl.getMembersCount()).append("</td>").toString());
        html.append("<td FIXWIDTH=5></td>");
        html.append("</tr>");
    ...
    {
      html.append(new StringBuilder().append("<td><button action=\"_bbsclan_clanlist;").append(index - 1).append("\" back=\"l2ui_ch3.prev1_down\" fore=\"l2ui_ch3.prev1\" width=16 height=16 ></td>").toString());
    }
    ...
    for (i = 1; i <= nbp; i++)
    {
      if (i == index)
      {
        html.append(new StringBuilder().append("<td> ").append(i).append(" </td>").toString());
      }
      else
      {
        html.append(new StringBuilder().append("<td><a action=\"bypass _bbsclan_clanlist;").append(i).append("\"> ").append(i).append(" </a></td>").toString());
      }
    }
    ...
    {
      html.append(new StringBuilder().append("<td><button action=\"bypass _bbsclan_clanlist;").append(index + 1).append("\" back=\"l2ui_ch3.next1_down\" fore=\"l2ui_ch3.next1\" width=16 height=16 ></td>").toString());
    }
  ...
  private void clanhome(L2PcInstance activeChar, int clanId)
  {
    ...
    if (cl != null)
    {
      ...
      else
      {
        ...
        html.append("<tr><td FIXWIDTH=15>&nbsp;</td>");
        html.append("<td width=610 height=30 align=left>");
        html.append(new StringBuilder().append("<a action=\"bypass _bbshome\">HOME</a> &gt; <a action=\"bypass _bbsclan_clanlist\"> CLAN COMMUNITY </a>  &gt; <a action=\"bypass _bbsclan_clanhome;").append(clanId).append("\"> &amp;$802; </a>").toString());
        ...
        html.append("<td fixWIDTH=5></td>");
        html.append("<td fixwidth=600>");
        html.append(new StringBuilder().append("<a action=\"bypass _bbsclan_clanhome;").append(clanId).append(";announce\">[CLAN ANNOUNCEMENT]</a> <a action=\"bypass _bbsclan_clanhome;").append(clanId).append(";cbb\">[CLAN BULLETIN BOARD]</a>").toString());

        html.append(new StringBuilder().append("<a action=\"bypass _bbsclan_clanhome;").append(clanId).append(";cmail\">[CLAN MAIL]</a>&nbsp;&nbsp;").toString());

        html.append(new StringBuilder().append("<a action=\"bypass _bbsclan_clanhome;").append(clanId).append(";cnotice\">[CLAN NOTICE]</a>&nbsp;&nbsp;").toString());
        ...
        html.append(new StringBuilder().append("<td fixWIDTH=195 align=left>").append(cl.getName()).append("</td>").toString());
        html.append("</tr>");
        html.append("<tr><td height=7></td></tr>");
        html.append("<tr>");
        html.append("<td fixWIDTH=100 align=left>CLAN LEVEL</td>");
        html.append(new StringBuilder().append("<td fixWIDTH=195 align=left height=16>").append(cl.getLevel()).append("</td>").toString());
        html.append("</tr>");
        html.append("<tr><td height=7></td></tr>");
        html.append("<tr>");
        html.append("<td fixWIDTH=100 align=left>CLAN MEMBERS</td>");
        html.append(new StringBuilder().append("<td fixWIDTH=195 align=left height=16>").append(cl.getMembersCount()).append("</td>").toString());
        html.append("</tr>");
        html.append("<tr><td height=7></td></tr>");
        html.append("<tr>");
        html.append("<td fixWIDTH=100 align=left>CLAN LEADER</td>");
        html.append(new StringBuilder().append("<td fixWIDTH=195 align=left height=16>").append(cl.getLeaderName()).append("</td>").toString());
        html.append("</tr>");
        html.append("<tr><td height=7></td></tr>");
        ...
        html.append(new StringBuilder().append("<td fixWIDTH=195 align=left height=16>").append(cl.getAllyName() != null ? cl.getAllyName() : "").append("</td>").toString());
  ...
  public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
  {
    if (ar1.equals("Set"))
    {
      ...
      parsecmd(new StringBuilder().append("_bbsclan_clanhome;").append(activeChar.getClan().getClanId()).toString(), activeChar);
    }
  }
}