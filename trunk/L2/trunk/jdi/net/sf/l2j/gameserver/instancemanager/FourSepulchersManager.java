...
public class FourSepulchersManager
{
  ...
  protected FastMap<Integer, Boolean> _archonSpawned;
  protected FastMap<Integer, Boolean> _hallInUse;
  protected FastMap<Integer, int[]> _startHallSpawns;
  protected FastMap<Integer, Integer> _hallGateKeepers;
  protected FastMap<Integer, Integer> _keyBoxNpc;
  protected FastMap<Integer, Integer> _victim;
  protected FastMap<Integer, L2PcInstance> _challengers;
  protected FastMap<Integer, L2Spawn> _executionerSpawns;
  protected FastMap<Integer, L2Spawn> _keyBoxSpawns;
  protected FastMap<Integer, L2Spawn> _mysteriousBoxSpawns;
  protected FastMap<Integer, L2Spawn> _shadowSpawns;
  protected FastMap<Integer, FastList<L2Spawn>> _dukeFinalMobs;
  protected FastMap<Integer, FastList<L2SepulcherMonsterInstance>> _dukeMobs;
  protected FastMap<Integer, FastList<L2Spawn>> _emperorsGraveNpcs;
  protected FastMap<Integer, FastList<L2Spawn>> _magicalMonsters;
  protected FastMap<Integer, FastList<L2Spawn>> _physicalMonsters;
  protected FastMap<Integer, FastList<L2SepulcherMonsterInstance>> _viscountMobs;
  ...
  public FourSepulchersManager()
  {
    ...
    _startHallSpawn = new int[][] { { 181632, -85587, -7218 }, { 179963, -88978, -7218 }, { 173217, -86132, -7218 }, { 175608, -82296, -7218 } };

    _shadowSpawnLoc = new int[][][] { { { 25339, 191231, -85574, -7216, 33380 }, { 25349, 189534, -88969, -7216, 32768 }, { 25346, 173195, -76560, -7215, 49277 }, { 25342, 175591, -72744, -7215, 49317 } }, { { 25342, 191231, -85574, -7216, 33380 }, { 25339, 189534, -88969, -7216, 32768 }, { 25349, 173195, -76560, -7215, 49277 }, { 25346, 175591, -72744, -7215, 49317 } }, { { 25346, 191231, -85574, -7216, 33380 }, { 25342, 189534, -88969, -7216, 32768 }, { 25339, 173195, -76560, -7215, 49277 }, { 25349, 175591, -72744, -7215, 49317 } }, { { 25349, 191231, -85574, -7216, 33380 }, { 25346, 189534, -88969, -7216, 32768 }, { 25342, 173195, -76560, -7215, 49277 }, { 25339, 175591, -72744, -7215, 49317 } } };

    _archonSpawned = new FastMap();
    _hallInUse = new FastMap();
    _startHallSpawns = new FastMap();
    _hallGateKeepers = new FastMap();
    _keyBoxNpc = new FastMap();
    _victim = new FastMap();
    _challengers = new FastMap();
    _executionerSpawns = new FastMap();
    _keyBoxSpawns = new FastMap();
    _mysteriousBoxSpawns = new FastMap();
    _shadowSpawns = new FastMap();
    _dukeFinalMobs = new FastMap();
    _dukeMobs = new FastMap();
    _emperorsGraveNpcs = new FastMap();
    _magicalMonsters = new FastMap();
    _physicalMonsters = new FastMap();
    _viscountMobs = new FastMap();

    _allMobs = new FastList();
  ...
  protected void spawnManagers()
  {
    ...
    for (; i <= 31924; i++)
    {
      ...
      try
      {
        ...
        _log.info("FourSepulchersManager: spawned " + i);
      }
  ...
  protected void initLocationShadowSpawns()
  {
    ...
    for (int i = 0; i <= 3; i++)
    {
      ...
      if (template != null)
      {
        ...
        {
          _log.severe("Error on InitLocationShadowSpawns");
        }
      }
      else
      {
  ...
  public synchronized void tryEntry(L2NpcInstance npc, L2PcInstance player)
  {
    ...
    if (Config.FS_PARTY_MEMBER_COUNT > 1)
    {
      ...
      {
        QuestState qs = mem.getQuestState("620_FourGoblets");
    ...
    {
      QuestState qs = player.getQuestState("620_FourGoblets");
      if ((qs == null) || ((!qs.isStarted()) && (!qs.isCompleted())))
      {
  ...
  public void deleteAllMobs()
  {
    ...
    for (L2NpcInstance mob : _allMobs)
    {
      ...
      {
        _log.severe("FourSepulchersManager: Failed deleting mob.");
      }
    }
    _allMobs.clear();
  }
  ...
  protected void closeAllDoors()
  {
    for (Iterator i$ = _hallGateKeepers.values().iterator(); i$.hasNext(); ) { int doorId = ((Integer)i$.next()).intValue();
      ...
      {
        _log.severe("FourSepulchersManager: Failed closing door");
      }
    }
  }
  ...
  public void managerSay(byte min)
  {
    if (_inAttackTime)
    {
      ...
      for (int k = _managers.size(); i < k; i++)
      {
        ...
        else if (!(((L2Spawn)_managers.get(i)).getLastSpawn() instanceof L2SepulcherNpcInstance))
        {
          _log.warning("FourSepulchersManager: managerSay(): manager is not Sepulcher instance");
        }
        else
        {
          if (!((Boolean)_hallInUse.get(Integer.valueOf(((L2Spawn)_managers.get(i)).getNpcid()))).booleanValue()) {
            continue;
          }
          ((L2SepulcherNpcInstance)((L2Spawn)_managers.get(i)).getLastSpawn()).sayInShout(msg);
        }
      }
    }
    else if (_inEntryTime)
    {
      ...
      for (int k = _managers.size(); i < k; i++)
      {
        ...
        else if (!(((L2Spawn)_managers.get(i)).getLastSpawn() instanceof L2SepulcherNpcInstance))
        {
          ...
          ((L2SepulcherNpcInstance)((L2Spawn)_managers.get(i)).getLastSpawn()).sayInShout(msg1);
          ((L2SepulcherNpcInstance)((L2Spawn)_managers.get(i)).getLastSpawn()).sayInShout(msg2);
        }
      }
    }
  }
