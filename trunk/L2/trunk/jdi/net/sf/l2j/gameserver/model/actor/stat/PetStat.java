...
public class PetStat extends SummonStat
{
  ...
  public final boolean addLevel(byte value)
  {
    ...
    if ((getExp() > getExpForLevel(getLevel() + 1)) || (getExp() < getExpForLevel(getLevel()))) setExp(net.sf.l2j.gameserver.model.base.Experience.LEVEL[getLevel()]);
  ...
  public int getMAtk(L2Character target, L2Skill skill)
  {
    ...
    if (stat != null)
    {
      ...
      case 1:
        attack += getActiveChar().getTemplate().baseAggression; break;
      case 2:
        attack += getActiveChar().getTemplate().baseBleed; break;
      case 3:
        attack += getActiveChar().getTemplate().basePoison; break;
      case 4:
        attack += getActiveChar().getTemplate().baseStun; break;
      case 5:
        attack += getActiveChar().getTemplate().baseRoot; break;
      case 6:
        attack += getActiveChar().getTemplate().baseMovement; break;
      case 7:
        attack += getActiveChar().getTemplate().baseConfusion; break;
      case 8:
        attack += getActiveChar().getTemplate().baseSleep; break;
      case 9:
        attack += getActiveChar().getTemplate().baseFire; break;
      case 10:
        attack += getActiveChar().getTemplate().baseWind; break;
      case 11:
        attack += getActiveChar().getTemplate().baseWater; break;
      case 12:
        attack += getActiveChar().getTemplate().baseEarth; break;
      case 13:
        attack += getActiveChar().getTemplate().baseHoly; break;
      case 14:
