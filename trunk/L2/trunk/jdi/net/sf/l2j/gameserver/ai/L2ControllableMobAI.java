...
public class L2ControllableMobAI extends L2AttackableAI
{
  ...
  protected void thinkFollow()
  {
    ...
    if (!Util.checkIfInRange(300, me, getForcedTarget(), true))
    {
  ...
  protected void onEvtThink()
  {
    ...
    try
    {
      ...
      {
      case 1:
        if (getIntention() == CtrlIntention.AI_INTENTION_ACTIVE) break;
        setIntention(CtrlIntention.AI_INTENTION_ACTIVE); break;
      case 4:
        thinkFollow();
        break;
      case 5:
      ...
      default:
        if (getIntention() == CtrlIntention.AI_INTENTION_ACTIVE) {
          thinkActive(); } else {
          if (getIntention() != CtrlIntention.AI_INTENTION_ATTACK) break;
          thinkAttack();
        }
      }
    }
