...
public class HotSprings extends L2AttackableAIScript
{
  public HotSprings(int questId, String name, String descr)
  {
    ...
    int[] mobs = { 21316, 21321, 21314, 21319, 21317, 21322 };
    registerMobs(mobs);
  }
  ...
  public String onAttack(L2NpcInstance npc, L2PcInstance attacker, int damage, boolean isPet)
  {
    ...
    if ((npc.getNpcId() == 21321) || (npc.getNpcId() == 21314))
    {
      if (HSBUFF == 1)
      {
        if (Rnd.get(100) < 5)
    ...
    if ((npc.getNpcId() == 21316) || (npc.getNpcId() == 21319))
    {
      if (HSBUFF == 2)
      {
        if (Rnd.get(100) < 5)
    ...
    if ((npc.getNpcId() == 21322) || (npc.getNpcId() == 21317))
    {
      if (HSBUFF == 3)
      {
        if (Rnd.get(100) < Config.FLU_CHANCE)
        {
    ...
    if ((npc.getNpcId() == 21321) || (npc.getNpcId() == 21316) || (npc.getNpcId() == 21314) || (npc.getNpcId() == 21319) || (npc.getNpcId() == 21322) || (npc.getNpcId() == 21317))
    {
      if (HSBUFF == 4)
      {
        if (Rnd.get(100) < Config.MALARIA_CHANCE)
        {
