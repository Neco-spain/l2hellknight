...
public class L2TvTEventNpcInstance extends L2NpcInstance
{
  ...
  public void showChatWindow(L2PcInstance playerInstance, int val)
  {
    ...
    if (TvTEvent.isParticipating())
    {
      ...
      String htmContent;
      if (!isParticipant)
        htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Participation.htm");
      else {
        htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/RemoveParticipation.htm");
      }
      if (htmContent != null)
      {
    ...
    {
      String htmContent = HtmCache.getInstance().getHtm("data/html/mods/TvTEvent/Status.htm");
