...
public final class L2TamedBeastInstance extends L2FeedableBeastInstance
{
  ...
  public void onOwnerGotAttacked(L2Character attacker)
  {
    ...
    if (((attacker instanceof L2PcInstance)) && ((Olympiad.getInstance().isRegisteredInComp((L2PcInstance)attacker)) || (((L2PcInstance)attacker).getOlympiadGameId() > 0)))
    {
      doDespawn();
      return;
    }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if ((Olympiad.getInstance().isRegisteredInComp(owner)) || (owner.getOlympiadGameId() > 0))
      {
        doDespawn();
        return;
      }
