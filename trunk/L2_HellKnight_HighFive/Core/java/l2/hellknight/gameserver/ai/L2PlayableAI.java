...
public abstract class L2PlayableAI extends L2CharacterAI
{
	...
	/**
	 * @see l2.hellknight.gameserver.ai.L2CharacterAI#onIntentionAttack(l2.hellknight.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.ai.L2CharacterAI#onIntentionCast(l2.hellknight.gameserver.model.skills.L2Skill, l2.hellknight.gameserver.model.L2Object)
	 */
	@Override
