 ...
 */
package l2.hellknight.gameserver.pathfinding.cellnodes;
...
public class NodeLoc extends AbstractNodeLoc
{
	...
	/**
	 * @see l2.hellknight.gameserver.pathfinding.AbstractNodeLoc#getX()
	 */
	@Override
	public int getX()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.pathfinding.AbstractNodeLoc#getY()
	 */
	@Override
	public int getY()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.pathfinding.AbstractNodeLoc#getZ()
	 */
	@Override
	public short getZ()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.pathfinding.AbstractNodeLoc#getNodeX()
	 */
	@Override
	public int getNodeX()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.pathfinding.AbstractNodeLoc#getNodeY()
	 */
	@Override
	public int getNodeY()
	{
