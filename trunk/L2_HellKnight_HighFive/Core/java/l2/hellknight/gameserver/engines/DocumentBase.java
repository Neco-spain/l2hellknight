 ...
 */
package l2.hellknight.gameserver.engines;
...
import l2.hellknight.gameserver.model.ChanceCondition;
import l2.hellknight.gameserver.model.L2Object.InstanceType;
import l2.hellknight.gameserver.model.StatsSet;
import l2.hellknight.gameserver.model.base.PlayerState;
import l2.hellknight.gameserver.model.base.Race;
import l2.hellknight.gameserver.model.conditions.Condition;
import l2.hellknight.gameserver.model.conditions.ConditionChangeWeapon;
import l2.hellknight.gameserver.model.conditions.ConditionForceBuff;
import l2.hellknight.gameserver.model.conditions.ConditionGameChance;
import l2.hellknight.gameserver.model.conditions.ConditionGameTime;
import l2.hellknight.gameserver.model.conditions.ConditionGameTime.CheckGameTime;
import l2.hellknight.gameserver.model.conditions.ConditionLogicAnd;
import l2.hellknight.gameserver.model.conditions.ConditionLogicNot;
import l2.hellknight.gameserver.model.conditions.ConditionLogicOr;
import l2.hellknight.gameserver.model.conditions.ConditionMinDistance;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerActiveEffectId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerActiveSkillId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerAgathionId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerCanSweep;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerCharges;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerClassIdRestriction;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerCloakStatus;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerCp;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerFlyMounted;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerGrade;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerHasCastle;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerHasClanHall;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerHasFort;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerHasPet;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerHp;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerInsideZoneId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerInstanceId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerInvSize;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerIsClanLeader;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerIsHero;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerLandingZone;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerLevel;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerLevelRange;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerMp;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerPkCount;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerPledgeClass;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerRace;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerRangeFromNpc;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerServitorNpcId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerSex;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerSiegeSide;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerSouls;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerState;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerSubclass;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerTransformationId;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerTvTEvent;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerTvTRoundEvent;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerVehicleMounted;
import l2.hellknight.gameserver.model.conditions.ConditionPlayerWeight;
import l2.hellknight.gameserver.model.conditions.ConditionSiegeZone;
import l2.hellknight.gameserver.model.conditions.ConditionSkillStats;
import l2.hellknight.gameserver.model.conditions.ConditionSlotItemId;
import l2.hellknight.gameserver.model.conditions.ConditionTargetAbnormal;
import l2.hellknight.gameserver.model.conditions.ConditionTargetActiveEffectId;
import l2.hellknight.gameserver.model.conditions.ConditionTargetActiveSkillId;
import l2.hellknight.gameserver.model.conditions.ConditionTargetAggro;
import l2.hellknight.gameserver.model.conditions.ConditionTargetClassIdRestriction;
import l2.hellknight.gameserver.model.conditions.ConditionTargetInvSize;
import l2.hellknight.gameserver.model.conditions.ConditionTargetLevel;
import l2.hellknight.gameserver.model.conditions.ConditionTargetLevelRange;
import l2.hellknight.gameserver.model.conditions.ConditionTargetNpcId;
import l2.hellknight.gameserver.model.conditions.ConditionTargetNpcType;
import l2.hellknight.gameserver.model.conditions.ConditionTargetPlayable;
import l2.hellknight.gameserver.model.conditions.ConditionTargetRace;
import l2.hellknight.gameserver.model.conditions.ConditionTargetRaceId;
import l2.hellknight.gameserver.model.conditions.ConditionTargetUsesWeaponKind;
import l2.hellknight.gameserver.model.conditions.ConditionTargetWeight;
import l2.hellknight.gameserver.model.conditions.ConditionUsingItemType;
import l2.hellknight.gameserver.model.conditions.ConditionUsingSkill;
import l2.hellknight.gameserver.model.conditions.ConditionWithSkill;
...
import l2.hellknight.gameserver.model.skills.funcs.Lambda;
import l2.hellknight.gameserver.model.skills.funcs.LambdaCalc;
import l2.hellknight.gameserver.model.skills.funcs.LambdaConst;
import l2.hellknight.gameserver.model.skills.funcs.LambdaStats;
...
public abstract class DocumentBase
{
	...
	protected void attachEffect(Node n, Object template, Condition attachCond)
	{
		...
		if (attrs.getNamedItem("abnormalTime") != null)
		{
			...
			if (ExternalConfig.PR_ENABLE_MODIFY_SKILL_DURATION)
			{
				if (ExternalConfig.PR_SKILL_DURATION_LIST.containsKey(((L2Skill) template).getId()))
				{
					if (((L2Skill) template).getLevel() < 100)
						abnormalTime = ExternalConfig.PR_SKILL_DURATION_LIST.get(((L2Skill) template).getId());
					else if ((((L2Skill) template).getLevel() >= 100) && (((L2Skill) template).getLevel() < 140))
						abnormalTime += ExternalConfig.PR_SKILL_DURATION_LIST.get(((L2Skill) template).getId());
					else if (((L2Skill) template).getLevel() > 140)
						abnormalTime = ExternalConfig.PR_SKILL_DURATION_LIST.get(((L2Skill) template).getId());
