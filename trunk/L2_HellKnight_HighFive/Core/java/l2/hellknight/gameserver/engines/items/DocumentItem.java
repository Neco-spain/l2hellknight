 ...
 */
package l2.hellknight.gameserver.engines.items;
...
import l2.hellknight.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("l2.hellknight.gameserver.model.items.L2"+_currentItem.type).getConstructor(StatsSet.class);
