...
import l2.hellknight.gameserver.instancemanager.TerritoryWarManager.Territory;
import l2.hellknight.gameserver.model.actor.L2Character;
import l2.hellknight.gameserver.model.actor.instance.L2PcInstance;
import l2.hellknight.gameserver.model.itemcontainer.ClanWarehouse;
...
import l2.hellknight.gameserver.network.serverpackets.ExSubPledgeSkillAdd;
...
import l2.hellknight.gameserver.network.serverpackets.PledgeReceiveSubPledgeCreated;
...
import l2.hellknight.gameserver.network.serverpackets.PledgeShowMemberListDeleteAll;
...
import l2.hellknight.gameserver.network.serverpackets.PledgeSkillList.SubPledgeSkill;
import l2.hellknight.gameserver.network.serverpackets.PledgeSkillListAdd;
...
public class L2Clan
{
	...
	public boolean checkClanJoinCondition(L2PcInstance activeChar, L2PcInstance target, int pledgeType)
	{
		...
		if (target.getClanId() == 0 && getCharPenaltyExpiryTime() > System.currentTimeMillis())
		{
