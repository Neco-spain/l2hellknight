...
import l2.hellknight.gameserver.model.L2TeleportLocation;
...
public final class L2TeleporterInstance extends L2Npc
{
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		if (val == 0)
			...
			pom = npcId + "-" + val;
		if (ExternalConfig.CUSTOM_TELEPORT_ID.contains(getNpcId()))
		{
			return "data/html/teleporter/custom/" + pom + ".htm";
		}
