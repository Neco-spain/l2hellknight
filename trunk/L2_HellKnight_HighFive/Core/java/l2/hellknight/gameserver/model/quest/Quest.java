...
import l2.hellknight.gameserver.network.serverpackets.NpcQuestHtmlMessage;
...
import l2.hellknight.gameserver.scripting.ManagedScript;
import l2.hellknight.gameserver.scripting.ScriptManager;
...
public class Quest extends ManagedScript
{
	...
	public static enum QuestEventType
	{
		...
		ON_NODE_ARRIVED(true); // Triggers, when monster, processed by Walking Manager, arrives a node
	 ...
	 * Use this method instead importing {@link l2.hellknight.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link l2.hellknight.gameserver.GameTimeController}.
	 */
