...
public class L2MonsterInstance extends L2Attackable
{
	...
	/**
		 * @return true if this L2MonsterInstance (or its master) is registered in WalkingManager - L2Master mod.
		 */
		@Override
		public boolean isWalker()
		{
			if (getLeader() == null) // Master, or have no minions
				return super.isWalker();
			return getLeader().isWalker();
		}
