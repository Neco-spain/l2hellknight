...
import l2.hellknight.gameserver.custom.BadWordsManager;
...
public class SetPrivateStoreMsgSell extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(_storeMsg != null && !BadWordsManager.getInstance().checkAll(_storeMsg)) 
		{
			player.sendMessage("Thank you to monitor your language.");
			return;
		}
