...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see l2.hellknight.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link l2.hellknight.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see l2.hellknight.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see l2.hellknight.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see l2.hellknight.util.Rnd#get(int n)
	 */
