...
import l2.hellknight.gameserver.model.entity.TvTRoundEventTeleporter;
...
public class AdminTvTRoundEvent implements IAdminCommandHandler
{
	...
	private void remove(L2PcInstance activeChar, L2PcInstance playerInstance)
	{
		...
		new TvTRoundEventTeleporter(playerInstance, ExternalConfig.TVT_ROUND_EVENT_PARTICIPATION_NPC_COORDINATES, true, true);
	}
}
