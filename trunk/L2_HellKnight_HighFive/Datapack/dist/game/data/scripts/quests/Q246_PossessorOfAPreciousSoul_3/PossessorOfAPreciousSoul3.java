 ...
 */
package quests.Q246_PossessorOfAPreciousSoul_3;
...
public class PossessorOfAPreciousSoul3 extends Quest
{
	private static final String _qn = "246_PossessorOfAPreciousSoul_3";
	...
	private final int NPCS[] = { LADD, CARADINE, OSSIAN };
	...
	private final int MOBS[] = { PILGRIM_OF_SPLENDOR, JUDGE_OF_SPLENDOR, BARAKIEL, WAILING_OF_SPLENDOR, FANG_OF_SPLENDOR, CROWN_OF_SPLENDOR, SHOUT_OF_SPLENDOR };
	 ...
	 * @param descr
	 */
	public PossessorOfAPreciousSoul3(int questId, String name, String descr)
	{
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.quest.Quest#onAdvEvent(java.lang.String, l2.hellknight.gameserver.model.actor.L2Npc, l2.hellknight.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.quest.Quest#onTalk(l2.hellknight.gameserver.model.actor.L2Npc, l2.hellknight.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.quest.Quest#onKill(l2.hellknight.gameserver.model.actor.L2Npc, l2.hellknight.gameserver.model.actor.instance.L2PcInstance, boolean)
	 */
	@Override
		...
		switch (npcId)
		{
			...
			case BARAKIEL:
				...
				if (party != null)
				{
					...
					{
						QuestState pst = pm.getQuestState(_qn);
				...
				{
					QuestState pst = killer.getQuestState(_qn);
					if (pst != null)
			...
			{
				if (st != null && st.getInt("cond") == 4 && st.getQuestItemsCount(RAIN_SONG) < 1 && st.getQuestItemsCount(RAIN_SONG_FRAGMENT) < 100)
				{
					if (Rnd.get(100) < CHANCE_FOR_DROP)
					{
	...
	{
		new PossessorOfAPreciousSoul3(246, _qn, "Possessor Of A Precious Soul - 3");
	}
}
