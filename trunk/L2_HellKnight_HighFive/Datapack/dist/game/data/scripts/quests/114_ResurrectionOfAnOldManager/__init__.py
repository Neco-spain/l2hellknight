...
from l2.hellknight.gameserver.datatables import SpawnTable
...
from l2.hellknight.gameserver.network import NpcStringId
from l2.hellknight.gameserver.network.serverpackets import NpcSay
