...
public class Q241_PossessorOfAPreciousSoul_1 extends Quest
{
	private static final String qn = "Q241_PossessorOfAPreciousSoul_1";
	...
	// CHANCE
	private static final int CRIMSON_MOSS_CHANCE = (10 * (int) Config.RATE_QUEST_DROP);; // guessed H5
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			if (cond == 15 && st.getQuestItemsCount(CRIMSON_MOSS) >= 5)
			{
				st.set("cond", "16");
		...
		{
			if (cond == 20 && st.getQuestItemsCount(LUNARGENT) >= 5 && st.getQuestItemsCount(HELLFIRE_OIL) >= 1)
			{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		switch (npcId)
		{
			...
			// Maluk Succubus and Maluk Succubus Turen IDs
			case 20244:
			case 20245:
			case 20283:
			case 20284:
	 ...
	 * @param descr
	 */
	public Q241_PossessorOfAPreciousSoul_1(int questId, String name, String descr)
	{
	...
	{
		new Q241_PossessorOfAPreciousSoul_1(241, qn, "Possessor Of A Precious Soul 1");
	}
}
