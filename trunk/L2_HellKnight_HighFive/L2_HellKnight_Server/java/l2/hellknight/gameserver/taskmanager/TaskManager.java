...
import static l2.hellknight.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static l2.hellknight.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static l2.hellknight.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import l2.hellknight.gameserver.taskmanager.tasks.TaskBirthday;
import l2.hellknight.gameserver.taskmanager.tasks.TaskCleanUp;
import l2.hellknight.gameserver.taskmanager.tasks.TaskDailyQuestClean;
import l2.hellknight.gameserver.taskmanager.tasks.TaskDailySkillReuseClean;
import l2.hellknight.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import l2.hellknight.gameserver.taskmanager.tasks.TaskJython;
import l2.hellknight.gameserver.taskmanager.tasks.TaskOlympiadSave;
import l2.hellknight.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import l2.hellknight.gameserver.taskmanager.tasks.TaskRecom;
import l2.hellknight.gameserver.taskmanager.tasks.TaskRestart;
import l2.hellknight.gameserver.taskmanager.tasks.TaskScript;
import l2.hellknight.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import l2.hellknight.gameserver.taskmanager.tasks.TaskShutdown;
