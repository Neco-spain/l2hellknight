...
public class WorldObjectTree<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#put(L2Object)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#remove(L2Object)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#contains(L2Object)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.util.L2ObjectMap#iterator()
	 */
	@Override
