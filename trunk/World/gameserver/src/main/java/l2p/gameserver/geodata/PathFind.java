...
import static l2p.gameserver.geodata.GeoEngine.EAST;
import static l2p.gameserver.geodata.GeoEngine.NORTH;
import static l2p.gameserver.geodata.GeoEngine.NSWE_ALL;
import static l2p.gameserver.geodata.GeoEngine.NSWE_NONE;
import static l2p.gameserver.geodata.GeoEngine.SOUTH;
import static l2p.gameserver.geodata.GeoEngine.WEST;
