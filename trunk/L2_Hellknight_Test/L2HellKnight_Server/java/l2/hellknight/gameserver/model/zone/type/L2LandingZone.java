...
public class L2LandingZone extends L2ZoneType
{
	...
	/**
	 * @see l2.hellknight.gameserver.model.zone.L2ZoneType#onDieInside(l2.hellknight.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.model.zone.L2ZoneType#onReviveInside(l2.hellknight.gameserver.model.actor.L2Character)
	 */
	@Override
