package quests._508_TheClansReputation;
...
public class _508_TheClansReputation extends Quest implements ScriptFile
{
	...
	private static final int Hisilromes_Heart = 8282; // Heart obtained after defeating Shilen's Priest Hisilrome.
	...
	private static final int CLAN_POINTS_REWARD = 250; // middle

	// id:[RaidBossNpcId,questItemId]
	private static final int[][] REWARDS_LIST = { { 0, 0 }, { PALIBATI_QUEEN_THEMIS, THEMIS_SCALE },
			{ Shilens_Priest_Hisilrome, Hisilromes_Heart }, { GARGOYLE_LORD_TIPHON, TIPHON_SHARD },
			{ LAST_LESSER_GIANT_GLAKI, GLAKIS_NECLEUS }, { RAHHA, RAHHAS_FANG },
			{ FLAMESTONE_GIANT, NUCLEUS_OF_FLAMESTONE_GIANT } };

	private static final int[][] RADAR = { { 0, 0, 0 }, { 192346, 21528, -3648 }, { 191979, 54902, -7658 },
			{ 170038, -26236, -3824 }, { 171762, 55028, -5992 }, { 117232, -9476, -3320 }, { 144218, -5816, -4722 }, };
