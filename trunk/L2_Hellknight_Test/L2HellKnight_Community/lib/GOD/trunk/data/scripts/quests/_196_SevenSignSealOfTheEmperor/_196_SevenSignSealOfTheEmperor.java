...
public class _196_SevenSignSealOfTheEmperor extends Quest implements ScriptFile
{
	...
	private static long Last_Spawned_Mammon = 0;
	...
	{
		return L2ObjectsStorage.contains(Last_Spawned_Mammon);
	}
	...
	public _196_SevenSignSealOfTheEmperor()
	{
		...
		/*addTalkId(PromiseofMammon);
		addTalkId(Shunaiman);
		addTalkId(Leon);
		addTalkId(CourtMagician);
		addTalkId(DisciplesGatekeeper);
		addTalkId(Wood);*/
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		{   
			...
			L2NpcInstance mammon = st.addSpawn(MerchantofMammon,109704,219976,-3512,180000);
			Last_Spawned_Mammon = mammon.getStoredId();
		...
		else if(event.equalsIgnoreCase("32584-05.htm"))
		{
			...
			Last_Spawned_Mammon = 0; //Убираем мамона чтобы небыло косяков...
			npc.decayMe();
		}
