...
public class _737_DenyBlessings extends Quest implements ScriptFile
{
	private static final List<ClassId> ClassList = Arrays.asList(new ClassId[] { ClassId.bishop, ClassId.prophet,
			ClassId.elder, ClassId.shillienElder, ClassId.warcryer, ClassId.cardinal, ClassId.hierophant, ClassId.evaSaint,
			ClassId.shillienSaint, ClassId.doomcryer });

	private static final int REWARD = 10;
	private static final int RANDOM_MIN = 3;
	private static final int RANDOM_MAX = 8;
	private static final String[] Text = new String[] { "Out of MAX Priests you have defeated KILL.",
