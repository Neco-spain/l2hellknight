...
public class _334_TheWishingPotion extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = { { 1, 2, SECRET_KEEPER_TREE, 0, SECRET_BOOK_ID, 1, 100, 1 },
			{ 3, 0, AMBER_BASILISK, 0, AMBER_SCALE_ID, 1, 15, 1 }, { 3, 0, WHISPERING_WIND, 0, WIND_SOULSTONE_ID, 1, 20, 1 },
			{ 3, 0, GLASS_JAGUAR, 0, GLASS_EYE_ID, 1, 35, 1 },
			{ 3, 0, HORROR_MIST_RIPPER, 0, HORROR_ECTOPLASM_ID, 1, 15, 1 }, { 3, 0, SILENOS, 0, SILENOS_HORN_ID, 1, 30, 1 },
			{ 3, 0, ANT_SOLDIER, 0, ANT_SOLDIER_APHID_ID, 1, 40, 1 },
			{ 3, 0, ANT_WARRIOR_CAPTAIN, 0, ANT_SOLDIER_APHID_ID, 1, 40, 1 },
			{ 3, 0, TYRANT, 0, TYRANTS_CHITIN_ID, 1, 50, 1 }, { 3, 0, TYRANT_KINGPIN, 0, TYRANTS_CHITIN_ID, 1, 50, 1 },
	...
	public _334_TheWishingPotion()
	{
		...
		addQuestItem(new int[] { ALCHEMY_TEXT_ID, SECRET_BOOK_ID, AMBER_SCALE_ID, WIND_SOULSTONE_ID, GLASS_EYE_ID,
