...
public class _287_FiguringItOut extends Quest implements ScriptFile
{
	...
	private static final int REWARD[] = { 15646, 15649, 15652, 15655, 15658, 15772, 15773, 15774, 15776, 15779, 15782, 15785, 15788 };
	private static final int REWARDCOUNT[] = { 5, 5, 5, 5, 5, 1, 1, 1, 1, 1, 1, 1, 1 };
	...
	public String onKill(L2NpcInstance npc, QuestState st)
	{
		...
		if(cond == 1)
		{
			if(arrayContains(MOB, npcId))
			{
				if(Rnd.chance(80))
				{
					st.giveItems(BLOOD, ConfigSystem.getInt("RateQuestsDrop"), false);
