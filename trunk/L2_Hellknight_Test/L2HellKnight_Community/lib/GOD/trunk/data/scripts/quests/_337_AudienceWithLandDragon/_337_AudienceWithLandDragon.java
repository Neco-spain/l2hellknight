...
public class _337_AudienceWithLandDragon extends Quest implements ScriptFile
{
	...
	public final int[][] DROPLIST = { { 2, MARSH_STALKER, STALKER_HORN_ID, 1, 50, 1 },
			{ 2, MARSH_DRAKE, DRAKE_TALON_ID, 1, 50, 1 },
			{ 4, SACRIFICE_OF_THE_SACRIFICED, REMAINS_OF_SACRIFICED_ID, 1, 50, 1 },
			{ 6, HARIT_LIZARDMAN_ZEALOT, TOTEM_OF_LAND_DRAGON_ID, 1, 50, 1 }, { 8, HAMRUT, HAMRUT_LEG_ID, 1, 50, 1 },
			{ 8, KRANROT, KRANROT_SKIN_ID, 1, 50, 1 }, { 11, JEWEL_GUARDIAN_MARA, MARA_FANG_ID, 1, 50, 1 },
			{ 11, ABYSSAL_JEWEL_1, FIRST_ABYSS_FRAGMENT_ID, 1, 100, 1 },
			{ 13, JEWEL_GUARDIAN_MUSFEL, MUSFEL_FANG_ID, 1, 50, 1 },
			{ 13, ABYSSAL_JEWEL_2, SECOND_ABYSS_FRAGMENT_ID, 1, 100, 1 },
			{ 16, ABYSSAL_JEWEL_3, THIRD_ABYSS_FRAGMENT_ID, 1, 100, 1 }, };
	//	  # [STEP, MOB, SPWN_MOB, SPWN_COUNT,]
	public final int[][] SPAWNLIST = { { 4, BLOOD_QUEEN, SACRIFICE_OF_THE_SACRIFICED, 6 },
			{ 6, HARIT_LIZARDMAN_SHAMAN, HARIT_LIZARDMAN_ZEALOT, 1 },
			{ 6, HARIT_LIZARDMAN_MATRIARCH, HARIT_LIZARDMAN_ZEALOT, 1 }, { 11, ABYSSAL_JEWEL_1, JEWEL_GUARDIAN_MARA, 4 },
			{ 13, ABYSSAL_JEWEL_2, JEWEL_GUARDIAN_MUSFEL, 4 }, { 16, CAVE_KEEPER, ABYSSAL_JEWEL_3, 1 },
			{ 16, CAVE_MAIDEN, ABYSSAL_JEWEL_3, 1 }, { 16, ABYSSAL_JEWEL_3, JEWEL_GUARDIAN_PYTON, 6 }, };
	...
	public _337_AudienceWithLandDragon()
	{
		...
		addQuestItem(new int[] { FEATHER_OF_GABRIELLE_ID, HERALD_OF_SLAYER_ID, STALKER_HORN_ID, DRAKE_TALON_ID,
				REMAINS_OF_SACRIFICED_ID, TOTEM_OF_LAND_DRAGON_ID, HAMRUT_LEG_ID, KRANROT_SKIN_ID, MARA_FANG_ID,
				FIRST_ABYSS_FRAGMENT_ID, MUSFEL_FANG_ID, SECOND_ABYSS_FRAGMENT_ID, THIRD_ABYSS_FRAGMENT_ID, MARK_OF_WATCHMAN_ID });
	}
