...
public class _420_LittleWings extends Quest implements ScriptFile
{
	...
	// Items
	private static short Coal = 1870;
	private static short Charcoal = 1871;
	private static short Silver_Nugget = 1873;
	private static short Stone_of_Purity = 1875;
	private static short GemstoneD = 2130;
	private static short GemstoneC = 2131;
	...
	private static short Hatchlings_Mithril_Coat = 3918;
	...
	private static short Toad_Lord_Back_Skin = 3820;
	private static short Juice_of_Monkshood = 3821;

	private static short Scale_of_Drake_Exarion = 3822;
	private static short Scale_of_Drake_Zwov = 3824;
	private static short Scale_of_Drake_Kalibran = 3826;
	private static short Scale_of_Wyvern_Suzet = 3828;
	private static short Scale_of_Wyvern_Shamhai = 3830;

	private static short Egg_of_Drake_Exarion = 3823;
	private static short Egg_of_Drake_Zwov = 3825;
	private static short Egg_of_Drake_Kalibran = 3827;
	private static short Egg_of_Wyvern_Suzet = 3829;
	private static short Egg_of_Wyvern_Shamhai = 3831;
	...
	private static short[][] Fairy_Stone_Items = { { Coal, 10 }, { Charcoal, 10 }, { GemstoneD, 1 },
			{ Silver_Nugget, 3 }, { Toad_Lord_Back_Skin, 10 } };

	private static short[][] Delux_Fairy_Stone_Items = { { Coal, 10 }, { Charcoal, 10 }, { GemstoneC, 1 },
			{ Stone_of_Purity, 1 }, { Silver_Nugget, 5 }, { Toad_Lord_Back_Skin, 20 } };
