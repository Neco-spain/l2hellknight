...
import quests._10287_StoryOfThoseLeft._10287_StoryOfThoseLeft;
...
public class _10288_SecretMission extends Quest implements ScriptFile
{
	...
	public CheckStatus LAST_CHECK_STATUS = CheckStatus.FREYA;
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == _dominic)
		{
			...
			{
				case CREATED:
					QuestState _prev = st.getPlayer().getQuestState(_10287_StoryOfThoseLeft.class);
		...
		else if(npc.getNpcId() == _greymore && st.getInt("cond") == 2){ return "32757-01.htm"; }
		return htmltext;
	}
