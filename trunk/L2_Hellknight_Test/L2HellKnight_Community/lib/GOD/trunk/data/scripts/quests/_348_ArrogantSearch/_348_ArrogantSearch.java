...
public class _348_ArrogantSearch extends Quest implements ScriptFile
{
	...
	private final static HashMap<Integer, Integer[]> ARKS = new HashMap<Integer, Integer[]>();
	private final static HashMap<Integer, String[]> ARKS_TEXT = new HashMap<Integer, String[]>();
	//npc: letter to take, item to check for, 1st time htm, return htm, completed part htm, [x,y,z of chest]
	private final static HashMap<Integer, Integer[]> ARK_OWNERS = new HashMap<Integer, Integer[]>();
	private final static HashMap<Integer, String[]> ARK_OWNERS_TEXT = new HashMap<Integer, String[]>();
	//mob: cond, giveItem, amount, chance%, takeItem (assumed to take only 1 of it)
	private final static HashMap<Integer, Integer[]> DROPS = new HashMap<Integer, Integer[]>();
	...
	static
	{
		...
		DROPS.put(GUARDIAN_ANGEL, new Integer[] { 25, BLOODED_FABRIC, Integer.MAX_VALUE, 25, WHITE_FABRIC_2 });
		DROPS.put(SEAL_ANGEL, new Integer[] { 25, BLOODED_FABRIC, Integer.MAX_VALUE, 25, WHITE_FABRIC_2 });
	}
