...
public class FantasyIsle extends Functions implements ScriptFile
{
	...
	private static String[] TEXT = new String[] {
			...
			"Now we also invited individuals with special talents.", "Let's welcome the first person here!", ";;;;;;Oh",
	...
	public void onLoad()
	{
		System.out.println("Loaded Service: Fantasy Isle");

		_startTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new StartTask(), 60000, 60000);
	}
	...
	private static void startQuestTimer(String event, int time, L2NpcInstance temp_npc)
	{
		...
		variables.put("npc", temp_npc.getStoredId());
