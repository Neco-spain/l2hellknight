package quests._238_SuccessFailureOfBusiness;

import l2rt.extensions.scripts.ScriptFile;
import l2rt.gameserver.model.instances.L2NpcInstance;
import l2rt.gameserver.model.quest.Quest;
import l2rt.gameserver.model.quest.QuestState;
import quests._237_WindsOfChange._237_WindsOfChange;
		...
		if(npcId == Helvetica)
			if(id == CREATED)
			{
				if(st.getPlayer().getLevel() < 82 || !st.getPlayer().isQuestCompleted(_237_WindsOfChange.class))
					return "32641-00.htm";
				if(st.getQuestItemsCount(VicinityOfTheFieldOfSilenceResearchCenter) == 0)
					return "32641-10.htm";
				return "32641-01.htm";
			}
