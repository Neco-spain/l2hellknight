...
public class _663_SeductiveWhispers extends Quest implements ScriptFile
{
	...
	// Mobs
	private final static int[] mobs = { 20674, 20678, 20954, 20955, 20956, 20957, 20958, 20959, 20960, 20961, 20962,
			20974, 20975, 20976, 20996, 20997, 20998, 20999, 21001, 21002, 21006, 21007, 21008, 21009, 21010 };
	// Quest Items
	private final static short Spirit_Bead = 8766;
	// Items
	private final static short Enchant_Weapon_D = 955;
	private final static short Enchant_Weapon_C = 951;
	private final static short Enchant_Weapon_B = 947;
	private final static short Enchant_Armor_B = 948;
	private final static short Enchant_Weapon_A = 729;
	private final static short Enchant_Armor_A = 730;
	private final static short[] Recipes_Weapon_B = { 4963, 4966, 4967, 4968, 5001, 5003, 5004, 5005, 5006, 5007 };
	private final static short[] Recipes_Weapon_B_100P = { 4182, 4185, 4186, 4187, 4193, 4195, 4196, 4197, 4198, 4199 };
	private final static short[] Ingredients_Weapon_B = { 4101, 4107, 4108, 4109, 4115, 4117, 4118, 4119, 4120, 4121 };
	// Chances
	...
	private final static LevelRewards[] rewards = {
			...
			new LevelRewards("%n% adena, %n% recipe(s) for a B-grade Weapon").add(ADENA_ID, 388000).add(Config.ALT_100_RECIPES_B ? Recipes_Weapon_B_100P : Recipes_Weapon_B, 1),
	...
	{
		private final FastMap<short[], Integer> rewards = new FastMap<short[], Integer>();
		private String txt;
		...
		{
			return add(new short[] { (short) item_id }, count);
		}

		public LevelRewards add(short[] items_id, int count)
		{
		...
		{
			for(short[] item_ids : rewards.keySet())
