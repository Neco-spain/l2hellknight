	...
	{ 
		...
		{ 
				if(st.getState() == STARTED) 
						st.rollAndGive(CursedBurialItems, (int)Config.RATE_QUESTS_DROP, DropRate);
				return null; 
		} 
  
		private static void loadMultiSell() 
		{ 
				L2Multisell.getInstance().parseFile(new File(Config.DATAPACK_ROOT, "data/scripts/quests/_645_GhostsOfBatur/12354799.xml")); 
		} 
