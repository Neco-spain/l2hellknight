...
public class ClanBBSManager extends BaseBBSManager
{
	...
	private void clanNotice(L2Player activeChar, int clanId)
	{
		...
		if(cl != null)
		{
			...
			{
				TextBuilder html = new TextBuilder("<html><body><center>");
				...
				if(!activeChar.isLangRus())
					html.append("<a action=\"bypass _bbshome\">Home</a>&nbsp;&nbsp;&gt;&nbsp;<a action=\"bypass _bbsclan_clanlist\">Clan Community</a>&nbsp;&nbsp;&gt;&nbsp;<a action=\"bypass _bbsclan_clanhome;" + clanId + "\">&$802;</a>&nbsp;&nbsp;&gt;&nbsp;Notice");
				else
					html.append("<a action=\"bypass _bbshome\">Главная</a>&nbsp;&nbsp;&gt;&nbsp;<a action=\"bypass _bbsclan_clanlist\">Сообщество Клана</a>&nbsp;&nbsp;&gt;&nbsp;<a action=\"bypass _bbsclan_clanhome;" + clanId + "\">&$802;</a>&nbsp;&nbsp;&gt;&nbsp;Новости");
				...
				if(!activeChar.isLangRus())
					html.append("<td fixwidth=600><a action=\"\">Announcements</a>&nbsp;&nbsp;<a action=\"\">Community Board</a>&nbsp;&nbsp;<a action=\"\">Management</a>&nbsp;&nbsp;<a action=\"\">Mail</a>&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_edit;" + clanId + ";cnotice\">Notice</a></td>");
				else
					html.append("<td fixwidth=600><a action=\"\">Объявления</a>&nbsp;&nbsp;<a action=\"\">Доска Объявлений</a>&nbsp;&nbsp;<a action=\"\">Управление</a>&nbsp;&nbsp;<a action=\"\">Почта</a>&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_edit;" + clanId + ";cnotice\">Новости</a></td>");
				html.append("<td fixWIDTH=5></td>");
				html.append("</tr>");
				html.append("<tr><td height=10></td></tr>");
				html.append("</table>");
				...
				if(!activeChar.isLangRus())
					if(activeChar.getClan().isNoticeEnabled())
						html.append("<tr><td fixwidth=610> Clan Notice: &nbsp;on &nbsp; <a action=\"bypass _bbsclan_clannotice_disable\">off</a>");
					else
						html.append("<tr><td fixwidth=610> Clan Notice: &nbsp;off &nbsp; <a action=\"bypass _bbsclan_clannotice_enable\">on</a>");
				else if(activeChar.getClan().isNoticeEnabled())
					html.append("<tr><td fixwidth=610> Новости Клана: &nbsp;вкл &nbsp; <a action=\"bypass _bbsclan_clannotice_disable\">выкл</a>");
				else
					html.append("<tr><td fixwidth=610> Новости Клана: &nbsp;выкл &nbsp; <a action=\"bypass _bbsclan_clannotice_enable\">вкл</a>");
				html.append("</td></tr>");
				html.append("</table>");
	 ...
	 * @param activeChar
	 */
	private void clanlist(L2Player activeChar, int page)
	{
		...
		html.append("<td width=755 height=30 align=left>");
		if(!activeChar.isLangRus())
			html.append("<a action=\"bypass _bbshome\">Home</a>&nbsp;&nbsp;&gt;&nbsp;Clan Community");
		else
			html.append("<a action=\"bypass _bbshome\">Главная</a>&nbsp;&nbsp;&gt;&nbsp;Сообщество Клана");
		html.append("</td></tr></table>");
		if(activeChar.getClanId() != 0)
		{
			...
			html.append("<td fixWIDTH=5></td>");
			if(!activeChar.isLangRus())
				html.append("<td fixWIDTH=750><a action=\"bypass _bbsclan_clanhome;" + (activeChar.getClanId() != 0 ? activeChar.getClanId() : 0) + "\">My clan: " + activeChar.getClan().getName() + "</a></td>");
			else
				html.append("<td fixWIDTH=750><a action=\"bypass _bbsclan_clanhome;" + (activeChar.getClanId() != 0 ? activeChar.getClanId() : 0) + "\">Мой клан: " + activeChar.getClan().getName() + "</a></td>");
			html.append("<td fixWIDTH=5></td>");
			html.append("</tr>");
			html.append("<tr><td height=10></td></tr>");
			html.append("</table>");
		...
		for(L2Clan cl : ClanTable.getInstance().getClans())
		{
			...
			html.append("<td FIXWIDTH=300 align=center><a action=\"bypass _bbsclan_clanhome;" + cl.getClanId() + "\">" + cl.getName() + "</a></td>");
		...
		html.append("<button action=\"bypass _bbsclan_clanlist;" + (page == 1 ? page : page - 1) + "\" back=\"L2UI_CT1.Button_DF_Left_Down\" fore=\"L2UI_CT1.Button_DF_Left\" width=15 height=15 >");
		...
		html.append("<td><table><tr><td></td></tr><tr><td>");
		html.append("<button action=\"bypass _bbsclan_clanlist;" + (page == maxpage ? page : page + 1) + "\" back=\"L2UI_CT1.Button_DF_Right_Down\" fore=\"L2UI_CT1.Button_DF_Right\" width=15 height=15 >");
		html.append("</td></tr></table></td>");
		html.append("</tr></table>");
		html.append("<table border=0 cellspacing=0 cellpadding=0>");
		...
		html.append("</td><td><edit var=\"Search\" width=130 height=15 length=\"16\"></td>");
		html.append("<td><button value=\"&$420;\" action=\"Write 5 -1 0 Search keyword keyword\" back=\"l2ui_ct1.button.button_df_small_down\" width=70 height=25 fore=\"l2ui_ct1.button.button_df_small\"></td></tr></table>");
		html.append("</center></body></html>");
		...
		if(cl != null)
		{
			...
			else
			{
				...
				if(!activeChar.isLangRus())
					...
					html.append("<a action=\"bypass _bbshome\">Главная</a>&nbsp;&nbsp;&gt;&nbsp;<a action=\"bypass _bbsclan_clanlist\">Сообщество Клана</a>");
				...
				{
					if(!activeChar.isLangRus())
						html.append("<td fixwidth=600><a action=\"\">Announcements</a>&nbsp;&nbsp;<a action=\"\">Community Board</a>&nbsp;&nbsp;<a action=\"\">Mail</a>&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_edit;" + clanId + ";cnotice\">Notice</a></td>");
					else
						html.append("<td fixwidth=600><a action=\"\">Объявления</a>&nbsp;&nbsp;<a action=\"\">Доска Объявлений</a>&nbsp;&nbsp;<a action=\"\">Почта</a>&nbsp;&nbsp;<a action=\"bypass _bbsclan_clannotice_edit;" + clanId + ";cnotice\">Новости</a></td>");
				}
				html.append("<td fixWIDTH=5></td>");
				html.append("</tr>");
				html.append("<tr><td height=10></td></tr>");
