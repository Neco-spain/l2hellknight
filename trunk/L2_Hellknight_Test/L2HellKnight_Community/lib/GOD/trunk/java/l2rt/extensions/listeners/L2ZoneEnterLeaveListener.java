...
public abstract class L2ZoneEnterLeaveListener implements MethodInvokeListener, MethodCollection
{
	 ...
	 * @see l2rt.extensions.listeners.events.L2Zone.L2ZoneEnterLeaveEvent
	 * @see l2rt.gameserver.model.L2Zone#doEnter(l2rt.gameserver.model.L2Object)
	 * @see l2rt.gameserver.model.L2Zone#doLeave(l2rt.gameserver.model.L2Object, boolean)
	 */
	@Override
