...
import static l2rt.gameserver.model.base.ClassLevel.*;
import static l2rt.gameserver.model.base.ClassType.*;
import static l2rt.gameserver.model.base.Race.*;
...
public enum PlayerClass
{
	...
	DummyEntry35(null, null, null), //137
	DummyEntry36(null, null, null), //138
	...
	private static final Set<PlayerClass> subclasseSet1 = EnumSet.of(DarkAvenger, Paladin, TempleKnight, ShillienKnight, sigelKnight);
	private static final Set<PlayerClass> subclasseSet2 = EnumSet.of(TreasureHunter, AbyssWalker, Plainswalker, othellRogue);
	private static final Set<PlayerClass> subclasseSet3 = EnumSet.of(Hawkeye, SilverRanger, PhantomRanger, yulArcher);
	private static final Set<PlayerClass> subclasseSet4 = EnumSet.of(Warlock, ElementalSummoner, PhantomSummoner, issEnchanter);
	private static final Set<PlayerClass> subclasseSet5 = EnumSet.of(Sorceror, Spellsinger, Spellhowler, feohWizard);
