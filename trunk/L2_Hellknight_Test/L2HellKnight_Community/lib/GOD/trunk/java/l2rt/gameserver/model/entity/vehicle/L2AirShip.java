...
import l2rt.gameserver.model.instances.L2AirShipControllerInstance;
import l2rt.gameserver.model.instances.L2StaticObjectInstance;
import l2rt.gameserver.model.items.L2ItemInstance;
import l2rt.gameserver.network.serverpackets.ExAirShipInfo;
import l2rt.gameserver.network.serverpackets.ExAirShipTeleportList;
import l2rt.gameserver.network.serverpackets.ExGetOffAirShip;
import l2rt.gameserver.network.serverpackets.ExStopMoveAirShip;
...
public class L2AirShip extends L2Vehicle
{
	...
	public void startMaintenanceTask()
	{
		...
		_airshipMaintenanceTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new MaintenanceTask(this), MAINTENANCE_DELAY, MAINTENANCE_DELAY);
	}
	...
	public int getFuel()
	{
		return isClanAirShip() ? _fuel : MAX_FUEL;
	}
