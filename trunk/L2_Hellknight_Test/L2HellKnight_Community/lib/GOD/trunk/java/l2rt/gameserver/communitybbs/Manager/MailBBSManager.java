...
import l2rt.gameserver.network.serverpackets.ExMailArrived;
...
public class MailBBSManager extends BaseBBSManager
{
	...
	private void showInbox(L2Player activeChar, int page)
	{
		...
		htmlCode.append("<td align=right><button action=\"bypass _maillist_0_1_0_ ").append(page == 1 ? page : page - 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_left_down\" fore=\"L2UI_ct1.button_df_left\"></td>");
		for(int i = 1; i <= 7; i++)
			htmlCode.append("<td align=center fixedwidth=10><a action=\"bypass _maillist_0_1_0_ ").append(i).append("\">").append(i).append("</a></td>");
		htmlCode.append("<td align=left><button action=\"bypass _maillist_0_1_0_ ").append(page + 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_right_down\" fore=\"L2UI_ct1.button_df_right\"></td>");
		htmlCode.append("</tr></table>");
		...
		htmlCode.append("<td align=left><button value=\"Search\" action=\"bypass _maillist_0_1_0_search $combo $keyword\" width=60 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
	...
	private void showLetterView(L2Player activeChar, UpdateMail letter)
	{
		...
		htmlCode.append("<img src=\"L2UI.SquareGrey\" width=\"770\" height=\"1\">");
		htmlCode.append("<table width=770><tr>");
		htmlCode.append("<td align=left><button value=\"View List\" action=\"bypass _maillist_0_1_0_\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td FIXWIDTH=300></td>");
		htmlCode.append("<td align=right><button value=\"Reply\" action=\"bypass _maillist_0_1_0_reply ").append(letter.letterId).append("\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=right><button value=\"Deliver\" action=\"bypass _maillist_0_1_0_deliver\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=right><button value=\"Delete\" action=\"bypass _maillist_0_1_0_delete ").append(letter.letterId).append("\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=right><button value=\"Store\" action=\"bypass _maillist_0_1_0_store ").append(letter.letterId).append("\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=right><button value=\"Mail Writing\" action=\"bypass _maillist_0_1_0_write\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("</tr></table>");
		htmlCode.append("</body></html>");
		separateAndSend(htmlCode.toString(), activeChar);
	}
	...
	private void showSentbox(L2Player activeChar, int page)
	{
		...
		htmlCode.append("</tr></table>");
		htmlCode.append("<center><table width=770><tr>");
		htmlCode.append("<td align=right><button action=\"bypass _maillist_0_1_0_sentbox ").append(page == 1 ? page : page - 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_left_down\" fore=\"L2UI_ct1.button_df_left\"></td>");
		for(int i = 1; i <= 7; i++)
		...
		htmlCode.append("<td align=left><button action=\"bypass _maillist_0_1_0_sentbox ").append(page + 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_right_down\" fore=\"L2UI_ct1.button_df_right\"></td>");
		htmlCode.append("</tr></table>");
		htmlCode.append("<table><tr>");
		htmlCode.append("<td align=right><combobox width=65 var=combo list=\"Writer\"></td>");
		htmlCode.append("<td align=center><edit var=\"keyword\" width=130 height=11 length=\"16\"></td>");
	...
	private void showWriteView(L2Player activeChar)
	{
		...
		htmlCode.append("<td align=left><button value=\"Cancel\" action=\"bypass _maillist_0_1_0_\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=left><button value=\"Delete\" action=\"bypass _maillist_0_1_0_delete 0\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
	...
	private void showWriteView(L2Player activeChar, String parcipientName, UpdateMail letter)
	{
		...
		htmlCode.append("<td align=left><button value=\"Cancel\" action=\"bypass _maillist_0_1_0_\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td align=left><button value=\"Delete\" action=\"bypass _maillist_0_1_0_delete ").append(letter.letterId).append("\" width=70 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		htmlCode.append("<td FIXWIDTH=400></td>");
		htmlCode.append("</tr></table>");
		htmlCode.append("</body></html>");
		try
