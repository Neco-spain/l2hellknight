package l2rt.gameserver.xml.parser;
...
public class EtcItemParser extends Parser {
    public static void main(String[] args) {
        initialize(Config.DATAPACK_ROOT + "/data/stats/items/etcitem");
        ...
        try {
            ...
            while(rs.next()) {
                ...
                if(rs.getInt("item_r") > 0)
                    addSet(etcitem, "item_r", rs.getString("item_r"));
            ...
            saveAll(Config.DATAPACK_ROOT + "/data/stats/items/etcitem/", "\t", true);
