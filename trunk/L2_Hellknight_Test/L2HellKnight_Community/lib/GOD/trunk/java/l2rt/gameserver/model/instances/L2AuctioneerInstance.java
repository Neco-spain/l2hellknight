...
import l2rt.gameserver.model.entity.Auction.Bidder;
	...
	public void onBypassFeedback(L2Player player, String command)
	{
		...
		else if(actualCommand.equalsIgnoreCase("doCancelAuction"))
		{
			...
			if(auction != null)
			{
				...
				player.sendMessage(new CustomMessage("l2rt.gameserver.model.instances.L2AuctioneerInstance.CanceledAuction", player));
			}
			return;
		}
