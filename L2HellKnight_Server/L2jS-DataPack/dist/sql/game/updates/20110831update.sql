...
ADD COLUMN `hitman`  int(16) NOT NULL DEFAULT 0 AFTER `createTime`;
...
CHANGE `isFourStars` `sendBySystem` tinyint(1) unsigned NOT NULL DEFAULT '0' AFTER `isLocked`,
CHANGE `isNews` `isReturned` enum('true','false') NOT NULL DEFAULT 'false' AFTER `sendBySystem`;
