 ...
 */
package com.l2js.loginserver.network;
...
import com.l2js.loginserver.SessionKey;
import com.l2js.loginserver.network.serverpackets.L2LoginServerPacket;
import com.l2js.loginserver.network.serverpackets.LoginFail;
import com.l2js.loginserver.network.serverpackets.PlayFail;
import com.l2js.loginserver.network.serverpackets.LoginFail.LoginFailReason;
import com.l2js.loginserver.network.serverpackets.PlayFail.PlayFailReason;
import com.l2js.util.Rnd;
import com.l2js.util.crypt.LoginCrypt;
import com.l2js.util.crypt.ScrambledKeyPair;
...
public final class L2LoginClient extends MMOClient<MMOConnection<L2LoginClient>>
{
	...
	/**
	 * @see com.l2js.mmocore.interfaces.MMOClient#decrypt(java.nio.ByteBuffer, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.mmocore.interfaces.MMOClient#encrypt(java.nio.ByteBuffer, int)
	 */
	@Override
