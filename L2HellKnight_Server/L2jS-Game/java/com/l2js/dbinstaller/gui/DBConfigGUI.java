 ...
 */
package com.l2js.dbinstaller.gui;
...
import com.l2js.dbinstaller.RunTasks;
import com.l2js.dbinstaller.util.mysql.MySqlConnect;
import com.l2js.dbinstaller.util.swing.SpringUtilities;
import com.l2js.images.ImagesTable;
...
public class DBConfigGUI extends JFrame
{
	...
	public DBConfigGUI(String db, String dir, String cleanUp)
	{
		...
		_dbPass.setText(_prop.get("dbPass_" + db, "root"));
		...
		ActionListener connectListener = new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (connector.getConnection() != null)
				{
					...
					int n = JOptionPane.showOptionDialog(null, "Select Installation Type", "Installation Type", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,
							options[1]);
