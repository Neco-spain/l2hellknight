 ...
 */
package com.l2js.gameserver.skills.l2skills;
...
public class L2SkillSiegeFlag extends L2Skill
{
	...
	/**
	 * @see com.l2jserver.gameserver.model.L2Skill#useSkill(com.l2jserver.gameserver.model.actor.L2Character,
	...
	public void useSkill(L2Character activeChar, L2Object[] targets)
	{
		...
		if (TerritoryWarManager.getInstance().isTWInProgress())
		{
			...
			{
				// Spawn a new flag
				L2SiegeFlagInstance flag = new L2SiegeFlagInstance(player, IdFactory.getInstance().getNextId(), NpcTable.getInstance().getTemplate((_isOutpost ? 36590 : 35062)), _isAdvanced,
						_isOutpost);
