...
public class EffectCancel extends L2Effect
{
	...
	private static boolean cancel(L2Character caster, L2Character target, L2Effect effect)
	{
		...
		if (caster.isDebug())
		{
			...
			StringUtil.append(stat, effect.getSkill().getName(), " power:", String.valueOf((int) effect.getEffectPower()), " lvl:", String.valueOf(cancelLvl), " res:", String.format("%1.2f", resMod),
