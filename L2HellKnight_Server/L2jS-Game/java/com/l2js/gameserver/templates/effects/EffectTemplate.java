 ...
 */
package com.l2js.gameserver.templates.effects;
...
import com.l2js.gameserver.model.ChanceCondition;
...
public class EffectTemplate
{
	...
	public EffectTemplate(Condition pAttachCond, Condition pApplayCond, String func, Lambda pLambda, int pCounter, int pAbnormalTime, AbnormalEffect pAbnormalEffect, AbnormalEffect[] pSpecialEffect,
			AbnormalEffect pEventEffect, String pAbnormalType, byte pAbnormalLvl, boolean showicon, double ePower, L2SkillType eType, int trigId, int trigLvl, ChanceCondition chanceCond,
			boolean passiveEff)
	{
		...
		try
		{
			_func = Class.forName("com.l2js.gameserver.skills.effects.Effect" + func);
		}
	...
	public L2Effect getStolenEffect(Env env, L2Effect stolen)
	{
		...
		try
		{
			func = Class.forName("com.l2js.gameserver.skills.effects.Effect" + stolen.getEffectTemplate().funcName);
		}
		catch (ClassNotFoundException e)
		{
			throw new RuntimeException(e);
