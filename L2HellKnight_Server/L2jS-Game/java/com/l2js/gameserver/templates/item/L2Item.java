 ...
 */
package com.l2js.gameserver.templates.item;
...
import com.l2js.gameserver.skills.SkillHolder;
import com.l2js.gameserver.skills.conditions.Condition;
import com.l2js.gameserver.skills.conditions.ConditionLogicOr;
import com.l2js.gameserver.skills.conditions.ConditionPetType;
...
public abstract class L2Item
{
	...
	protected L2Item(StatsSet set)
	{
		...
		_materialType = ItemTable._materials.get(set.getString("material", "steel")); // default is steel, yeah and
																						// what?
		...
		_pvpItem = (_itemId >= 10667 && _itemId <= 10835) || (_itemId >= 12852 && _itemId <= 12977) || (_itemId >= 14363 && _itemId <= 14525) || _itemId == 14528 || _itemId == 14529
				|| _itemId == 14558 || (_itemId >= 15913 && _itemId <= 16024) || (_itemId >= 16134 && _itemId <= 16147) || _itemId == 16149 || _itemId == 16151 || _itemId == 16153 || _itemId == 16155
				|| _itemId == 16157 || _itemId == 16159 || (_itemId >= 16168 && _itemId <= 16176) || (_itemId >= 16179 && _itemId <= 16220);
	}
	...
	public void attach(FuncTemplate f)
	{
		...
		else
		{
			...
			// Definition : arraycopy(array source, begins copy at this position of source, array destination, begins
			// copy at this position in dest,
