...
import com.l2js.gameserver.datatables.AccessLevels;
...
import com.l2js.gameserver.model.L2AccessLevel;
...
public class Die extends L2GameServerPacket
{
	...
	public Die(L2Character cha)
	{
		...
		_canTeleport = !((cha instanceof L2PcInstance && ((TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(_charObjId)) || (DMEvent.isStarted() && DMEvent.isPlayerParticipant(_charObjId)) || (LMEvent
				.isStarted() && LMEvent.isPlayerParticipant(_charObjId)))) || cha.isPendingRevive());
	...
	protected final void writeImpl()
	{
		...
		if (_canTeleport && _clan != null && ZoneManager.getInstance().getZone(_activeChar, L2RespawnZone.class) == null)
		{
			...
			writeD((TerritoryWarManager.getInstance().getFlagForClan(_clan) != null) || (siegeClan != null && !isInCastleDefense && !isInFortDefense && !siegeClan.getFlag().isEmpty())
					|| (hall != null && hall.getSiege().checkIsAttacker(_clan)) ? 0x01 : 0x00);       // 6d 03 00 00 00 - to
																								// siege HQ
