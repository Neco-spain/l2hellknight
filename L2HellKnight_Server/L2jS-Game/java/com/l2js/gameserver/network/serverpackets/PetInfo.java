...
public class PetInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(1);
		writeD(_summon.getOwner() != null ? _summon.getOwner().getPvpFlag() : 0);	// 0 = white,2= purpleblink, if its
		...
		writeD(_summon.getAbnormalEffect());// c2 abnormal visual effect... bleed=1; poison=2; poison & bleed=3;
											// flame=4;
