 ...
 */
package com.l2js.gameserver.network.communityserver;
...
import com.l2js.gameserver.network.communityserver.readpackets.AuthResponse;
import com.l2js.gameserver.network.communityserver.readpackets.ClanNoticeInfo;
import com.l2js.gameserver.network.communityserver.readpackets.ConnectionError;
import com.l2js.gameserver.network.communityserver.readpackets.InitCS;
import com.l2js.gameserver.network.communityserver.readpackets.RequestPlayerShowBoard;
import com.l2js.gameserver.network.communityserver.readpackets.RequestPlayerShowMessage;
import com.l2js.gameserver.network.communityserver.readpackets.RequestWorldInfo;
	...
	public static final void initialize()
	{
		if (_instance == null)
		{
			if (Config.ENABLE_COMMUNITY_BOARD)
			{
				try
				{
					_instance = new CommunityServerThread(new NetConnectionConfig(Config.COMMUNITY_SERVER_CONFIG));
					_instance.start();
				}
				catch (Exception e)
				{
