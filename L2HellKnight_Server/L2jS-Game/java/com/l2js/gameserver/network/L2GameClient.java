...
import com.l2js.gameserver.LoginServerThread.SessionKey;
...
import com.l2js.gameserver.instancemanager.AntiFeedManager;
import com.l2js.gameserver.model.CharSelectInfoPackage;
...
import com.l2js.gameserver.security.SecondaryPasswordAuth;
			...
			try
			{
				if ((getActiveChar() != null) && !isDetached())
				{
					...
					if (offlineMode(getActiveChar()))
					{
						...
						getActiveChar().setIsInvul(Config.OFFLINE_MODE_SET_INVULNERABLE);
