...
import com.l2js.gameserver.TaskPriority;
...
import com.l2js.gameserver.model.entity.Couple;
import com.l2js.gameserver.model.entity.Fort;
import com.l2js.gameserver.model.entity.FortSiege;
import com.l2js.gameserver.model.entity.L2Event;
import com.l2js.gameserver.model.entity.Siege;
import com.l2js.gameserver.model.entity.clanhall.AuctionableHall;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.MULTIBOX_PROTECTION_ENABLED)
			IPManager.getInstance().validBox(activeChar, Config.MULTIBOX_PROTECTION_CLIENTS_PER_PC, L2World.getInstance().getAllPlayersArray(), true);
		...
		{
			activeChar.sendMessage(getText("QSBwcm9qZWN0IGZvdW5kZWQgYnkgTDBuZ2gwcm4gYW5kIGRldmVsb3BlZCBieSB0aGU=\n"));
			activeChar.sendMessage(getText("TDJqUyBEZXYgVGVhbSBhdCBsMmpzLmNvbS5icg==\n"));
			
			if (Config.DISPLAY_SERVER_VERSION)
			{
				if (Config.SERVER_VERSION != null)
					activeChar.sendMessage(getText("TDJqUy1TZXJ2ZXIgVmVyc2lvbjo=") + " " + Config.SERVER_VERSION);
				
				if (Config.DATAPACK_VERSION != null)
					activeChar.sendMessage(getText("TDJqUy1EYXRhcGFjayBWZXJzaW9uOg==") + " " + Config.DATAPACK_VERSION);
			}
			activeChar.sendMessage(getText("Q29weXJpZ2h0IDIwMTAtMjAxMA==\n"));
		}
