...
public final class RequestRestartPoint extends L2GameClientPacket
{
		...
		public void run()
		{
			...
			switch (_requestedPointType)
			{
				...
				case 5: // Fixed or Player is a festival participant
					...
					loc = new Location(activeChar.getX(), activeChar.getY(), activeChar.getZ()); // spawn them where
																									// they died
					break;
	...
	protected void runImpl()
	{
		...
		if ((TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(activeChar.getObjectId())) || (DMEvent.isStarted() && DMEvent.isPlayerParticipant(activeChar.getObjectId()))
				|| (LMEvent.isStarted() && LMEvent.isPlayerParticipant(activeChar.getObjectId())))
			return;
