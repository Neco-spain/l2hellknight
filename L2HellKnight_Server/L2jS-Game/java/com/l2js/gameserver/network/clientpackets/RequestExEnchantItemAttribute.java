...
public class RequestExEnchantItemAttribute extends L2GameClientPacket
{
	...
	public int getLimit(L2ItemInstance item, int sotneId)
	{
		...
		if (item.isWeapon())
			return Elementals.WEAPON_VALUES[getMax(elementItem._type._maxLevel, Config.ELEMENTAL_LEVEL_WEAPON)];
		else
			return Elementals.ARMOR_VALUES[getMax(elementItem._type._maxLevel, Config.ELEMENTAL_LEVEL_ARMOR)];
	}
