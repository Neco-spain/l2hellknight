...
import com.l2js.gameserver.network.serverpackets.AskJoinParty;
...
public final class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (target.isInOlympiadMode() || requestor.isInOlympiadMode())
		{
			...
			{
				requestor
						.sendPacket(SystemMessageId.A_USER_CURRENTLY_PARTICIPATING_IN_THE_OLYMPIAD_CANNOT_SEND_PARTY_AND_FRIEND_INVITATIONS);
				return;
			}
		}
