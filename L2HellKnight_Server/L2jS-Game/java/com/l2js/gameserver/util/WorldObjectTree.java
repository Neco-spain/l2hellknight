 ...
 */
package com.l2js.gameserver.util;
...
public class WorldObjectTree<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#put(T)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#remove(T)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#contains(T)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.util.L2ObjectMap#iterator()
	 */
	@Override
