...
import com.l2js.util.file.filter.ExtFilter;
...
public final class Util
{
	...
	public static double calculateDistance(L2Object obj1, L2Object obj2, boolean includeZAxis)
	{
		...
		return calculateDistance(obj1.getPosition().getX(), obj1.getPosition().getY(), obj1.getPosition().getZ(), obj2.getPosition().getX(), obj2.getPosition().getY(), obj2.getPosition().getZ(),
				includeZAxis);
	}
