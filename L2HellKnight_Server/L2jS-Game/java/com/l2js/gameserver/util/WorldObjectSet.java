...
public class WorldObjectSet<T extends L2Object> extends L2ObjectSet<T>
{
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#clear()
	 */
	@Override
	public void clear()
	{
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#put(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#remove(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#contains(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2js.util.L2ObjectSet#iterator()
	 */
	@Override
