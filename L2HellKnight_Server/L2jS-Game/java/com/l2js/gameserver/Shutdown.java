...
import com.l2js.gameserver.datatables.OfflineTradersTable;
...
import com.l2js.gameserver.instancemanager.GlobalVariablesManager;
import com.l2js.gameserver.instancemanager.GrandBossManager;
import com.l2js.gameserver.instancemanager.ItemAuctionManager;
...
import com.l2js.gameserver.network.serverpackets.ServerClose;
			...
			while (_secondsShut > 0)
			{
				...
				switch (_secondsShut)
				{
					...
					case 120:
						...
						break;
					case 60:
						LoginServerThread.getInstance().setServerStatus(ServerStatus.STATUS_DOWN); // avoids new players
																									// from logging in
						SendServerQuit(60);
						break;
					case 30:
