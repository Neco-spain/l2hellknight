...
public class ChatShout implements IChatHandler
{
	...
	public void handleChat(int type, L2PcInstance activeChar, String target, String text)
	{
		...
		if (isValid(activeChar) || activeChar.isGM())
		{
			...
			{
				activeChar.sendMessage("You were punished for using this chat. (-" + String.valueOf(Config.PUNISHED_AMOUNT_PVP_CHAT_SHOUT) + ")");
	...
	{
		if (Config.ENABLE_PVP_CHAT_SHOUT_BLOCK && Config.PUNISHED_AMOUNT_PVP_CHAT_SHOUT > 0 && Config.AMOUNT_PVP_CHAT_SHOUT > Config.PUNISHED_AMOUNT_PVP_CHAT_SHOUT)
			return false;
		return true;
	}
