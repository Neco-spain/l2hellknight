...
public class TvTVoicedInfo implements IVoicedCommandHandler
{
	...
	{
		"tvtinfo", "tvtjoin", "tvtleave" 
	};

	/**
	 * Set this to false and recompile script if you dont want to use string
	 * cache.
	 * This will decrease performance but will be more consistent against
	 * possible html editions during runtime
	 * Recompiling the script will get the new html would be enough too
	 * [DrHouse]
	 */
	...
	public boolean useVoicedCommand(String command, L2PcInstance activeChar, String target)
	{
		...
		if (command.equalsIgnoreCase("tvtinfo"))
		{
			...
			{
				String htmContent = (USE_STATIC_HTML && !HTML.isEmpty()) ? HTML : HtmCache.getInstance().getHtm(
						activeChar.getHtmlPrefix(), "data/html/mods/TvTEvent/Status.htm");
