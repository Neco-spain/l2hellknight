...
import com.l2js.gameserver.model.L2ExtractableProductItem;
import com.l2js.gameserver.model.L2ExtractableSkill;
...
public class Extractable implements ISkillHandler
{
	...
	{
			323, 324, 419, 519, 520, 620, 1324, 1387
	};

	private static final L2SkillType[] SKILL_TYPES =
	{
			L2SkillType.EXTRACTABLE, L2SkillType.EXTRACTABLE_FISH
	};
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		{
			_log.warning("Extractable Item Skill with no data, probably wrong/empty table with Skill Id: "
					+ skill.getId());
			return;
		}
		...
		if (player.isSubClassActive() && (skill.getReuseDelay() > 0)
				&& !Util.contains(protectedSkillIds, skill.getId()))
		{
