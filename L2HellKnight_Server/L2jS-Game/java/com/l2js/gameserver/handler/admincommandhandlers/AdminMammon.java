...
import com.l2js.gameserver.model.AutoSpawnHandler.AutoSpawnInstance;
...
public class AdminMammon implements IAdminCommandHandler
{
	...
	{
		int teleportIndex = -1;
		final AutoSpawnInstance blackSpawnInst = AutoSpawnHandler.getInstance().getAutoSpawnInstance(
				SevenSigns.MAMMON_BLACKSMITH_ID, false);
		final AutoSpawnInstance merchSpawnInst = AutoSpawnHandler.getInstance().getAutoSpawnInstance(
				SevenSigns.MAMMON_MERCHANT_ID, false);
