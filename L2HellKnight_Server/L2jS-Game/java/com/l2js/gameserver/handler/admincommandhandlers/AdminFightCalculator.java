...
public class AdminFightCalculator implements IAdminCommandHandler
{
	...
	private void handleStart(String params, L2PcInstance activeChar)
	{
		...
		else if (lvl1 != 0 && npc1 == null)
		{
			...
			{
				StringUtil.append(sb, "<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 ",
						String.valueOf(lvl1), " lvl2 ", String.valueOf(lvl2), " mid1 ", String.valueOf(n.npcId),
						" mid2 ", String.valueOf(mid2), "\">", n.name, "</a></td></tr>");
			}
		...
		else if (lvl2 != 0 && npc2 == null)
		{
			...
			{
				StringUtil.append(sb, "<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 ",
						String.valueOf(lvl1), " lvl2 ", String.valueOf(lvl2), " mid1 ", String.valueOf(mid1), " mid2 ",
