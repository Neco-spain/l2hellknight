...
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_CAST;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_INTERACT;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_PICK_UP;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_REST;
...
import com.l2js.gameserver.model.actor.L2Character.AIAccessor;
import com.l2js.gameserver.model.actor.instance.L2PcInstance;
import com.l2js.gameserver.model.actor.instance.L2StaticObjectInstance;
...
public class L2PlayerAI extends L2PlayableAI
{
	...
	synchronized void changeIntention(CtrlIntention intention, Object arg0, Object arg1)
	{
		/*
		 * if (Config.DEBUG)
		 * _log.warning("L2PlayerAI: changeIntention -> " + intention + " " +
		 * arg0 + " " + arg1);
		 */
	...
	protected void onEvtFinishCasting()
	{
		if (getIntention() == AI_INTENTION_CAST)
		{
			...
			{
				if (nextIntention._crtlIntention != AI_INTENTION_CAST) // previous
																		// state
																		// shouldn't
																		// be
																		// casting
			...
			else
			{
				 ...
				 * if (Config.DEBUG)
				 * _log.warning(
				 * "L2PlayerAI: no previous intention set... Setting it to IDLE"
				 * );
				 */
	 ...
	 * Server->Client packet AutoAttackStop (broadcast)</li> <li>Set the
	 * Intention of this AI to AI_INTENTION_MOVE_TO</li> <li>Move the actor to
	 * Location (x,y,z) server side AND client side by sending Server->Client
	...
	private void thinkCast()
	{
		...
		{
			if (maybeMoveToPosition(((L2PcInstance) _actor).getCurrentSkillWorldPosition(),
	...
	{
		if (_thinking && getIntention() != AI_INTENTION_CAST) // casting must
																// always
																// continue
			return;
