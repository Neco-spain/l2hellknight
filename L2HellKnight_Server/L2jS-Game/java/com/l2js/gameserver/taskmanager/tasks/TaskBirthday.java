...
import com.l2js.gameserver.taskmanager.TaskTypes;
...
public class TaskBirthday extends Task
{
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.l2jserver.gameserver.taskmanager.Task#onTimeElapsed(com.l2jserver.gameserver.taskmanager.TaskManager.ExecutedTask
	 * )
	 */
	@Override
