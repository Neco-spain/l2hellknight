 ...
 */
package com.l2js.gameserver.model.quest;
...
import com.l2js.gameserver.model.actor.instance.L2TrapInstance;
...
import com.l2js.gameserver.network.serverpackets.NpcQuestHtmlMessage;
import com.l2js.gameserver.scripting.ManagedScript;
import com.l2js.gameserver.scripting.ScriptManager;
import com.l2js.gameserver.templates.chars.L2NpcTemplate;
import com.l2js.gameserver.templates.item.L2Item;
import com.l2js.gameserver.util.MinionList;
...
public class Quest extends ManagedScript
{
	...
	{
		ON_FIRST_TALK(false), // control the first dialog shown by NPCs when they are clicked (some quests must override
	...
	{
		// if not overridden by a subclass, then default to the returned value of the simpler (and older) onEvent
		// override
	 ...
	 * :</U> the message held in "res" is shown in chat box</LI>
	 * 
	 * @param qs : QuestState
	...
	public L2Npc addSpawn(int npcId, int x, int y, int z, int heading, boolean randomOffset, long despawnDelay, boolean isSummonSpawn, int instanceId)
	{
		...
		try
		{
			...
			if (template != null)
			{
				// Sometimes, even if the quest script specifies some xyz (for example npc.getX() etc) by the time the
				// code
				// reaches here, xyz have become 0! Also, a questdev might have purposely set xy to 0,0...however,
				// the spawn code is coded such that if x=y=0, it looks into location for the spawn loc! This will NOT
				// work
