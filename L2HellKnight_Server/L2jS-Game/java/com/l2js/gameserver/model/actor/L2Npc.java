...
import com.l2js.gameserver.instancemanager.CHSiegeManager;
...
import com.l2js.gameserver.model.L2NpcAIData;
...
import com.l2js.gameserver.model.actor.instance.L2ClanHallManagerInstance;
import com.l2js.gameserver.model.actor.instance.L2DoormenInstance;
import com.l2js.gameserver.model.actor.instance.L2FestivalGuideInstance;
import com.l2js.gameserver.model.actor.instance.L2FishermanInstance;
import com.l2js.gameserver.model.actor.instance.L2MerchantInstance;
import com.l2js.gameserver.model.actor.instance.L2NpcInstance;
import com.l2js.gameserver.model.actor.instance.L2PcInstance;
import com.l2js.gameserver.model.actor.instance.L2TeleporterInstance;
import com.l2js.gameserver.model.actor.instance.L2TrainerHealersInstance;
import com.l2js.gameserver.model.actor.instance.L2TrainerInstance;
import com.l2js.gameserver.model.actor.instance.L2WarehouseInstance;
import com.l2js.gameserver.model.actor.knownlist.NpcKnownList;
import com.l2js.gameserver.model.actor.stat.NpcStat;
import com.l2js.gameserver.model.actor.status.NpcStatus;
import com.l2js.gameserver.model.entity.Castle;
import com.l2js.gameserver.model.entity.Fort;
import com.l2js.gameserver.model.entity.clanhall.SiegableHall;
...
import com.l2js.gameserver.network.serverpackets.AbstractNpcInfo;
import com.l2js.gameserver.network.serverpackets.ActionFailed;
import com.l2js.gameserver.network.serverpackets.ExChangeNpcState;
...
import com.l2js.gameserver.network.serverpackets.ServerObjectInfo;
import com.l2js.gameserver.network.serverpackets.SocialAction;
import com.l2js.gameserver.network.serverpackets.SystemMessage;
import com.l2js.gameserver.taskmanager.DecayTaskManager;
 ...
 * It also uses a template to fetch some static values. The templates are hardcoded in the client, so we can rely on
 * them.<BR>
 * <BR>
 * 
 * L2Character :<BR>
...
public class L2Npc extends L2Character
{
	...
	{
		// Send a Server->Client packet NpcInfo with state of abnormal effect to all L2PcInstance in the _KnownPlayers
	 ...
	 * _knownObjects and _knownPlayer of the L2NpcInstance then cancel Attack or Cast and notify AI</li> <li>Remove
	...
	public void deleteMe()
	{
		...
		// Remove all L2Object from _knownObjects and _knownPlayer of the L2Character then cancel Attak or Cast and
		// notify AI
		try
		{
	...
	// 1- Show the name, 0 - hide the name
	private byte _hidedName = 1;
	
	public void hideName(boolean val)
	{
		this._hidedName = (byte) (val ? 0 : 1);
	}
	
	public final byte getHidedName()
	{
		return this._hidedName;
	}
}
