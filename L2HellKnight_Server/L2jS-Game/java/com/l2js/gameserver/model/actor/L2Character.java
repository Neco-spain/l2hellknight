 ...
 */
package com.l2js.gameserver.model.actor;

import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.l2js.gameserver.ai.CtrlEvent;
import com.l2js.gameserver.ai.CtrlIntention;
import com.l2js.gameserver.ai.L2AttackableAI;
import com.l2js.gameserver.ai.L2CharacterAI;
import com.l2js.gameserver.datatables.DoorTable;
...
import com.l2js.gameserver.instancemanager.DimensionalRiftManager;
import com.l2js.gameserver.instancemanager.InstanceManager;
import com.l2js.gameserver.instancemanager.MapRegionManager;
import com.l2js.gameserver.instancemanager.MapRegionManager.TeleportWhereType;
import com.l2js.gameserver.instancemanager.TerritoryWarManager;
import com.l2js.gameserver.instancemanager.TownManager;
import com.l2js.gameserver.model.ChanceSkillList;
import com.l2js.gameserver.model.CharEffectList;
import com.l2js.gameserver.model.FusionSkill;
import com.l2js.gameserver.model.IChanceSkillTrigger;
...
import com.l2js.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.l2js.gameserver.model.actor.instance.L2PcInstance;
import com.l2js.gameserver.model.actor.instance.L2PcInstance.SkillDat;
import com.l2js.gameserver.model.actor.instance.L2PetInstance;
import com.l2js.gameserver.model.actor.instance.L2RiftInvaderInstance;
import com.l2js.gameserver.model.actor.knownlist.CharKnownList;
import com.l2js.gameserver.model.actor.position.CharPosition;
import com.l2js.gameserver.model.actor.stat.CharStat;
import com.l2js.gameserver.model.actor.status.CharStatus;
...
import com.l2js.gameserver.network.serverpackets.FlyToLocation.FlyType;
import com.l2js.gameserver.pathfinding.AbstractNodeLoc;
import com.l2js.gameserver.pathfinding.PathFinding;
import com.l2js.gameserver.skills.AbnormalEffect;
import com.l2js.gameserver.skills.Calculator;
import com.l2js.gameserver.skills.Formulas;
import com.l2js.gameserver.skills.Stats;
import com.l2js.gameserver.skills.effects.EffectChanceSkillTrigger;
import com.l2js.gameserver.skills.funcs.Func;
import com.l2js.gameserver.skills.l2skills.L2SkillAgathion;
import com.l2js.gameserver.skills.l2skills.L2SkillMount;
import com.l2js.gameserver.skills.l2skills.L2SkillSummon;
import com.l2js.gameserver.taskmanager.AttackStanceTaskManager;
import com.l2js.gameserver.templates.chars.L2CharTemplate;
...
import com.l2js.gameserver.util.L2TIntObjectHashMap;
...
public abstract class L2Character extends L2Object
{
	...
	// of this L2Character type (ex : Max HP, Speed...)
	...
	public void teleToLocation(int x, int y, int z, int heading, int randomOffset)
	{
		...
		// Send a Server->Client packet TeleportToLocationt to the L2Character AND to all L2PcInstance in the
		// _KnownPlayers of the L2Character
	...
	protected void doAttack(L2Character target)
	{
		...
		if (this instanceof L2PcInstance)
		{
			...
			if (target.getActingPlayer() != null && ((L2PcInstance) this).getSiegeState() > 0 && this.isInsideZone(L2Character.ZONE_SIEGE)
					&& target.getActingPlayer().getSiegeState() == ((L2PcInstance) this).getSiegeState() && target.getActingPlayer() != this
					&& target.getActingPlayer().getSiegeSide() == ((L2PcInstance) this).getSiegeSide())
			{
				//
			...
			// TODO: unhardcode this to support boolean if with that weapon u can attack or not (for ex transform
			// weapons)
		...
		if (weaponItem != null && !isTransformed())
		{
			if (weaponItem.getItemType() == L2WeaponType.BOW)
			{
				...
				if (this instanceof L2PcInstance)
				{
					// Equip arrows needed in left hand and send a Server->Client packet ItemList to the L2PcINstance
					// then return True
			...
			if (weaponItem.getItemType() == L2WeaponType.CROSSBOW)
			{
				...
				if (this instanceof L2PcInstance)
				{
					...
					// Equip bolts needed in left hand and send a Server->Client packet ItemList to the L2PcINstance
					// then return True
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Calculate if hit is missed or not</li> <li>Consume arrows</li> <li>If hit isn't missed, calculate if shield
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Calculate if hit is missed or not</li> <li>Consume bolts</li> <li>If hit isn't missed, calculate if shield
	 * defense is efficient</li> <li>If hit isn't missed, calculate if hit is critical</li> <li>If hit isn't missed,
	 * calculate physical damages</li> <li>If the L2Character is a L2PcInstance, Send a Server->Client packet SetupGauge
	 * </li> <li>Create a new hit task with Medium priority</li> <li>Calculate and set the disable delay of the crossbow
	 * in function of the Attack Speed</li> <li>Add this hit to the Server-Client packet Attack</li><BR>
	 * <BR>
	 * 
	 * @param attack Server->Client packet Attack in which the hit will be added
	 * @param target The L2Character targeted
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Get all visible objects in a spherical area near the L2Character to obtain possible targets</li> <li>If
	 * possible target is the L2Character targeted, launch a simple attack against it</li> <li>If possible target isn't
	 * the L2Character targeted but is attackable, launch a simple attack against it</li><BR>
	 * <BR>
	 * 
	 * @param attack Server->Client packet Attack in which the hit will be added
	 * 
		...
		// synchronized (getKnownList().getKnownObjects())
		{
			for (L2Object obj : objs)
			{
				...
				if (obj instanceof L2Character)
				{
					...
					if (this instanceof L2Attackable && obj instanceof L2Attackable && !((L2Attackable) this).getEnemyClan().equals(((L2Attackable) obj).getClan())
	...
	private void beginCast(L2Skill skill, boolean simultaneously, L2Character target, L2Object[] targets)
	{
		...
		if (skill.getSkillType() == L2SkillType.RESURRECT)
		{
			...
			{
				sendPacket(SystemMessage.getSystemMessage(356)); // Reject
																	// resurrection
				target.sendPacket(SystemMessage.getSystemMessage(356)); // Reject
																		// resurrection
		...
		// Note: _castEndTime = GameTimeController.getGameTicks() + (coolTime + hitTime) /
		...
		// Disable the skill during the re-use delay and create a task EnableSkill with Medium priority to enable it at
		// the end of the re-use delay
		if (reuseDelay > 10)
		{
			if (skillMastery)
			{
		...
		if (effectWhileCasting)
		{
			// Consume Items if necessary and Send the Server->Client packet InventoryUpdate with Item modification to
			// all the L2Character
	...
	public boolean doDie(L2Character killer)
	{
		...
		{
			if (((L2Playable) this).getCharmOfLuck()) // remove Lucky Charm if player has SoulOfThePhoenix/Salvation
														// buff
	 ...
	 * If 2 effects of a same group are used at the same time on a L2Character, only the more efficient (identified by
	 ...
	 * effect to Not In Use</li> <li>Update active skills in progress icons on player client</li><BR>
	 * 
	 */
	 ...
	 * L2Effect from _effects of the L2Character</li> <li>Update active skills in progress icons on player client</li><BR>
	 * 
	 */
	 ...
	 * icon</li> <li>Set the abnormal effect flag _confused to False</li> <li>Notify the L2Character AI</li> <li>Send
	 ...
	 * from _effects of the L2Character</li> <li>Update active skills in progress icons on player client</li><BR>
	 * <BR>
	 * 
	 ...
	 * icon</li> <li>Set the abnormal effect flag _fake_death to False</li> <li>Notify the L2Character AI</li><BR>
	 * <BR>
	 * 
	 */
	public final void stopFakeDeath(boolean removeEffects)
	{
		...
		// TODO: Temp hack: players see FD on ppl that are moving: Teleport to someone who uses FD - if he gets up he
		// will fall down again for that client -
	 ...
	 * <li>Set the abnormal effect flag _affraid to False</li> <li>Notify the L2Character AI</li> <li>Send
	 * Server->Client UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Delete a specified/all (if effect=null) Muted abnormal L2Effect from L2Character and update client magic icon
	 * </li> <li>Set the abnormal effect flag _muted to False</li> <li>Notify the L2Character AI</li> <li>Send
	 * Server->Client UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <li>Set the abnormal effect flag _rooted to False</li> <li>Notify the L2Character AI</li> <li>Send Server->Client
	 * UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Delete a specified/all (if effect=null) Sleep abnormal L2Effect from L2Character and update client magic icon
	 * </li> <li>Set the abnormal effect flag _sleeping to False</li> <li>Notify the L2Character AI</li> <li>Send
	 * Server->Client UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <li>Set the abnormal effect flag _stuned to False</li> <li>Notify the L2Character AI</li> <li>Send Server->Client
	 * UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Remove Transformation Effect</li> <li>Notify the L2Character AI</li> <li>Send Server->Client
	 * UserInfo/CharInfo packet</li><BR>
	 * <BR>
	 * 
	 */
	 ...
	 * <B><U> Concept</U> :</B><BR>
	 * <BR>
	 * All active skills effects in progress (In Use and Not In Use because stacked) are represented by an icon on the
	 * client.<BR>
	 * <BR>
	 * 
	 ...
	 * <B><U> Concept</U> :</B><BR>
	 * <BR>
	 * In Server->Client packet, each effect is represented by 1 bit of the map (ex : INVULNERABLE = 0x0001 (bit 1),
	 * PINK_AFFRO = 0x0020 (bit 6)...).
	 * The map is calculated by applying a BINARY OR operation on each effect.<BR>
	 * <BR>
	 * 
	 * <B><U> Example of use </U> :</B><BR>
	 ...
	 * A Func object is a mathematic function that permit to calculate the modifier of a state (ex :
	 * REGENERATE_HP_RATE...).
	 ...
	 * <B>_move</B> of the L2Character.
	 * The position of the start point and of the destination permit to estimated in function of the movement speed the
	 * time to achieve the destination.<BR>
	 * <BR>
	 * 
	 * When the movement is started (ex : by MovetoLocation), this method will be called each 0.1 sec to estimate and
	 * update the L2Character position on the server.
	 * Note, that the current server position can differe from the current client position even if each movement is
	 * straight foward.
	 * That's why, client send regularly a Client->Server ValidatePosition packet to eventually correct the gap on the
	 * server.
	...
	public boolean updatePosition(int gameTicks)
	{
		...
		if (Config.GEODATA > 0 && Config.COORD_SYNCHRONIZE == 2 && !isFloating && !m.disregardingGeodata && GameTimeController.getGameTicks() % 10 == 0 // once
																																						// a
																																						// second
																																						// to
																																						// reduce
				...
				&& GeoData.getInstance().hasGeo(xPrev, yPrev))
		{
			...
			else if (this.isInCombat() && Math.abs(dz) > 200 && (dx * dx + dy * dy) < 40000) // allow mob to climb up to
																								// pcinstance
			{
		...
		if (delta < 10000 && (dz * dz > 2500) // close enough, allows error between client and server geodata if it
												// cannot be avoided
		...
		// if (Config.DEVELOPER) _log.warning("Move Ticks:" + (gameTicks - m._moveTimestamp) + ", distPassed:" +
		// distPassed + ", distFraction:" + distFraction);
	...
	protected void moveToLocation(int x, int y, int z, int offset)
	{
		...
		if (Config.GEODATA > 0 && !isFlying() // flying chars not checked - even canSeeTarget doesn't work yet
				&& (!isInsideZone(ZONE_WATER) || isInsideZone(ZONE_SIEGE)) // swimming also not checked unless in siege
																			// zone - but distance is limited
				&& !(this instanceof L2NpcWalkerInstance)) // npc walkers not checked
		{
			...
			// Movement checks:
			// when geodata == 2, for all characters except mobs returning home (could be changed later to teleport if
			// pathfinding fails)
			...
			if ((Config.GEODATA == 2 && !(this instanceof L2Attackable && ((L2Attackable) this).isReturningToSpawnPoint())) || (this instanceof L2PcInstance && !(isInVehicle && distance > 1500))
					|| (this instanceof L2Summon && !(this.getAI().getIntention() == AI_INTENTION_FOLLOW)) // assuming
																											// intention_follow
																											// only when
																											// following
																											// owner
					|| isAfraid() || this instanceof L2RiftInvaderInstance)
			{
				...
				if (curX < L2World.MAP_MIN_X || curX > L2World.MAP_MAX_X || curY < L2World.MAP_MIN_Y || curY > L2World.MAP_MAX_Y)
				{
					...
					if (this instanceof L2PcInstance)
						...
						return; // preventation when summon get out of world coords, player will not loose him, unsummon
								// handled from pcinstance
					else
						this.onDecay();
					return;
				}
			...
			if (Config.GEODATA == 2 && originalDistance - distance > 30 && distance < 2000 && !this.isAfraid())
			{
				...
				if ((this instanceof L2Playable && !isInVehicle) || this.isMinion() || this.isInCombat())
				{
					...
					if (m.geoPath == null || m.geoPath.size() < 2) // No path found
					{
						...
						if (this instanceof L2PcInstance || (!(this instanceof L2Playable) && !this.isMinion() && Math.abs(z - curZ) > 140)
	 ...
	 * 
	 * @see com.l2js.gameserver.model.L2Character.isInsideRadius(int x, int y, int z, int radius, boolean checkZ,
	 *      boolean strictCheck)
	 */
	...
	//
	//
	// if (((distance > getAttackRange()) && (getCurrentState() == STATE_ATTACKING)) || (pawn.isMoving() &&
	// getCurrentState() != STATE_ATTACKING))
	// {
	// calculateMovement(x,y,z,distance);
	// return;
	// }
	...
	protected void onHitTimer(L2Character target, int damage, boolean crit, boolean miss, boolean soulshot, byte shld)
	{
		...
		// If attack isn't aborted, send a message system (critical hit, missed...) to attacker/target if they are
		// L2PcInstance
		if (!isAttackAborted())
		{
			...
			if (target instanceof L2PcInstance)
			{
				 ...
				 * {
				 * damage = 1;
				 * enemy.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.
				 * YOUR_EXCELLENT_SHIELD_DEFENSE_WAS_A_SUCCESS)); //SHIELD_DEFENCE faultless
				 * }
				 * else
			...
			if (!miss && damage > 0)
			{
				...
				if (!isBow && !target.isInvul()) // Do not reflect if weapon is of type bow or target is invunlerable
				{
					...
					if (!target.isRaid() || getActingPlayer() == null || getActingPlayer().getLevel() <= target.getLevel() + 8)
					{
						...
						if (reflectPercent > 0)
						{
							...
							if (reflectedDamage > target.getMaxHp()) // to prevent extreme damage when hitting a low lvl
																		// char...
				...
				if (reflectedDamage > 0)
				{
					 ...
					 * else if (this instanceof L2Summon)
					 * ((L2Summon)this).getOwner().sendMessage("Target reflected to your summon " + reflectedDamage +
					 * " damage.");
					 */
				}
	...
	public void onForcedAttack(L2PcInstance player)
	{
		...
		{
			// If L2Character or target is in a peace zone, send a system message TARGET_IN_PEACEZONE a Server->Client
			// packet ActionFailed
	...
	public L2Skill addSkill(L2Skill newSkill)
	{
		...
		if (newSkill != null)
		{
			 ...
			 * {
			 * L2Skill bestowed = SkillTable.getInstance().getInfo(newSkill.getTriggeredId(),
			 ...
			 * if(newSkill.isChance() && newSkill.triggerAnotherSkill())
			 * {
			 * L2Skill triggeredSkill =
			 * SkillTable.getInstance().getInfo(newSkill.getTriggeredId(),newSkill.getTriggeredLevel());
	...
	public L2Skill removeSkill(int skillId, boolean cancelEffect)
	{
		...
		if (oldSkill != null)
		{
			...
			if (oldSkill instanceof L2SkillSummon && oldSkill.getId() == 710 && this instanceof L2PcInstance && ((L2PcInstance) this).getPet() != null
	...
	public void onMagicLaunchedTimer(MagicUseTask mut)
	{
		...
		// Send a Server->Client packet MagicSkillLaunched to the L2Character AND to all L2PcInstance in the
		// _KnownPlayers of the L2Character
		if (!skill.isPotion())
	...
	public void onMagicHitTimer(MagicUseTask mut)
	{
		...
		try
		{
			...
			// Consume MP of the L2Character and Send the Server->Client packet StatusUpdate with current HP and MP to
			...
			// Consume HP if necessary and Send the Server->Client packet StatusUpdate with current HP and MP to all
			...
			// Consume CP if necessary and Send the Server->Client packet StatusUpdate with current CP/HP and MP to all
			// other L2PcInstance to inform
	...
	public void onMagicFinalizer(MagicUseTask mut)
	{
		...
		if (this instanceof L2PcInstance)
		{
			...
			if (queuedSkill != null)
			{
				...
				// currPlayer.useMagic(queuedSkill.getSkill(), queuedSkill.isCtrlPressed(),
				...
				if (trg instanceof L2Character)
				{
					...
					if (!Config.RAID_DISABLE_CURSE
							&& ((target.isRaid() && target.giveRaidCurse() && getLevel() > target.getLevel() + 8)
									|| (!skill.isOffensive() && targetsAttackTarget != null && targetsAttackTarget.isRaid() && targetsAttackTarget.giveRaidCurse()
											&& targetsAttackTarget.getAttackByList().contains(target) // has attacked
																										// raid
									&& getLevel() > targetsAttackTarget.getLevel() + 8) || (!skill.isOffensive() && targetsCastTarget != null && targetsCastTarget.isRaid()
									&& targetsCastTarget.giveRaidCurse() && targetsCastTarget.getAttackByList().contains(target) // has
																																	// attacked
																																	// raid
	...
	protected boolean _isDebuffInvul = false;
	
	public void setIsDebuffInvul(boolean b)
	{
		_isInvul = b;
	}
	
	public boolean isDebuffInvul()
	{
		return _isDebuffInvul;
	}
}
