...
import com.l2js.gameserver.ai.L2DoorAI;
...
import com.l2js.gameserver.model.actor.knownlist.DoorKnownList;
import com.l2js.gameserver.model.actor.stat.DoorStat;
import com.l2js.gameserver.model.actor.status.DoorStatus;
...
import com.l2js.gameserver.network.serverpackets.DoorStatusUpdate;
import com.l2js.gameserver.network.serverpackets.OnEventTrigger;
import com.l2js.gameserver.network.serverpackets.StaticObject;
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if (getClanHall() != null)
		{
			if (!getClanHall().isSiegableHall())
				return false;
			return ((SiegableHall) getClanHall()).isInSiege() && ((SiegableHall) getClanHall()).getSiege().checkIsAttacker(actingPlayer.getClan());
		}
