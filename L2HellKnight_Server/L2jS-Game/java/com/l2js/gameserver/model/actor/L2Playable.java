...
import com.l2js.gameserver.model.actor.knownlist.PlayableKnownList;
import com.l2js.gameserver.model.actor.stat.PlayableStat;
import com.l2js.gameserver.model.actor.status.PlayableStatus;
...
public abstract class L2Playable extends L2Character
{
	...
	private boolean _isTransferringDmg = false;
	private boolean _isUnderBetrayalMark = false;
	private L2Playable _isTransferringDmgTo = null;
	...
	public final void setIsUnderBetrayalMark(boolean value)
	{
		_isUnderBetrayalMark = value;
	}
	
	public final boolean isUnderBetrayalMark()
	{
		return _isUnderBetrayalMark;
	}
	
	public final void setIsTransferringDmg(boolean value)
	{
		_isTransferringDmg = value;
	}
	
	public final boolean isTransferringDmg()
	{
		return _isTransferringDmg;
	}
	
	public final void setIsTransferringDmgTo(L2Playable obj)
	{
		_isTransferringDmgTo = obj;
	}
	
	public final L2Playable isTransferringDmgTo()
	{
