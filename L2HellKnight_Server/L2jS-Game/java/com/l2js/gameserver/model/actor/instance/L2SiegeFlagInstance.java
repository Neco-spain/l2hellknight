...
import com.l2js.gameserver.model.actor.status.SiegeFlagStatus;
...
public class L2SiegeFlagInstance extends L2Npc
{
	...
	public void reduceCurrentHp(double damage, L2Character attacker, L2Skill skill)
	{
		...
		if (canTalk())
		{
			if ((getCastle() != null && getCastle().getSiege().getIsInProgress()) || (getFort() != null && getFort().getSiege().getIsInProgress())
