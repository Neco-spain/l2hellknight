...
import com.l2js.gameserver.model.L2Clan.SubPledge;
...
import com.l2js.gameserver.network.serverpackets.MagicSkillLaunched;
			...
			switch (cmdChoice)
			{
				...
				case 1: // Add Subclass - Initial
					...
					if ((subsAvailable != null) && !subsAvailable.isEmpty())
					{
						...
						{
							StringUtil.append(content1, "<a action=\"bypass -h npc_%objectId%_Subclass 4 ", String.valueOf(subClass.ordinal()), "\" msg=\"1268;", formatClassForDisplay(subClass),
				...
				case 2: // Change Class - Initial
					...
					else
					{
						...
						for (Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();)
						{
							...
							{
								StringUtil.append(content2, "<a action=\"bypass -h npc_%objectId%_Subclass 5 ", String.valueOf(subClass.getClassIndex()), "\">",
				...
				case 3: // Change/Cancel Subclass - Initial
					...
					if (player.getTotalSubClasses() > 3)
					{
						...
						for (Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();)
						{
							...
							StringUtil.append(content3, "Sub-class ", String.valueOf(classIndex++), "<br>", "<a action=\"bypass -h npc_%objectId%_Subclass 6 ",
									String.valueOf(subClass.getClassIndex()), "\">", CharTemplateTable.getInstance().getClassNameById(subClass.getClassId()), "</a><br>");
						}
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					/**
					 * If quest checking is enabled, verify if the character has completed the Mimir's Elixir (Path to
					 * Subclass)
					 * and Fate's Whisper (A Grade Weapon) quests by checking for instances of their unique reward
					 * items.
					 * 
					...
					if (allowAddition && isValidNewSubClass(player, paramOne))
					{
						...
						player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.ADD_NEW_SUBCLASS)); // Subclass
																												// added.
					}
					else
						html.setFile(player.getHtmlPrefix(), getSubClassFail());
				...
				case 5: // Change Class - Action
					...
					player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.SUBCLASS_TRANSFER_COMPLETED)); // Transfer
																													// completed.
					return;
				case 6: // Change/Cancel Subclass - Choice
					...
					for (PlayerClass subClass : subsAvailable)
					{
						StringUtil.append(content6, "<a action=\"bypass -h npc_%objectId%_Subclass 7 ", String.valueOf(paramOne), " ", String.valueOf(subClass.ordinal()), "\" msg=\"1445;", "\">",
								formatClassForDisplay(subClass), "</a><br>");
					}
				...
				case 7: // Change Subclass - Action
					...
					{
						player.abortCast();
						player.stopAllEffectsExceptThoseThatLastThroughDeath(); // all effects from old subclass
																				// stopped!
