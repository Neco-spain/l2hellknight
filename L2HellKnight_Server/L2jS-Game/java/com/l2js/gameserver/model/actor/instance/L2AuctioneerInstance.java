...
import com.l2js.gameserver.instancemanager.AuctionManager;
...
import com.l2js.gameserver.model.entity.Auction;
import com.l2js.gameserver.model.entity.Auction.Bidder;
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		else if (condition == COND_REGULAR)
		{
				...
				try
				{
					...
					if (a != null)
					{
						...
						html.replace("%AGIT_AUCTION_REMAIN%",
								String.valueOf((a.getEndDate() - System.currentTimeMillis()) / 3600000) + " hours " + String.valueOf((((a.getEndDate() - System.currentTimeMillis()) / 60000) % 60))
										+ " minutes");
						html.replace("%AGIT_AUCTION_MINBID%", String.valueOf(a.getStartingBid()));
			...
			else if (actualCommand.equalsIgnoreCase("bidlist"))
			{
				...
				{
					biders += "<tr>" + "<td>" + b.getClanName() + "</td><td>" + b.getName() + "</td><td>" + b.getTimeBid().get(Calendar.YEAR) + "/" + (b.getTimeBid().get(Calendar.MONTH) + 1) + "/"
