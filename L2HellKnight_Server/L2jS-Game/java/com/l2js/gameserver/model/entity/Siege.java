...
import com.l2js.gameserver.instancemanager.MercTicketManager;
import com.l2js.gameserver.instancemanager.SiegeGuardManager;
import com.l2js.gameserver.instancemanager.SiegeManager;
import com.l2js.gameserver.instancemanager.SiegeManager.SiegeSpawn;
import com.l2js.gameserver.model.L2Clan;
import com.l2js.gameserver.model.L2ClanMember;
import com.l2js.gameserver.model.L2Object;
import com.l2js.gameserver.model.L2SiegeClan;
import com.l2js.gameserver.model.L2SiegeClan.SiegeClanType;
import com.l2js.gameserver.model.L2Spawn;
import com.l2js.gameserver.model.actor.L2Npc;
import com.l2js.gameserver.model.actor.instance.L2ControlTowerInstance;
import com.l2js.gameserver.model.actor.instance.L2FlameTowerInstance;
import com.l2js.gameserver.model.actor.instance.L2PcInstance;
import com.l2js.gameserver.network.SystemMessageId;
import com.l2js.gameserver.network.serverpackets.ExBrExtraUserInfo;
import com.l2js.gameserver.network.serverpackets.RelationChanged;
import com.l2js.gameserver.network.serverpackets.SiegeInfo;
...
public class Siege implements Siegable
{
	...
	public class ScheduleStartSiegeTask implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				{
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining - 86400000); // Prepare
																																									// task
																																									// for
																																									// 24
																																									// before
				...
				else if ((timeRemaining <= 86400000) && (timeRemaining > 13600000))
				{
					...
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining - 13600000); // Prepare
																																									// task
																																									// for
																																									// 1
																																									// hr
				...
				{
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining - 600000); // Prepare
																																									// task
																																									// for
																																									// 10
																																									// minute
				...
				{
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining - 300000); // Prepare
																																									// task
																																									// for
																																									// 5
																																									// minute
				...
				{
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining - 10000); // Prepare
																																								// task
																																								// for
																																								// 10
																																								// seconds
				...
				{
					_scheduledStartSiegeTask = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(_castleInst), timeRemaining); // Prepare
																																						// task
																																						// for
																																						// second
																																						// count
	...
	public void endSiege()
	{
		if (getIsInProgress())
		{
			...
			teleportPlayer(Siege.TeleportWhoType.Attacker, MapRegionManager.TeleportWhereType.Town); // Teleport to the
																										// second
																										// closest town
			teleportPlayer(Siege.TeleportWhoType.DefenderNotOwner, MapRegionManager.TeleportWhereType.Town); // Teleport
																												// to
																												// the
																												// second
																												// closest
																												// town
			teleportPlayer(Siege.TeleportWhoType.Spectator, MapRegionManager.TeleportWhereType.Town); // Teleport to the
																										// second
																										// closest town
	...
	public void midVictory()
	{
		if (getIsInProgress()) // Siege still in progress
		{
			...
			if (getCastle().getOwnerId() > 0)
			{
				...
				teleportPlayer(Siege.TeleportWhoType.Attacker, MapRegionManager.TeleportWhereType.SiegeFlag); // Teleport
																												// to
																												// the
																												// second
																												// closest
																												// town
				teleportPlayer(Siege.TeleportWhoType.Spectator, MapRegionManager.TeleportWhereType.Town); // Teleport to
																											// the
																											// second
																											// closest
																											// town
	...
	public void startSiege()
	{
		if (!getIsInProgress())
		{
			...
			teleportPlayer(Siege.TeleportWhoType.Attacker, MapRegionManager.TeleportWhereType.Town); // Teleport to the
																										// closest town
			// teleportPlayer(Siege.TeleportWhoType.Spectator, MapRegionTable.TeleportWhereType.Town); // Teleport to
			// the second closest town
			...
			MercTicketManager.getInstance().deleteTickets(getCastle().getCastleId()); // remove the tickets from the
																						// ground
	...
	{
		getAttackerClans().add(new L2SiegeClan(clanId, SiegeClanType.ATTACKER)); // Add registered attacker to attacker
																					// list
	}
	...
	{
		getDefenderClans().add(new L2SiegeClan(clanId, SiegeClanType.DEFENDER)); // Add registered defender to defender
																					// list
	}
	...
	{
		getDefenderWaitingClans().add(new L2SiegeClan(clanId, SiegeClanType.DEFENDER_PENDING)); // Add registered
