	...
	public void startReg()
	{
		...
		else
		{
			...
			Announcements.getInstance().announceToAll(
					"TvT Event: Registration opened for " + (time >= 1 ? time : " less than 1") + " minute(s).");
	...
	class TvTStartTask implements Runnable
	{
		...
		private void announce(long time)
		{
			if (time >= 3600 && time % 3600 == 0)
			{
				...
				{
					Announcements.getInstance().announceToAll(
							"TvT Event: " + (time / 60 / 60) + " hour(s) until registration is closed!");
				}
				else if (TvTEvent.isStarted())
				{
					TvTEvent.sysMsgToAllParticipants("TvT Event: " + (time / 60 / 60)
			...
			else if (time >= 60)
			{
				...
				{
					Announcements.getInstance().announceToAll(
							"TvT Event: " + (time / 60) + " minute(s) until registration is closed!");
				}
				else if (TvTEvent.isStarted())
				{
			...
			else
			{
				...
				{
					Announcements.getInstance().announceToAll(
							"TvT Event: " + time + " second(s) until registration is closed!");
				}
				else if (TvTEvent.isStarted())
				{
