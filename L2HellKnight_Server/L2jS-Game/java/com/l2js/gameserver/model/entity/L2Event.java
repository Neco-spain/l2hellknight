...
import com.l2js.util.ValueSortMap;
...
public class L2Event
{
	...
	public static void registerPlayer(L2PcInstance player)
	{
		...
		if (AntiFeedManager.getInstance().tryAddPlayer(AntiFeedManager.L2EVENT_ID, player, Config.DUALBOX_CHECK_MAX_L2EVENT_PARTICIPANTS_PER_IP))
