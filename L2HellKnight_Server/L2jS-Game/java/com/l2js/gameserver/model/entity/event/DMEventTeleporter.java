...
public class DMEventTeleporter implements Runnable
{
	...
	public void run()
	{
		...
		if (Config.DM_EVENT_EFFECTS_REMOVAL == 0 || (Config.DM_EVENT_EFFECTS_REMOVAL == 1 && (_activeChar.getTeam() == 0 || (_activeChar.isInDuel() && _activeChar.getDuelState() != Duel.DUELSTATE_INTERRUPTED))))
