...
import com.l2js.gameserver.instancemanager.FortSiegeGuardManager;
...
import com.l2js.gameserver.model.CombatFlag;
...
import com.l2js.gameserver.model.actor.instance.L2FortCommanderInstance;
...
public class FortSiege implements Siegable
{
	...
	public class ScheduleStartSiegeTask implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				{
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(600), 3000000); // Prepare
																												// task
																												// for
																												// 10
																												// minutes
				...
				else if (_time == 600) // 10min remains
				{
					...
					sm.addNumber(10);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(300), 300000); // Prepare
																												// task
																												// for 5
																												// minutes
																												// left.
				...
				else if (_time == 300) // 5min remains
				{
					...
					sm.addNumber(5);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(60), 240000); // Prepare
																												// task
																												// for 1
																												// minute
																												// left.
				...
				else if (_time == 60) // 1min remains
				{
					...
					sm.addNumber(1);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(30), 30000); // Prepare
																											// task for
																											// 30
																											// seconds
																											// left.
				...
				else if (_time == 30) // 30seconds remains
				{
					...
					sm.addNumber(30);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(10), 20000); // Prepare
																											// task for
																											// 10
																											// seconds
																											// left.
				...
				else if (_time == 10) // 10seconds remains
				{
					...
					sm.addNumber(10);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(5), 5000); // Prepare
																											// task for
																											// 5 seconds
																											// left.
				}
				else if (_time == 5) // 5seconds remains
				{
					...
					sm.addNumber(5);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(1), 4000); // Prepare
																											// task for
																											// 1 seconds
																											// left.
				}
				else if (_time == 1) // 1seconds remains
				{
					...
					sm.addNumber(1);
					announceToPlayer(sm);
					ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleStartSiegeTask(0), 1000); // Prepare
																											// task
																											// start
																											// siege.
				}
	...
	public void endSiege()
	{
		if (getIsInProgress())
		{
			...
			ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleSuspiciousMerchantSpawn(), FortSiegeManager.getInstance().getSuspiciousMerchantRespawnDelay() * 60 * 1000l); // Prepare
																																														// 3hr
																																														// task
																																														// for
																																														// suspicious
	...
	public void startSiege()
	{
		if (!getIsInProgress())
		{
			...
			teleportPlayer(FortSiege.TeleportWhoType.Attacker, MapRegionManager.TeleportWhereType.Town); // Teleport to
																											// the
																											// closest
																											// town
			...
			_siegeEnd = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleEndSiegeTask(), FortSiegeManager.getInstance().getSiegeLength() * 60 * 1000l); // Prepare
																																									// auto
																																									// end
																																									// task
