...
public class LMEventTeleporter implements Runnable
{
	...
	public void run()
	{
		...
		if (Config.LM_EVENT_EFFECTS_REMOVAL == 0 || (Config.LM_EVENT_EFFECTS_REMOVAL == 1 && (_activeChar.getTeam() == 0 || (_activeChar.isInDuel() && _activeChar.getDuelState() != Duel.DUELSTATE_INTERRUPTED))))
