...
import com.l2js.gameserver.model.zone.type.L2DerbyTrackZone;
import com.l2js.gameserver.model.zone.type.L2PeaceZone;
			...
			//synchronized (_visibleObjects)
			{
				for(L2Object o: vObj)
				{
					if (o instanceof L2Attackable)
					{
						...
						if (mob.hasAI())
						{
							mob.getAI().setIntention(com.l2js.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
