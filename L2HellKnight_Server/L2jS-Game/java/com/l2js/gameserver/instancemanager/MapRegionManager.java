...
import com.l2js.gameserver.model.L2MapRegion;
...
public class MapRegionManager
{
	...
	public Location getTeleToLocation(L2Character activeChar, TeleportWhereType teleportWhere)
	{
		...
		if (activeChar instanceof L2PcInstance)
		{
			...
			if (player.getClan() != null && !player.isFlyingMounted() && !player.isFlying()) // flying players in gracia
																								// cant use teleports to
																								// aden continent
			{
