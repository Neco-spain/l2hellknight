...
public class ConfigCharacter extends Config
{
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			RESPAWN_RESTORE_HP = getDouble(properties, "RespawnRestoreHP", 65) / 100;
			RESPAWN_RESTORE_MP = getDouble(properties, "RespawnRestoreMP", 0) / 100;
			...
			ALT_GAME_CANCEL_BOW = getString(properties, "AltGameCancelByHit", "Cast").equalsIgnoreCase("bow") || getString(properties, "AltGameCancelByHit", "Cast").equalsIgnoreCase("all");
			ALT_GAME_CANCEL_CAST = getString(properties, "AltGameCancelByHit", "Cast").equalsIgnoreCase("cast") || getString(properties, "AltGameCancelByHit", "Cast").equalsIgnoreCase("all");
			...
			ALLOW_TRANSFORM_WITHOUT_QUEST = getBoolean(properties, "AltTransformationWithoutQuest", false);
			...
			BASE_SUBCLASS_LEVEL = getByte(properties, "BaseSubclassLevel", Byte.parseByte("40"));
			...
			ALT_FREIGHT_SLOTS = getInt(properties, "MaximumFreightSlots", 200);
			...
			ALT_GAME_KARMA_PLAYER_CAN_BE_KILLED_IN_PEACEZONE = getBoolean(properties, "AltKarmaPlayerCanBeKilledInPeaceZone", false);
			...
			FEE_DELETE_TRANSFER_SKILLS = getInt(properties, "FeeDeleteTransferSkills", 10000000);
			FEE_DELETE_SUBCLASS_SKILLS = getInt(properties, "FeeDeleteSubClassSkills", 10000000);
		}
		catch (Exception e)
		{
			e.printStackTrace();
