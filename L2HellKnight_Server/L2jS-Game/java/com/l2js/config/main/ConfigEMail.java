...
public class ConfigEMail extends Config
{
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			EMAIL_SYS_SELECTQUERY = getString(properties, "EmailDBSelectQuery", "SELECT value FROM account_data WHERE account_name=? AND var='email_addr'");
			EMAIL_SYS_DBFIELD = getString(properties, "EmailDBField", "value");
		}
		catch (Exception e)
		{
			e.printStackTrace();
