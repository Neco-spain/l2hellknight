...
public class ConfigGeneral extends Config
{
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			BAN_CHAT_CHANNELS = getIntArray(properties, "BanChatChannels", new int[]
			{
					0, 1, 8, 17
			}, ";");
			...
			ALT_BIRTHDAY_MAIL_SUBJECT = getString(properties, "AltBirthdayMailSubject", "Happy Birthday!");
			ALT_BIRTHDAY_MAIL_TEXT = getString(
					properties,
					"AltBirthdayMailText",
