...
public class ConfigOfflineTrade extends Config
{
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			OFFLINE_MODE_IN_PEACE_ZONE = getBoolean(properties, "OfflineModeInPaceZone", false);
			OFFLINE_MODE_SET_INVULNERABLE = getBoolean(properties, "OfflineModeSetInvulnerable", false);
