@echo off
REM ###############################################
REM ## L2HellKnight Database Installer - (by DrLecter) #
REM ###############################################
...
:loadconfig
title L2HellKnight Installer - Reading Configuration from File...
cls
...
:configure
call :colors 17
title L2HellKnight Installer - Setup
cls
...
set lsuser=root
set lspass=
set lsdb=l2hellknight
set lshost=localhost
set cbuser=root
set cbpass=
set cbdb=l2hellknight
set cbhost=localhost
set gsuser=root
set gspass=
set gsdb=l2hellknight
...
echo and reading about it. Setup and host an L2HellKnight server requires a
...
set cmdline=
set stage=1
title L2HellKnight Installer - Login Server DataBase Setup
echo.
...
:ls_err1
call :colors 47
title L2HellKnight Installer - Login Server DataBase Setup ERROR!
cls
echo.
...
cls
call :colors 57
title L2HellKnight Installer - Potential PICNIC detected at stage %stage%
echo.
...
set cmdline=
set stage=2
title L2HellKnight Installer - Login Server DataBase Setup - DB Creation
echo.
...
:ls_err2
call :colors 47
title L2HellKnight Installer - Login Server DataBase Setup - DB Creation ERROR!
cls
...
:ls_db_ok
call :colors 17
title L2HellKnight Installer - Login Server DataBase Setup - WARNING!
:ls_ask
cls
set loginprompt=u
echo.
...
call :colors 17
set cmdline=
title L2HellKnight Installer - Login Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2HellKnight Installer - Login Server DataBase Setup - Installing...
echo.
echo Installing new Login Server content.
echo.
) else (
title L2HellKnight Installer - Login Server DataBase Setup - Upgrading...
echo.
...
set cmdline=
set stage=4
title L2HellKnight Installer - Community Server DataBase Setup
echo.
...
:cb_err1
call :colors 47
title L2HellKnight Installer - Community Server DataBase Setup ERROR!
cls
echo.
echo Backup attempt failed! A possible reason for this to 
echo happen, is that your DB doesn't exist yet. I could 
...
set cmdline=
set stage=5
title L2HellKnight Installer - Communty Server DataBase Setup - DB Creation
echo.
...
:cb_err2
call :colors 47
title L2HellKnight Installer - Community Board Server DataBase Setup - DB Creation ERROR!
cls
echo An error occured while trying to create a database for 
...
:cs_db_ok
call :colors 17
title L2HellKnight Installer - Community Server DataBase Setup - WARNING!
:cs_ask
cls
...
call :colors 17
set cmdline=
title L2HellKnight Installer - Community Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2HellKnight Installer - Community Server DataBase Setup - Installing...
echo.
echo Installing new Community Server content.
echo.
) else (
title L2HellKnight Installer - Community Server DataBase Setup - Upgrading...
echo.
...
set cmdline=
set stage=7
title L2HellKnight Installer - Game Server DataBase Setup
cls
echo.
...
:gs_err1
call :colors 47
title L2HellKnight Installer - Game Server DataBase Setup - Backup ERROR!
cls
echo.
...
set stage=8
set cmdline=
title L2HellKnight Installer - Game Server DataBase Setup - DB Creation
cls
...
:gs_err2
call :colors 47
title L2HellKnight Installer - Game Server DataBase Setup - DB Creation ERROR!
cls
echo.
echo An error occured while trying to create a database for 
...
:gs_db_ok
call :colors 17
title L2HellKnight Installer - Game Server DataBase Setup - WARNING!
cls
:gs_ask
cls
set installtype=u
...
set stage=9
set cmdline=
title L2HellKnight Installer - Game Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2HellKnight Installer - Game Server DataBase Setup - Installing...
echo.
echo Installing new Game Server content.
echo.
) else (
title L2HellKnight Installer - Game Server DataBase Setup - Upgrading...
echo.
...
cls
call :colors 47
title L2HellKnight Installer - Potential DataBase Issue at stage %stage%
echo.
...
cls
call :colors 17
title L2HellKnight Installer - Game Server DataBase Setup - Logging Options turned on
set logging=1
if %full% == 1 (
...
:custom_ask
title L2HellKnight Installer - Custom Server Tables
cls
set cstprompt=n
echo.
echo L2HellKnight provides some "Custom Server Tables" for non-retail modifications
...
title L2HellKnight Installer - Custom Server Tables Process Complete
cls
echo Database structure for L2HellKnight Custom finished.
echo.
...
:mod_ask
title L2HellKnight Installer - Mod Server Tables
cls
set cstprompt=n
echo.
echo L2HellKnight provides a basic infraestructure for some non-retail features
echo (aka L2HellKnight mods) to get enabled with a minimum of changes.
echo.
...
title L2HellKnight Installer - Mod Server Tables Process Complete
cls
echo Database structure for L2HellKnight Mods finished.
echo.
echo Remember that in order to get these additions actually working 
echo you need to edit your configuration files. 
echo.
...
:horrible_end
call :colors 47
title L2HellKnight Installer - Oops!
cls
...
echo       (http://www.l2hellknight.com)
echo.
...
set dpvf="..\config\L2HellKnight-version.properties" 
...
:end
call :colors 17
title L2HellKnight Installer - Script Execution Finished
cls
echo.
echo L2HellKnight Database Installer 2011
echo.
echo (C) 2007-2011 L2HellKnight DataPack Team
