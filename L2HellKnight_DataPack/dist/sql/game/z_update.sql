...
UPDATE `npcaidata` SET enemyRange='1000', enemyClan='dummy' WHERE `npcid` IN (18828, 18834, 18835, 27351);
UPDATE `npc` SET type='L2Monster' WHERE `id` IN (18828, 18834, 18835, 27351);
UPDATE `npc` SET `aggro`='150' WHERE `id` IN (18834, 18835);
UPDATE `npc` SET `aggro`='300' WHERE `id` IN (18828, 27351);
...
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=sjis;
