...
public abstract class AbstractServerBasePacket extends L2GameServerPacket
{
	...
	/**
	 * @see l2.hellknight.util.network.BaseSendablePacket.ServerBasePacket#runImpl()
	 */
	@Override
	abstract public void runImpl();
	
	/**
	 * @see l2.hellknight.util.network.BaseSendablePacket.ServerBasePacket#writeImpl()
	 */
	@Override
