...
public class L2SkillSiegeFlag extends L2Skill
{
	...
	/**
	 * @see l2.hellknight.gameserver.model.L2Skill#useSkill(l2.hellknight.gameserver.model.actor.L2Character, l2.hellknight.gameserver.model.L2Object[])
	 */
	@Override
	public void useSkill(L2Character activeChar, L2Object[] targets)
	{
		...
		try
		{
			...
			if (castle != null)
				...
				hall.getSiege().getAttackerClan(player.getClan()).addFlag(flag);
		}
		catch (Exception e)
		{
			player.sendMessage("Error placing flag:" + e);
