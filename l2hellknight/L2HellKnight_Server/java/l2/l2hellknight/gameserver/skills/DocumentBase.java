 ...
 */
package l2.hellknight.gameserver.skills;
...
import l2.hellknight.gameserver.skills.conditions.Condition;
import l2.hellknight.gameserver.skills.conditions.ConditionChangeWeapon;
import l2.hellknight.gameserver.skills.conditions.ConditionForceBuff;
import l2.hellknight.gameserver.skills.conditions.ConditionGameChance;
import l2.hellknight.gameserver.skills.conditions.ConditionGameTime;
import l2.hellknight.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import l2.hellknight.gameserver.skills.conditions.ConditionLogicAnd;
import l2.hellknight.gameserver.skills.conditions.ConditionLogicNot;
import l2.hellknight.gameserver.skills.conditions.ConditionLogicOr;
import l2.hellknight.gameserver.skills.conditions.ConditionMinDistance;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerActiveEffectId;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerActiveSkillId;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerAgathionId;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerCharges;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerClassIdRestriction;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerCloakStatus;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerCp;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerDMEvent;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerFlyMounted;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerGrade;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerHasCastle;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerHasClanHall;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerHasFort;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerHasPet;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerHp;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerInstanceId;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerInvSize;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerIsClanLeader;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerIsHero;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerLMEvent;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerLandingZone;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerLevel;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerLevelRange;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerMp;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerPkCount;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerPledgeClass;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerRace;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerRangeFromNpc;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerServitorNpcId;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerSex;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerSiegeSide;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerSouls;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerState;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerSubclass;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerTvTEvent;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerTvTRoundEvent;
import l2.hellknight.gameserver.skills.conditions.ConditionPlayerWeight;
import l2.hellknight.gameserver.skills.conditions.ConditionSiegeZone;
import l2.hellknight.gameserver.skills.conditions.ConditionSkillStats;
import l2.hellknight.gameserver.skills.conditions.ConditionSlotItemId;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetAbnormal;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetActiveEffectId;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetActiveSkillId;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetAggro;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetLevel;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetNpcId;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetNpcType;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetPlayable;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetRace;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetRaceId;
import l2.hellknight.gameserver.skills.conditions.ConditionTargetUsesWeaponKind;
import l2.hellknight.gameserver.skills.conditions.ConditionUsingItemType;
import l2.hellknight.gameserver.skills.conditions.ConditionUsingSkill;
import l2.hellknight.gameserver.skills.conditions.ConditionWithSkill;
import l2.hellknight.gameserver.skills.effects.EffectChanceSkillTrigger;
import l2.hellknight.gameserver.skills.funcs.FuncTemplate;
import l2.hellknight.gameserver.skills.funcs.Lambda;
import l2.hellknight.gameserver.skills.funcs.LambdaCalc;
import l2.hellknight.gameserver.skills.funcs.LambdaConst;
import l2.hellknight.gameserver.skills.funcs.LambdaStats;
import l2.hellknight.gameserver.templates.StatsSet;
import l2.hellknight.gameserver.templates.EffectTemplate;
import l2.hellknight.gameserver.templates.L2ArmorType;
import l2.hellknight.gameserver.templates.L2Item;
import l2.hellknight.gameserver.templates.L2WeaponType;
