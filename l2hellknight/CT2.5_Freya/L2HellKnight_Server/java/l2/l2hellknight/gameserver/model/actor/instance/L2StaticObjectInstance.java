...
import l2.hellknight.gameserver.model.actor.knownlist.StaticObjectKnownList;
import l2.hellknight.gameserver.model.actor.stat.StaticObjStat;
import l2.hellknight.gameserver.model.actor.status.StaticObjStatus;
import l2.hellknight.gameserver.network.serverpackets.ShowTownMap;
...
public class L2StaticObjectInstance extends L2Character
{
	...
	/* (non-Javadoc)
	 * @see l2.hellknight.gameserver.model.L2Object#isAttackable()
	 */
	@Override
