...
public class QuestItems implements IItemHandler
{
	...
	/* (non-Javadoc)
	 * @see l2.hellknight.gameserver.handler.IItemHandler#useItem(l2.hellknight.gameserver.model.actor.L2Playable, l2.hellknight.gameserver.model.L2ItemInstance)
	 */
	@Override
