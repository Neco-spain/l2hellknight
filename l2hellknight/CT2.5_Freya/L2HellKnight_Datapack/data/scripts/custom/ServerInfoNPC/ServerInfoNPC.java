...
public class ServerInfoNPC extends Quest
{
	...
	public String pageSub(int pIndex)
	{
		...
		switch (pIndex)
		{
			...
			case 6:
				...
				htmltext += "Death Match Events: <font color=\"LEVEL\">" + convBoolean(Config.DM_EVENT_ENABLED) + "</font><br>";
				htmltext += "TvT Round Events: <font color=\"LEVEL\">" + convBoolean(Config.TVT_ROUND_EVENT_ENABLED) + "</font><br>";
				htmltext += "Last Man Event: <font color=\"LEVEL\">" + convBoolean(Config.LM_EVENT_ENABLED) + "</font><br>";
				htmltext += "CTF Events: <font color=\"LEVEL\">" + convBoolean(Config.CTF_EVENT_ENABLED) + "</font><br>";
				htmltext += "Hide and Seek: <font color=\"LEVEL\">" + convBoolean(Config.ALT_HAS_ENABLE) + "</font><br>";
	...
	public String htmlPage(String op)
	{
		String texto = "";
		if (op == "Title")
			texto += "<html><body><title>L2 Hell Knight</title><center><br>" + "<b><font color=ffcc00>Server Info NPC</font></b>"
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Custom: Server Info NPC");
	}
}
