package zone_scripts.Pailaka.PailakaDevilsLegacy;
...
public class PailakaDevilsLegacy extends Quest
{
	...
	private static final int MIN_LEVEL = Config.PDL_MIN_LVL; //61
	private static final int MAX_LEVEL = Config.PDL_MAX_LVL; //67
	private static final int EXIT_TIME = Config.PDL_EXIT_TIME; //5
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Pailaka: Devils Legacy");
	}
}