package zone_scripts.GraciaContinent.SeedOfAnnihilation;
...
import l2.hellknight.gameserver.model.zone.type.L2EffectZone;
...
public class SeedOfAnnihilation extends Quest
{
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Gracia Area: Seed of Annihilation");
	}
}