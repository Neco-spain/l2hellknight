@echo off
cls
title L2 Brick - SQL Account Manager
color 0b
java -Djava.util.logging.config.file=console.cfg -cp ./../libs/*;l2brick_login.jar l2.brick.tools.accountmanager.SQLAccountManager 2> NUL
if %errorlevel% == 0 (
echo.
...
echo.
echo An error has ocurred while running the L2 Brick Account Manager!
echo.
