...
extends L2ObjectMap<T>
{
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#clear()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#put(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#remove(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#contains(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.brick.util.L2ObjectMap#iterator()
	 */
	@Override
