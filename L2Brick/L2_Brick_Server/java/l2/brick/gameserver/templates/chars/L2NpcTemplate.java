 ...
 */
package l2.brick.gameserver.templates.chars;
...
import l2.brick.gameserver.model.L2MinionData;
import l2.brick.gameserver.model.L2NpcAIData;
import l2.brick.gameserver.model.L2Skill;
import l2.brick.gameserver.model.StatsSet;
import l2.brick.gameserver.model.actor.instance.L2XmassTreeInstance;
import l2.brick.gameserver.model.base.ClassId;
import l2.brick.gameserver.model.quest.Quest;
import l2.brick.gameserver.model.quest.Quest.QuestEventType;
...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	// Skill AI
	private final FastList<L2Skill> _buffSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _negativeSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _debuffSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _atkSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _rootSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _stunskills = new FastList<L2Skill>();
	private final FastList<L2Skill> _sleepSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _paralyzeSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _fossilSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _floatSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _immobilizeSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _healSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _resSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _dotSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _cotSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _universalSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _manaSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _longRangeSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _shortRangeSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _generalSkills = new FastList<L2Skill>();
	private final FastList<L2Skill> _suicideSkills = new FastList<L2Skill>();
	 ...
	 */
	private final List<L2MinionData> _minions = new FastList<L2MinionData>();
	
	private final List<ClassId> _teachInfo = new FastList<ClassId>();
	
	private final TIntObjectHashMap<L2Skill> _skills = new TIntObjectHashMap<L2Skill>();
	
	/**
	 * Contains a list of quests for each event type (questStart, questAttack, questKill, etc).
	 */
	private final Map<QuestEventType, Quest[]> _questEvents = new FastMap<QuestEventType, Quest[]>();
	...
	{
		final List<L2DropData> list = new FastList<L2DropData>();
