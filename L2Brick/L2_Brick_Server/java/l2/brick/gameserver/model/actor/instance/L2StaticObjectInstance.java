...
import l2.brick.gameserver.model.actor.knownlist.StaticObjectKnownList;
import l2.brick.gameserver.model.actor.stat.StaticObjStat;
import l2.brick.gameserver.model.actor.status.StaticObjStatus;
import l2.brick.gameserver.model.item.L2Weapon;
import l2.brick.gameserver.model.item.instance.L2ItemInstance;
import l2.brick.gameserver.network.serverpackets.ShowTownMap;
import l2.brick.gameserver.network.serverpackets.StaticObject;
import l2.brick.gameserver.templates.chars.L2CharTemplate;
...
public class L2StaticObjectInstance extends L2Character
{
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.model.L2Object#isAttackable()
	 */
	@Override
