...
import l2.brick.gameserver.communitybbs.BB.Forum;
import l2.brick.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import l2.brick.gameserver.model.L2ContactList;
...
import l2.brick.gameserver.model.entity.CTF.BaseTeleportTask;
...
import l2.brick.gameserver.model.entity.RecoBonus;
...
import l2.brick.gameserver.model.item.L2Armor;
import l2.brick.gameserver.model.item.L2EtcItem;
...
import l2.brick.gameserver.templates.chars.L2PcTemplate;
...
import l2.brick.gameserver.util.PlayerEventStatus;
...
public final class L2PcInstance extends L2Playable
{
	...
	*/
		...
		if (killer != null)
		{
			...
			if (_inEventCTF)
			{
				if (CTF._teleport || CTF._started)
				{
					...
					{
						sendMessage("Get ready! You will be sent into battle in " + Config.CTF_REVIVE_DELAY / 1000 + " seconds!");
						
						if (_haveFlagCTF)
							removeCTFFlagOnDie();
						
						teleToLocation(CTF._teamsBaseX.get(CTF._teams.indexOf(_teamNameCTF)), CTF._teamsBaseY.get(CTF._teams.indexOf(_teamNameCTF)), CTF._teamsBaseZ.get(CTF._teams.indexOf(_teamNameCTF)), false);
						
						doRevive();
						
						ThreadPoolManager.getInstance().scheduleGeneral(new BaseTeleportTask(this, false), Config.CTF_REVIVE_DELAY);
					}
					else
					{
	...
	{
		if (L2Event.isParticipant(this) || (CTF._started && _inEventCTF) || killer == null)
			return;
	...
	public void deathPenalty(boolean atwar, boolean killed_by_pc, boolean killed_by_siege_npc)
	{
		...
		long lostExp = 0;
		if (!L2Event.isParticipant(this) && !_inEventCTF)
