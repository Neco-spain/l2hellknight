...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		Class<?>[] parameters = {int.class, Class.forName("l2.brick.gameserver.templates.chars.L2NpcTemplate")};
		_constructor = Class.forName("l2.brick.gameserver.model.actor.instance." + _template.getType() + "Instance").getConstructor(parameters);
	}
