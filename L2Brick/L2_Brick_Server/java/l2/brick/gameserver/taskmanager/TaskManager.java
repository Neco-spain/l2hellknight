 ...
 */
package l2.brick.gameserver.taskmanager;

import static l2.brick.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static l2.brick.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static l2.brick.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import l2.brick.gameserver.taskmanager.tasks.TaskBirthday;
import l2.brick.gameserver.taskmanager.tasks.TaskCleanUp;
import l2.brick.gameserver.taskmanager.tasks.TaskDailyQuestClean;
import l2.brick.gameserver.taskmanager.tasks.TaskDailySkillReuseClean;
import l2.brick.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import l2.brick.gameserver.taskmanager.tasks.TaskJython;
import l2.brick.gameserver.taskmanager.tasks.TaskOlympiadSave;
import l2.brick.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import l2.brick.gameserver.taskmanager.tasks.TaskRecom;
import l2.brick.gameserver.taskmanager.tasks.TaskRestart;
import l2.brick.gameserver.taskmanager.tasks.TaskScript;
import l2.brick.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import l2.brick.gameserver.taskmanager.tasks.TaskShutdown;
