...
:loadconfig
title L2Brick Installer - Reading Configuration from File...
cls
...
echo and reading about it. Setup and host an L2Brick server requires a
...
set cmdline=
set stage=1
title L2Brick Installer - Login Server DataBase Setup
echo.
...
:ls_err1
call :colors 47
title L2Brick Installer - Login Server DataBase Setup ERROR!
cls
echo.
...
cls
call :colors 57
title L2Brick Installer - Potential PICNIC detected at stage %stage%
echo.
...
set cmdline=
set stage=2
title L2Brick Installer - Login Server DataBase Setup - DB Creation
echo.
...
:ls_err2
call :colors 47
title L2Brick Installer - Login Server DataBase Setup - DB Creation ERROR!
cls
...
:ls_db_ok
call :colors 17
title L2Brick Installer - Login Server DataBase Setup - WARNING!
:ls_ask
cls
set loginprompt=u
echo.
...
call :colors 17
set cmdline=
title L2Brick Installer - Login Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2Brick Installer - Login Server DataBase Setup - Installing...
echo.
echo Installing new Login Server content.
echo.
) else (
title L2Brick Installer - Login Server DataBase Setup - Upgrading...
echo.
...
set cmdline=
set stage=4
title L2Brick Installer - Community Server DataBase Setup
echo.
...
:cb_err1
call :colors 47
title L2Brick Installer - Community Server DataBase Setup ERROR!
cls
echo.
echo Backup attempt failed! A possible reason for this to 
echo happen, is that your DB doesn't exist yet. I could 
...
set cmdline=
set stage=5
title L2Brick Installer - Communty Server DataBase Setup - DB Creation
echo.
...
:cb_err2
call :colors 47
title L2Brick Installer - Community Board Server DataBase Setup - DB Creation ERROR!
cls
echo An error occured while trying to create a database for 
...
:cs_db_ok
call :colors 17
title L2Brick Installer - Community Server DataBase Setup - WARNING!
:cs_ask
cls
...
call :colors 17
set cmdline=
title L2Brick Installer - Community Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2Brick Installer - Community Server DataBase Setup - Installing...
echo.
echo Installing new Community Server content.
echo.
) else (
title L2Brick Installer - Community Server DataBase Setup - Upgrading...
echo.
...
set cmdline=
set stage=7
title L2Brick Installer - Game Server DataBase Setup
cls
echo.
...
:gs_err1
call :colors 47
title L2Brick Installer - Game Server DataBase Setup - Backup ERROR!
cls
echo.
...
set stage=8
set cmdline=
title L2Brick Installer - Game Server DataBase Setup - DB Creation
cls
...
:gs_err2
call :colors 47
title L2Brick Installer - Game Server DataBase Setup - DB Creation ERROR!
cls
echo.
echo An error occured while trying to create a database for 
...
:gs_db_ok
call :colors 17
title L2Brick Installer - Game Server DataBase Setup - WARNING!
cls
:gs_ask
cls
set installtype=u
...
set stage=9
set cmdline=
title L2Brick Installer - Game Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title L2Brick Installer - Game Server DataBase Setup - Installing...
echo.
echo Installing new Game Server content.
echo.
) else (
title L2Brick Installer - Game Server DataBase Setup - Upgrading...
echo.
...
cls
call :colors 47
title L2Brick Installer - Potential DataBase Issue at stage %stage%
echo.
...
cls
call :colors 17
title L2Brick Installer - Game Server DataBase Setup - Logging Options turned on
set logging=1
if %full% == 1 (
...
:custom_ask
title L2Brick Installer - Custom Server Tables
cls
set cstprompt=n
echo.
echo L2Brick provides some "Custom Server Tables" for non-retail modifications
...
title L2Brick Installer - Custom Server Tables Process Complete
cls
echo Database structure for L2Brick Custom finished.
echo.
...
:mod_ask
title L2Brick Installer - Mod Server Tables
cls
set cstprompt=n
echo.
echo L2Brick provides a basic infraestructure for some non-retail features
echo (aka L2Brick mods) to get enabled with a minimum of changes.
echo.
...
title L2Brick Installer - Mod Server Tables Process Complete
cls
echo Database structure for L2Brick Mods finished.
echo.
echo Remember that in order to get these additions actually working 
echo you need to edit your configuration files. 
echo.
...
echo       (http://l2brick.funsite.cz/)
echo.
echo You can ask for support in our forums or irc channel:
echo irc://irc.freenode.net channel: #L2Brick
echo.
...
set dpvf="..\config\L2Brick-version.properties" 
...
:end
call :colors 17
title L2Brick Installer - Script Execution Finished
cls
echo.
echo L2Brick Database Installer 2011
echo.
echo (C) 2007-2011 L2Brick DataPack Team
...
echo visit http://l2brick.funsite.cz for more info about
echo the L2Brick DataPack Project.
echo.
pause
color