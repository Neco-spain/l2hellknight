 ...
 */
package quests.Q241_PossessorOfAPreciousSoul_1;
...
{
	private static final String _qn = "241_PossessorOfAPreciousSoul_1";
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		switch (npc.getNpcId())
		{
			case _baraham:
			{
				...
				if (ptMember != null)
				{
					QuestState st = ptMember.getQuestState(_qn);
					st.set("cond", "4");
	...
	{
		new PossessorOfAPreciousSoul1(241, _qn, "Possessor Of A Precious Soul - 1");
	}
}