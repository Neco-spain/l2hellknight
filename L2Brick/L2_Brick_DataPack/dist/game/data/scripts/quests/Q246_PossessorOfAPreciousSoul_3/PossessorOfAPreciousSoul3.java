...
public class PossessorOfAPreciousSoul3 extends Quest
{
	...
	/**
	 * 
	 * @see l2.brick.gameserver.model.quest.Quest#onAdvEvent(java.lang.String, l2.brick.gameserver.model.actor.L2Npc, l2.brick.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.brick.gameserver.model.quest.Quest#onTalk(l2.brick.gameserver.model.actor.L2Npc, l2.brick.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.brick.gameserver.model.quest.Quest#onKill(l2.brick.gameserver.model.actor.L2Npc, l2.brick.gameserver.model.actor.instance.L2PcInstance, boolean)
	 */
	@Override
		...
		switch (npcId)
		{
			case PILGRIM_OF_SPLENDOR:
				...
				if (partyMember != null)
				{
					...
					{
						if (st.getRandom(100) < CHANCE_FOR_DROP)
						{
