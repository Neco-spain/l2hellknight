package other.NpcBuffer;

import static l2.brick.gameserver.util.Util.formatAdena;
...
public class NpcBuffer extends Quest
{
    ...
    private static final String TITLE_NAME = "L2Brick Buffer";
    ...
    private String viewAllSchemeBuffs(String scheme, String page, String action)
    {
      ...
      //}
        ...
        for (int ii = 1; ii <= pc; ++ii)
            ...
            else if (action.equals("add"))    HTML_MESSAGE += "<td width=" + width + ">" + "<button value=\"" + pageName + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_1 " + scheme + " " + ii + " x\" width=" + width + " height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
            else if (action.equals("remove")) HTML_MESSAGE += "<td width=" + width + ">" + "<button value=\"" + pageName + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_2 " + scheme + " " + ii + " x\" width=" + width + " height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
            else if (DEBUG) throw new RuntimeException();
    ...
    private String viewAllBuffs(String type, String typeName, String page)
    {
      ...
      //}
        ...
        for (int ii = 1; ii <= pc; ++ii)
            if (ii == Integer.parseInt(page)) HTML_MESSAGE += "<td width=" + width + " align=center><font color=LEVEL>" + pageName + ii + "</font></td>";
            else HTML_MESSAGE += "<td width=" + width + "><button value=\"" + pageName + "" + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list " + type + " " + typeName + " " + ii + "\" width=" + width + " height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (i % 2 != 0) HTML_MESSAGE += "<BR1><table border=0 bgcolor=333333>";
            else            HTML_MESSAGE += "<BR1><table border=0 bgcolor=292929>";
            if (type.equals("set")) {
                ...
                else if (usable == 0) HTML_MESSAGE += "<button value=\"Enable\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " editSelectedBuff " + skillPos + " 1-" + page + " " + type + "\" width=80 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>";
            }
            HTML_MESSAGE += "</table>";
        }
            ...
            case "removeBuffs":
                if ((int)(System.currentTimeMillis()/1000) > st.getInt("blockUntilTime")) {
                    if (st.getQuestItemsCount(CONSUMABLE_ID) < BUFF_REMOVE_PRICE)
                        ...
                        if (TIME_OUT) addTimeout(st, 2, TIME_OUT_TIME / 2, 600);
                    }
                }
                return SMART_WINDOW ? null : rebuildMainHtml(st);
