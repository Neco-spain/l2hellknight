...
public class EventBuffer extends Functions implements ScriptFile
{
	...
	public void onLoad()
	{
		if(isActive())
		{
			_active = true;
			spawnEventManagers();
			System.out.println("Loaded Event: Event Buffer [state: activated]");
		}
		else
			System.out.println("Loaded Event: Event Buffer [state: deactivated]");
	}
	...
	public void startEvent()
	{
		...
		{
			if(ConfigSystem.getBoolean("EVENTBUFFER_SPAWN_EVENT_NPC"))
			{
				spawnEventManagers();
				System.out.println("Event 'Event Buffer' started.");
	...
	public void stopEvent()
	{
		...
		if(SetActive("EventBuffer", false))
		{
			...
			System.out.println("Event 'Event Buffer' stopped.");
	...
	public void charGroup(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_PACK_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_PACK_ITEM_COUNT"))
        {
			if(ConfigSystem.getInt("EVENTBUFFER_PACK_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
		}
		removeItem(player, ConfigSystem.getInt("EVENTBUFFER_PACK_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_PACK_ITEM_COUNT"));
			...
			{
				{
					...
					ThreadPoolManager.getInstance().scheduleGeneral(new BeginBuff(getNpc(), skill, player), +0);
				}
	...
	public void AllDanceofSongs(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_ALLDANCEOFSONGS_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_ALLDANCEOFSONGS_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_ALLDANCEOFSONGS_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
		}
		removeItem(player, ConfigSystem.getInt("EVENTBUFFER_ALLDANCEOFSONGS_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_ALLDANCEOFSONGS_ITEM_COUNT"));
	...
	public void WarriorDanceofSongs(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_WARRIORDANCEOFSONGS_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_WARRIORDANCEOFSONGS_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_WARRIORDANCEOFSONGS_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
		}
		removeItem(player, ConfigSystem.getInt("EVENTBUFFER_WARRIORDANCEOFSONGS_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_WARRIORDANCEOFSONGS_ITEM_COUNT"));
	...
	public void MageDanceofSongs(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_MAGEDANCEOFSONGS_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_MAGEDANCEOFSONGS_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_MAGEDANCEOFSONGS_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
		}
		removeItem(player, ConfigSystem.getInt("EVENTBUFFER_MAGEDANCEOFSONGS_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_MAGEDANCEOFSONGS_ITEM_COUNT"));
	...
	public void charOther(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_OTHER_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_OTHER_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_OTHER_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
...

		{
			...
			ThreadPoolManager.getInstance().scheduleGeneral(new BeginBuff(getNpc(), skill, player), +0);
			removeItem(player, ConfigSystem.getInt("EVENTBUFFER_OTHER_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_OTHER_ITEM_COUNT"));
		}
	...
	public void charDance(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_DANCE_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_DANCE_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_DANCE_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
...

		{
			...
			L2Skill skill = SkillTable.getInstance().getInfo(skill_id, skill_lvl);
			ThreadPoolManager.getInstance().scheduleGeneral(new BeginBuff(getNpc(), skill, player), +0);
			removeItem(player, ConfigSystem.getInt("EVENTBUFFER_DANCE_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_DANCE_ITEM_COUNT"));
		}
	...
	public void charSong(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_SONG_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_SONG_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_SONG_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
...

		{
			...
			L2Skill skill = SkillTable.getInstance().getInfo(skill_id, skill_lvl);
			ThreadPoolManager.getInstance().scheduleGeneral(new BeginBuff(getNpc(), skill, player), +0);
			removeItem(player, ConfigSystem.getInt("EVENTBUFFER_SONG_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_SONG_ITEM_COUNT"));
		}
	...
	public void charChant(String[] args)
	{
		...
		if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_CHANT_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_CHANT_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_CHANT_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
...

		{
			...
			L2Skill skill = SkillTable.getInstance().getInfo(skill_id, skill_lvl);
			ThreadPoolManager.getInstance().scheduleGeneral(new BeginBuff(getNpc(), skill, player), +0);
			removeItem(player, ConfigSystem.getInt("EVENTBUFFER_CHANT_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_CHANT_ITEM_COUNT"));
		}
	...
	public void heal_player()
	{
        ...
        if(getItemCount(player, ConfigSystem.getInt("EVENTBUFFER_HEAL_ITEM_ID")) < ConfigSystem.getInt("EVENTBUFFER_HEAL_ITEM_COUNT"))
		{
			if(ConfigSystem.getInt("EVENTBUFFER_HEAL_ITEM_ID") == 57)
				player.sendPacket(Msg.YOU_DO_NOT_HAVE_ENOUGH_ADENA);
			else
				player.sendPacket(Msg.INCORRECT_ITEM_COUNT);
			return;
		}
		removeItem(player, ConfigSystem.getInt("EVENTBUFFER_HEAL_ITEM_ID"), ConfigSystem.getInt("EVENTBUFFER_HEAL_ITEM_COUNT"));
			...
			{
				{
					...
					skill = SkillTable.getInstance().getInfo(buff[0], buff[1]);
					ThreadPoolManager.getInstance().scheduleGeneral(new BeginPetBuff(getNpc(), skill, pet), +0);
				}
			}
	...
	{
		if(player.isActionsDisabled() || player.isSitting() || player.getLastNpc().getNpcId() != EVENT_MANAGER_ID || player.getLastNpc().getDistance(player) > 300)
			return false;
		...
		if(player.getLevel() > ConfigSystem.getInt("EVENTBUFFER_MAX_LVL") || player.getLevel() < ConfigSystem.getInt("EVENTBUFFER_MIN_LVL"))
		{
			html = Files.read("data/scripts/events/EventBuffer/no-lvl.htm", player);
			html = html.replace("%min_lvl%", Integer.toString(ConfigSystem.getInt("EVENTBUFFER_MIN_LVL")));
			html = html.replace("%max_lvl%", Integer.toString(ConfigSystem.getInt("EVENTBUFFER_MAX_LVL")));
			show(html, player);
			return false;
		}
		return true;
	...
	public void SelectMenu(String[] args)
	{
		...
		if(select_menu == 1)
		{
			if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_PET_BUFF") != true)
				return;
	...
	public class BeginBuff implements Runnable
	{
		...
		public void run()
		{
			if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_BUFF_ANIMATION"))
			{
				_buffer.broadcastPacket(new MagicSkillUse(_buffer, _target, _skill.getDisplayId(), _skill.getLevel(), _skill.getHitTime(), 0));
				if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_SKILL_GETHITTIME"))
				{
					ThreadPoolManager.getInstance().scheduleGeneral(new EndBuff(_buffer, _skill, _target), _skill.getHitTime());
				}
				else
					ThreadPoolManager.getInstance().scheduleGeneral(new EndBuff(_buffer, _skill, _target), +0);
			}
			else if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_SKILL_GETHITTIME"))
			{
				ThreadPoolManager.getInstance().scheduleGeneral(new EndBuff(_buffer, _skill, _target), _skill.getHitTime());
			}
			else
		...
		public void run()
		{
			if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_BUFF_ANIMATION"))
			{
				...
				if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_SKILL_GETHITTIME"))
				{
					...
					ThreadPoolManager.getInstance().scheduleGeneral(new EndPetBuff(_buffer, _skill, _target), +0);
			}
			else if(ConfigSystem.getBoolean("EVENTBUFFER_ENABLE_SKILL_GETHITTIME"))
			{
				ThreadPoolManager.getInstance().scheduleGeneral(new EndPetBuff(_buffer, _skill, _target), _skill.getHitTime());
