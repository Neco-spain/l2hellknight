...
import quests._114_ResurrectionOfAnOldManager._114_ResurrectionOfAnOldManager;
...
public class _120_PavelsResearch extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32041-32.htm"))
		{
			...
			st.giveItems(EarPhoenix, 1, false);
			st.giveItems(ADENA_ID, 783729 + Math.round(Math.min(0, 227500 * (st.getRateQuestsReward() - 1))), true);
			st.addExpAndSp(3447315, 272615, true);
