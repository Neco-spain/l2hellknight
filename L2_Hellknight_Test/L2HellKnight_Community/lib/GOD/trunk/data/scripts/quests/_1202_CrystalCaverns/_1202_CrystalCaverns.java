package quests._1202_CrystalCaverns;
...
public class _1202_CrystalCaverns extends Quest implements ScriptFile
{
	...
	private static final int[] CRY = new int[] { BLUE_CRYSTAL, RED_CRYSTAL, CLEAR_CRYSTAL };
	...
	private static final int[] MOBLIST = new int[] { KechisCaptain1, KechisCaptain2, KechisCaptain3, BurningIris,
			FlameIris, BrimstoneIris, Spinel, ReefGolem, PlazaCaiman, ChromaticDetainee1, CrystallineUnicorn, EmeraldBoar,
			PlazaHelm };
	...
	private static final int[][] ordreOracle1 = new int[][] { { OG2, OG1, OG1, OG1 }, { OG1, OG2, OG1, OG1 },
			{ OG1, OG1, OG2, OG1 }, { OG1, OG1, OG1, OG2 } };

	private static final int[][] ordreOracle2 = new int[][] { { OG3, OG1, OG1, OG1 }, { OG1, OG3, OG1, OG1 },
			{ OG1, OG1, OG3, OG1 }, { OG1, OG1, OG1, OG3 } };

	private static final int[][] ordreOracle3 = new int[][] { { OG4, OG1, OG1, OG1 }, { OG1, OG4, OG1, OG1 },
			{ OG1, OG1, OG4, OG1 }, { OG1, OG1, OG1, OG4 } };
	...
	public class World
	{
		...
		public GArray<Integer> rewarded;
	...
	public void onLoad()
	{
		System.out.println("Loaded Quest: 1202: Crystal Caverns");
	}
	...
	{
		World world = worlds.get(qs.getPlayer().getReflection().getId());
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("meet"))
		{
			...
			st.takeItems(CRY[Rnd.get(CRY.length)], 1);
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		{
			if(st.getQuestItemsCount(BLUE_CRYSTAL) < 1 || st.getQuestItemsCount(RED_CRYSTAL) < 1 || st.getQuestItemsCount(CLEAR_CRYSTAL) < 1)
				return "needCrystal.htm";
	...
	public String onKill(L2NpcInstance npc, QuestState st)
	{
		...
		switch(world.status)
		{
			case 0:
				if(npcId == GK1)
				{
					dropItem(npc, BLUE_CORAL_KEY, 1);
					runEmerald(world);
				}
				else if(npcId == GK2)
				{
					dropItem(npc, RED_CORAL_KEY, 1);
					runSteamRoom1(world);
				}
				break;
			case 1:
			...
			case 20:
				...
				{
					for(L2NpcInstance mob : world.steamRoom1.npclist.keySet())
						if(mob != null)
							mob.decayMe();
			...
			case 21:
				...
				if(world.killedCaptains == 3)
				{
					for(L2NpcInstance mob : world.steamRoom2.npclist.keySet())
						if(mob != null)
							mob.decayMe();
			...
			case 22:
				...
				if(world.killedCaptains == 3)
				{
					for(L2NpcInstance mob : world.steamRoom3.npclist.keySet())
						if(mob != null)
							mob.decayMe();
			...
			case 23:
				...
				if(world.killedCaptains == 3)
				{
					for(L2NpcInstance mob : world.steamRoom4.npclist.keySet())
						if(mob != null)
							mob.decayMe();
	...
	private void enterInstance(L2Player player, int type)
	{
		if(player.getInventory().getCountOf(CONTAMINATED_CRYSTAL) < 1)
		{
	...
	private void runEmerald(World world)
	{
		...
		world.emeraldRoom.npclist = new HashMap<L2NpcInstance, Boolean>();
	...
	private void runSecretRoom1(World world)
	{
		...
		world.SecretRoom1.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSecretRoom2(World world)
	{
		...
		world.SecretRoom2.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSecretRoom3(World world)
	{
		...
		world.SecretRoom3.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSecretRoom4(World world)
	{
		...
		world.SecretRoom4.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSteamRoom1(World world)
	{
		...
		world.steamRoom1.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSteamRoom2(World world)
	{
		...
		world.steamRoom2.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSteamRoom3(World world)
	{
		...
		world.steamRoom3.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runSteamRoom4(World world)
	{
		...
		world.steamRoom4.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runKechi(World world)
	{
		...
		world.kechiRoom.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
	...
	private void runCoralGardenHall(World world)
	{
		...
		world.CoralGardenHall.npclist = new HashMap<L2NpcInstance, Boolean>();
		L2NpcInstance newNpc;
