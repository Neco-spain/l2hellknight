...
public class Kief extends Functions implements ScriptFile
{
	...
	public void dlf()
	{
		...
		{
			long points = 10 * dimlf * ConfigSystem.getInt("RateHbPoints");
	...
	public void lf()
	{
		...
		{
			long points = 20 * lifef * ConfigSystem.getInt("RateHbPoints");
	...
	public void clf()
	{
		...
		{
			long points = 50 * conlf * ConfigSystem.getInt("RateHbPoints");
