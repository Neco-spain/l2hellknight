...
{
	private static ScheduledThreadPoolExecutor interestPool = new ScheduledThreadPoolExecutor(Config.INTEREST_MAX_THREAD, new PriorityThreadFactory("InterestManagerPool", 4));
	static
	{
	...
	{
		return Config.INTEREST_ALT && _client != null && _client instanceof L2GameClient;
	}
