package l2rt.extensions.multilang;
...
public class CustomMessage
{
	...
	{
		File src = new File(Config.DATAPACK_ROOT, localizationDirSrc);
		...
		try
		{
			loader = new URLClassLoader(new URL[] { new File(Config.DATAPACK_ROOT, localizationDirASCII).toURI().toURL() });
