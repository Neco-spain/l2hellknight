	...
	public void run()
	{
		...
		switch(punishment)
		{
			case 0:
				...
				actor.sendMessage(new CustomMessage("l2rt.Util.IllegalAction.case0", actor));
				return;
			case 1:
				actor.sendMessage(new CustomMessage("l2rt.Util.IllegalAction.case1", actor));
				try
				{
					Thread.sleep(1000);
				}
				...
				break;
			case 2:
				actor.sendMessage(new CustomMessage("l2rt.Util.IllegalAction.case2", actor));
