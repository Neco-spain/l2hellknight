...
public class ExBasicActionList extends L2GameServerPacket
{
	private static final int[] BasicActions = { 
			...
			70, // Спуск с корабля
            71, // Парное соц действие, поклон
            72, // Парное соц действие, дай пять
            73, // Парное соц действие, танец
			74, // Tactical Sign: Star 
			75, // Tactical Sign: Heart
			76, // Tactical Sign: Moon
			77, // Tactical Sign: Cross
			78, 
			79,
			80,
			81,
	...
	*/
	...
	protected void writeImpl()
	{
		...
		writeH(0x5f);
		writeDD(activeChar.getTransformation() == 0 ? BasicActions : TransformationActions, true);
	}
}