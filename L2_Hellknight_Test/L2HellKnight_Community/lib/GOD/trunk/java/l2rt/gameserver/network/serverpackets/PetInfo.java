 ...
 * 0110: 00 00                                              ..
 *
 * rev 828	dddddddddddddddddddffffdddccccc S SdddddddddddQQQddddddddddddd
 * rev 404	dddddddddddddddddddffffdddcccccdSdSdddddddddddQQQdddddddddddddddddccddddddd
 */
public class PetInfo extends L2GameServerPacket
{
	...
	public PetInfo(L2Summon summon)
	{
		...
		switch(summon.getTemplate().getNpcId())
		{
			...
			case PetDataTable.WFENRIR_WOLF_ID:
				if(summon.getLevel() >= 70)
					type = 3;
				else if(summon.getLevel() >= 65)
					type = 2;
				else if(summon.getLevel() >= 60)
					type = 1;
				break;
		}
	}
