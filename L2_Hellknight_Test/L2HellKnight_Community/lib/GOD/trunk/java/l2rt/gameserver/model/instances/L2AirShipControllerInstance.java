...
public class L2AirShipControllerInstance extends L2NpcInstance
{
	...
	public void onBypassFeedback(L2Player player, String command)
	{
		...
		else if(command.equalsIgnoreCase("summon"))
		{
			...
			Functions.npcShoutCustomMessage(this, "l2rt.gameserver.model.instances.L2AirShipControllerInstance.AirshipSummoned");

			if(_autoDepartureTask != null)
				_autoDepartureTask.cancel(true);
			_autoDepartureTask = ThreadPoolManager.getInstance().scheduleGeneral(new AutoDepartureTask(newAirship), AUTO_DEPARTURE_TASK_DELAY);
		}
