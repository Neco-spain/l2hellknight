...
public class PailakaSongOfIceAndFire extends Quest
{
	...
	private static final int MIN_LEVEL = 36; //36
	private static final int MAX_LEVEL = 42; //42
	private static final int EXIT_TIME = 5; //5
	...
	{
		new PailakaSongOfIceAndFire(128, qn, "instances");
	}
}