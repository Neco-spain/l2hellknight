...
public class L2NpcBufferInstance extends L2Npc
{
	...
	/* (non-Javadoc)
	 * @see l2.hellknight.gameserver.model.actor.L2Npc#showChatWindow(l2.hellknight.gameserver.model.actor.instance.L2PcInstance, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.hellknight.gameserver.model.actor.L2Npc#onBypassFeedback(l2.hellknight.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
