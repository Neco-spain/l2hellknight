...
import l2.hellknight.gameserver.datatables.BuffBBSTable;
...
import l2.hellknight.gameserver.model.L2Fishing;
...
import l2.hellknight.gameserver.skills.l2skills.L2SkillSiegeFlag;
import l2.hellknight.gameserver.skills.l2skills.L2SkillSummon;
import l2.hellknight.gameserver.skills.l2skills.L2SkillTrap;
...
import l2.hellknight.gameserver.templates.item.L2Armor;
...
import l2.hellknight.gameserver.templates.item.L2Henna;
...
{
	// Character Skprivate ScheduledFuture<?> _recoBonusTask;ill SQL String Definitions:
	...
	/** Community **/
	private Map<Integer, Integer> _bbsBuff = new FastMap<Integer, Integer>();
	private Map<Integer, Integer> _bbsPetBuff = new FastMap<Integer, Integer>();	
	...
	*/
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.actor.L2Character#enableSkill(l2.hellknight.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.actor.L2Character#checkDoCastConditions(l2.hellknight.gameserver.model.L2Skill)
	 */
	@Override
	...
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			if (killer instanceof L2PcInstance && isInsideZone(L2Character.ZONE_PVP) && !isInSiege() && Config.RANK_ARENA_ENABLED)
			{
	...
	* Restore Pet's inventory items from database.
	...
	public void cactBBSBuff(int forPet)
	{
	    ...
	    for (Map.Entry<Integer, Integer> entry : ceffects.entrySet())
	    {
	      L2Skill skill = SkillTable.getInstance().getInfo(entry.getKey().intValue(), entry.getValue().intValue());
	      if (skill == null)
	        continue;
	...
	public int calcBBSBuff(int forPet)
	{
	    ...
	    for (Map.Entry<Integer, Integer> entry : ceffects.entrySet())
	    {
	      ...
	      int skillLvl = entry.getValue().intValue();
