...
class Quest (JQuest) :
	...
	if id == State.COMPLETED :
        ...
        elif id == State.CREATED and npcId == Tepios and st.getQuestItemsCount(Mark) == 1:
	    ...
	    st.giveItems(14052,1)
	    st.playSound("ItemSound.quest_finish")    
	return htmltext
       

QUEST       = Quest(697,qn,"Defend the Hall of Erosion")
