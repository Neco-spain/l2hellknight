...
import com.l2js.gameserver.model.quest.jython.QuestJython;
		...
		for (int level =1; level<100; level++)
		{
			...
			if ((templates != null) && (templates.length > 0))
			{
				for (L2NpcTemplate t: templates)
				{
					try
					{
						if ( L2Attackable.class.isAssignableFrom(Class.forName("com.l2js.gameserver.model.actor.instance."+t.type+"Instance")))
						{
