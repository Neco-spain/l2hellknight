...
import com.l2js.config.events.*;
import com.l2js.config.main.*;
import com.l2js.config.mods.*;
import com.l2js.config.network.*;
...
public class Config
{
	...
	public static final String PROJECT_NAME = "RusDev";
	...
	public static String[] getStringArray(final L2Properties properties, final String key, final String[] defaultValue,
	...
	public static int[] getIntArray(final L2Properties properties, final String key, final int[] defaultValue,
			final String separator)
	{
		final String string = getString(properties, key, null);
	...
	private static void loadFloodProtectorConfig(final L2Properties properties, final FloodProtectorConfig config,
			final String configString, final String defaultInterval)
	{
		config.FLOOD_PROTECTION_INTERVAL = Integer.parseInt(properties.getProperty(
				StringUtil.concat("FloodProtector", configString, "Interval"), defaultInterval));
		config.LOG_FLOODING = Boolean.parseBoolean(properties.getProperty(
				StringUtil.concat("FloodProtector", configString, "LogFlooding"), "False"));
		config.PUNISHMENT_LIMIT = Integer.parseInt(properties.getProperty(
				StringUtil.concat("FloodProtector", configString, "PunishmentLimit"), "0"));
		config.PUNISHMENT_TYPE = properties.getProperty(
				StringUtil.concat("FloodProtector", configString, "PunishmentType"), "none");
		config.PUNISHMENT_TIME = Integer.parseInt(properties.getProperty(
				StringUtil.concat("FloodProtector", configString, "PunishmentTime"), "0"));
	}
