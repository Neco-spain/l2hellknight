...
public class EffectDebuffInvul extends L2Effect
{
	public EffectDebuffInvul(Env env, EffectTemplate template)
	{
		super(env, template);
	}
	...
	{
		getEffected().setIsDebuffInvul(true);
		return true;
	}
	...
	public void onExit()
	{
		getEffected().setIsDebuffInvul(false);
	}
}
