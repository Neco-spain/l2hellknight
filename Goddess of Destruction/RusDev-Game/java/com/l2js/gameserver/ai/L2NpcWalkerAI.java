...
import com.l2js.gameserver.datatables.NpcWalkerRoutesTable;
import com.l2js.gameserver.model.L2CharPosition;
import com.l2js.gameserver.model.L2NpcWalkerNode;
...
public class L2NpcWalkerAI extends L2CharacterAI implements Runnable
{
	...
	{
		_log.warning("NpcWalker ID: " + getActor().getNpcId() + ": Blocked at rote position [" + _currentPos
	...
	private void checkArrived()
	{
		...
		if (getActor().isInsideRadius(destinationX, destinationY, destinationZ, 5, false, false))
		{
			...
			if (delay <= 0)
			{
				...
				if (Config.DEVELOPER)
					_log.warning("Wrong Delay Set in Npc Walker Functions = " + delay + " secs, using default delay: "
