...
import com.l2js.gameserver.model.actor.instance.L2DefenderInstance;
...
public class GeoEngine extends GeoData
{
	...
	//Public Methods
	/**
	 * @see com.l2js.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#getSpawnHeight(int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#canSeeTarget(L2Object, Point3D)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#canSeeTarget(com.l2js.gameserver.model.L2Object, com.l2js.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#canSeeTargetDebug(com.l2js.gameserver.model.actor.instance.L2PcInstance, com.l2js.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#moveCheck(int, int, int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.GeoData#addGeoDataBug(com.l2js.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
