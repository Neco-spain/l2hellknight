 ...
 */
package com.l2js.gameserver.model.itemcontainer;
...
import com.l2js.gameserver.datatables.ArmorSetsTable;
	...
	public L2ItemInstance findArrowForBow(L2Item bow)
	{
		...
		switch (bow.getItemGradeSPlus())
		{
			...
			case L2Item.CRYSTAL_R:
                                arrow = getItemByItemId(18550);
                                break; // Ohrikalkum Arrow
	...
	public L2ItemInstance findBoltForCrossBow(L2Item crossbow)
	{
		...
		switch (crossbow.getItemGradeSPlus())
		{
			...
			case L2Item.CRYSTAL_S:
				...
				break; // Shining Bolt
			case L2Item.CRYSTAL_R:
				bolt = getItemByItemId(19443);
				break; // Ohrikalkum Bolt	
		}
