...
import com.l2js.gameserver.GeoData;
import com.l2js.gameserver.GmListTable;
import com.l2js.gameserver.ItemsAutoDestroy;
import com.l2js.gameserver.LoginServerThread;
import com.l2js.gameserver.RecipeController;
import com.l2js.gameserver.SevenSigns;
import com.l2js.gameserver.SevenSignsFestival;
import com.l2js.gameserver.ThreadPoolManager;
import com.l2js.gameserver.ai.CtrlIntention;
import com.l2js.gameserver.ai.L2CharacterAI;
import com.l2js.gameserver.ai.L2PlayerAI;
import com.l2js.gameserver.ai.L2SummonAI;
import com.l2js.gameserver.cache.HtmCache;
import com.l2js.gameserver.cache.WarehouseCacheManager;
import com.l2js.gameserver.communitybbs.BB.Forum;
import com.l2js.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l2js.gameserver.communitybbs.Manager.RegionBBSManager;
import com.l2js.gameserver.datatables.*;
import com.l2js.gameserver.handler.IItemHandler;
import com.l2js.gameserver.handler.ItemHandler;
import com.l2js.gameserver.instancemanager.*;
import com.l2js.gameserver.model.*;
import com.l2js.gameserver.model.L2Skill.SkillTargetType;
import com.l2js.gameserver.model.actor.L2Attackable;
import com.l2js.gameserver.model.actor.L2Character;
import com.l2js.gameserver.model.actor.L2Decoy;
...
import com.l2js.gameserver.model.actor.L2Trap;
import com.l2js.gameserver.model.actor.L2Vehicle;
import com.l2js.gameserver.model.actor.appearance.PcAppearance;
import com.l2js.gameserver.model.actor.instance.PcInstance.PcAdmin;
import com.l2js.gameserver.model.actor.knownlist.PcKnownList;
import com.l2js.gameserver.model.actor.position.PcPosition;
import com.l2js.gameserver.model.actor.stat.PcStat;
import com.l2js.gameserver.model.actor.status.PcStatus;
import com.l2js.gameserver.model.base.ClassId;
import com.l2js.gameserver.model.base.ClassLevel;
import com.l2js.gameserver.model.base.Experience;
import com.l2js.gameserver.model.base.PlayerClass;
import com.l2js.gameserver.model.base.Race;
import com.l2js.gameserver.model.base.SubClass;
import com.l2js.gameserver.model.entity.Castle;
import com.l2js.gameserver.model.entity.Duel;
...
import com.l2js.gameserver.model.entity.L2Event;
import com.l2js.gameserver.model.entity.Siege;
...
import com.l2js.gameserver.model.itemcontainer.Inventory;
import com.l2js.gameserver.model.itemcontainer.ItemContainer;
import com.l2js.gameserver.model.itemcontainer.PcFreight;
import com.l2js.gameserver.model.itemcontainer.PcInventory;
import com.l2js.gameserver.model.itemcontainer.PcRefund;
import com.l2js.gameserver.model.itemcontainer.PcWarehouse;
import com.l2js.gameserver.model.itemcontainer.PetInventory;
import com.l2js.gameserver.model.multisell.PreparedListContainer;
import com.l2js.gameserver.model.olympiad.OlympiadGameManager;
import com.l2js.gameserver.model.olympiad.OlympiadGameTask;
...
import com.l2js.gameserver.model.restriction.GlobalRestrictions;
import com.l2js.gameserver.model.zone.type.L2BossZone;
...
import com.l2js.gameserver.network.communityserver.writepackets.WorldInfo;
import com.l2js.gameserver.network.serverpackets.*;
import com.l2js.gameserver.skills.AbnormalEffect;
import com.l2js.gameserver.skills.Env;
import com.l2js.gameserver.skills.Formulas;
import com.l2js.gameserver.skills.Stats;
import com.l2js.gameserver.skills.l2skills.L2SkillSiegeFlag;
import com.l2js.gameserver.skills.l2skills.L2SkillSummon;
import com.l2js.gameserver.skills.l2skills.L2SkillTrap;
import com.l2js.gameserver.taskmanager.AttackStanceTaskManager;
import com.l2js.gameserver.templates.chars.L2PcTemplate;
import com.l2js.gameserver.templates.effects.EffectTemplate;
import com.l2js.gameserver.templates.item.L2Armor;
import com.l2js.gameserver.templates.item.L2ArmorType;
import com.l2js.gameserver.templates.item.L2EtcItemType;
import com.l2js.gameserver.templates.item.L2Henna;
import com.l2js.gameserver.templates.item.L2Item;
import com.l2js.gameserver.templates.item.L2Weapon;
import com.l2js.gameserver.templates.item.L2WeaponType;
import com.l2js.gameserver.templates.skills.L2EffectType;
import com.l2js.gameserver.templates.skills.L2SkillType;
import com.l2js.gameserver.util.FloodProtectors;
import com.l2js.gameserver.util.Util;
import com.l2js.util.PlayerEventStatus;
...
public final class L2PcInstance extends L2Playable
{
	...
	public int getRelation(L2PcInstance target)
	{
		...
		{
			result |= RelationChanged.RELATION_INSIEGE;
			HandysBlockCheckerManager.ArenaParticipantsHolder holder = HandysBlockCheckerManager.getInstance()
	 ...
	 * {@link L2PcInstance#deleteMe(boolean)}</li> <li>Save player data into DB
	 * <BR>
	 ...
	 *            recipe books
	 * @return
	 *         <b>TRUE</b> if player has the recipe on Common or Dwarven Recipe
	...
	private void insertNewRecipeData(int recipeId, boolean isDwarf)
	{
		...
		catch (SQLException e)
		{
			if (_log.isLoggable(Level.SEVERE))
				_log.log(Level.SEVERE, "SQL exception while inserting recipe: " + recipeId + " from character "
						+ getObjectId(), e);
		}
		finally
		{
	...
	private void deleteRecipeData(int recipeId, boolean isDwarf)
	{
		...
		{
			if (_log.isLoggable(Level.SEVERE))
				_log.log(Level.SEVERE, "SQL exception while deleting recipe: " + recipeId + " from character "
						+ getObjectId(), e);
		}
		finally
		{
	...
	private void showQuestWindow(String questId, String stateId)
	{
		...
		String content = HtmCache.getInstance().getHtm(getHtmlPrefix(), path); // TODO
																				// path
																				// for
																				// quests
																				// html
	...
	public void refreshExpertisePenalty()
	{
		...
		if (getExpertiseArmorPenalty() != armorPenalty || getSkillLevel(6213) != armorPenalty)
		{
			...
			if (_expertiseArmorPenalty > 0)
				super.addSkill(SkillTable.getInstance().getInfo(6213, _expertiseArmorPenalty)); // level
																								// used
																								// to
																								// be
																								// newPenalty
		...
		if (getExpertiseWeaponPenalty() != weaponPenalty || getSkillLevel(6209) != weaponPenalty)
		{
			...
			if (_expertiseWeaponPenalty > 0)
				super.addSkill(SkillTable.getInstance().getInfo(6209, _expertiseWeaponPenalty)); // level
																									// used
																									// to
																									// be
																									// newPenalty
	...
	public void checkIfWeaponIsAllowed()
	{
		...
		for (L2Effect currenteffect : getAllEffects())
		{
			...
			if (!effectSkill.isOffensive()
					&& !(effectSkill.getTargetType() == SkillTargetType.TARGET_PARTY && effectSkill.getSkillType() == L2SkillType.BUFF))
			{
				...
				if (!effectSkill.getWeaponDependancy(this))
				{
					...
					if (Config.DEBUG)
						_log.info("   | Skill " + effectSkill.getName() + " has been disabled for (" + getName()
	...
	public void checkSShotsMatch(L2ItemInstance equipped, L2ItemInstance unequipped)
	{
		 ...
		 * (equipped == null ? true : equipped.getItem().getItemGradeSPlus() !=
		 * unequipped.getItem().getItemGradeSPlus()))
		 * {
		...
		if (item.getCount() > 0)
		{
			...
			else if (FortSiegeManager.getInstance().isCombat(item.getItemId()))
			{
				if (FortSiegeManager.getInstance().activateCombatFlag(this, item))
				{
					...
					fort.getSiege().announceToPlayer(SystemMessage.getSystemMessage(SystemMessageId.C1_ACQUIRED_THE_FLAG),
							this.getName());
				}
			}
			// Territory Ward
	...
	public L2ItemInstance addItem(String process, int itemId, long count, L2Object reference, boolean sendMessage)
	{
		if (count > 0)
		{
			...
			// Sends message to client if requested
			if (sendMessage
					&& ((!isCastingNow() && item.getItemType() == L2EtcItemType.HERB) || item.getItemType() != L2EtcItemType.HERB))
			{
				if (count > 1)
				{
															...
															// :]
			{
				...
				else
				{
					...
					ThreadPoolManager.getInstance().scheduleAi(
							new HerbTask(process, itemId, count, reference, sendMessage), _herbstask);
				}
			}
			else
			{
				...
				if (!isGM() && !_inventory.validateCapacity(0, item.isQuestItem()) && createdItem.isDropable()
					...
					dropItem("InvDrop", createdItem, null, true, false);
				...
				{
					TerritoryWard ward = TerritoryWarManager.getInstance().getTerritoryWard(
							createdItem.getItemId() - 13479);
					if (ward != null)
	...
	public void setTeleportProtection(boolean protect)
	{
		if (Config.DEVELOPER && (protect || _teleportProtectEndTime > 0))
			_log.warning(getName()
					+ ": Tele Protection "
					+ (protect ? "ON "
							+ (GameTimeController.getGameTicks() + Config.PLAYER_TELEPORT_PROTECTION
									* GameTimeController.TICKS_PER_SECOND) : "OFF") + " (currently "
					+ GameTimeController.getGameTicks() + ")");

		_teleportProtectEndTime = protect ? GameTimeController.getGameTicks() + Config.PLAYER_TELEPORT_PROTECTION
				* GameTimeController.TICKS_PER_SECOND : 0;
	}
	...
	{
		_recentFakeDeathEndTime = protect ? GameTimeController.getGameTicks() + Config.PLAYER_FAKEDEATH_UP_PROTECTION
				* GameTimeController.TICKS_PER_SECOND : 0;
	}
	...
	/**
	 * @see com.l2js.gameserver.model.actor.L2Character#enableSkill(com.l2js.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * @see com.l2js.gameserver.model.actor.L2Character#checkDoCastConditions(com.l2js.gameserver.model.L2Skill)
	 */
	@Override
		...
		switch (skill.getSkillType())
		{
			...
			case SUMMON:
			{
				if (!((L2SkillSummon) skill).isCubic()
						&& (getPet() != null || isMounted()
								|| CharSummonTable.getInstance().getPets().contains(getObjectId()) || CharSummonTable
								.getInstance().getPets().contains(getObjectId())))
				{
					if (Config.DEBUG)
	...
	public void broadcastStatusUpdate()
	{
		...
		{
			if (Config.DEBUG)
				_log.fine("Send status for party window of " + getObjectId() + "(" + getName() + ") to his party. CP: "
	 ...
	 * identified in <B>_knownPlayers</B>.
	 ...
	 * other players instead of CharInfo packet.
	 * Indeed, UserInfo packet contains PRIVATE DATA as MaxHP, STR,
	 * DEX...</B></FONT><BR>
	 * <BR>
	 */
	public final void broadcastUserInfo()
	{
		...
		if (TerritoryWarManager.getInstance().isTWInProgress()
				&& (TerritoryWarManager.getInstance().checkIsRegistered(-1, getObjectId()) || TerritoryWarManager
						.getInstance().checkIsRegistered(-1, getClan())))
		{
	 ...
	 * the Zariche,
	 * the transform Id returned will be that of the Zariche, and NOT the
	 * Buffalo.
	 * 
	...
	public boolean isWearingHeavyArmor()
	{
		...
		if (armor != null)
		{
			if ((getInventory().getPaperdollItem(Inventory.PAPERDOLL_CHEST).getItem().getBodyPart() == L2Item.SLOT_FULL_ARMOR && (L2ArmorType) armor
	 ...
	 * @see com.l2js.gameserver.model.actor.L2Playable#doDie(com.l2js.gameserver.model.actor.L2Character)
	 */
	@Override
			...
			if (dropPercent > 0 && Rnd.get(100) < dropPercent)
			{
				...
				for (L2ItemInstance itemDrop : getInventory().getItems())
				{
					...
					if (itemDrop.isShadowItem() || // Dont drop Shadow Items
							itemDrop.isTimeLimitedItem() || // Dont drop Time
															// Limited Items
							!itemDrop.isDropable() || itemDrop.getItemId() == 57 || // Adena
							itemDrop.getItem().getType2() == L2Item.TYPE2_QUEST || // Quest
																					// Items
							getPet() != null && getPet().getControlObjectId() == itemDrop.getItemId() || // Control
																											// Item
																											// of
																											// active
																											// pet
							Arrays.binarySearch(Config.KARMA_LIST_NONDROPPABLE_ITEMS, itemDrop.getItemId()) >= 0 || // Item
																													// listed
																													// in
																													// the
																													// non
																													...
																													// item
																													// list
							Arrays.binarySearch(Config.KARMA_LIST_NONDROPPABLE_PET_ITEMS, itemDrop.getItemId()) >= 0 // Item
																														// listed
																														// in
																														// the
																														// non
					...
					if (Rnd.get(100) < itemDropPercent)
					{
						...
						if (isKarmaDrop)
							_log.warning(getName() + " has karma and dropped id = " + itemDrop.getItemId()
									+ ", count = " + itemDrop.getCount());
						else
							_log.warning(getName() + " dropped id = " + itemDrop.getItemId() + ", count = "
									+ itemDrop.getCount());
	...
	public void onKillUpdatePvPKarma(L2Character target)
	{
		...
		{
			// check about wars
			if (targetPlayer.getClan() != null && getClan() != null && getClan().isAtWarWith(targetPlayer.getClanId())
			...
			if (targetPlayer.getKarma() > 0) // Target player has karma
			{
				if (Config.KARMA_AWARD_PK_KILL)
					increasePvpKills(target);
														...
														// have karma
			{
				if (Config.HITMAN_ENABLE_EVENT && Config.HITMAN_TAKE_KARMA
						&& Hitman.getInstance().exists(targetPlayer.getObjectId()))
					return;
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Calculate the Experience loss</li> <li>Set the value of
	 * _expBeforeDeath</li> <li>Set the new Experience value of the L2PcInstance
	 * and Decrease its level if necessary</li> <li>Send a Server->Client
	 * StatusUpdate packet with its new Experience</li><BR>
	 * <BR>
	 */
	public void deathPenalty(boolean atwar, boolean killed_by_pc, boolean killed_by_siege_npc)
	{
		...
		if (!L2Event.isParticipant(this))
			if (lvl < Experience.MAX_LEVEL)
				lostExp = Math.round((getStat().getExpForLevel(lvl + 1) - getStat().getExpForLevel(lvl)) * percentLost
						/ 100);
			else
				lostExp = Math.round((getStat().getExpForLevel(Experience.MAX_LEVEL) - getStat().getExpForLevel(
	...
	public void setAccessLevel(int level)
	{
		...
		else
		{
			...
			if (accessLevel == null)
			{
				...
				{
					_log.warning("Tryed to set unregistered access level " + level + " to character " + getName()
	...
	public L2AccessLevel getAccessLevel()
	{
		if (Config.EVERYBODY_HAS_ADMIN_RIGHTS)
			return AccessLevels._masterAccessLevel;
										 ...
										 * This is here because inventory etc.
										 * is loaded before access level on
										 * login, so it is not null
										 */
	...
	public void restoreEffects()
	{
		...
		try
		{
			...
			while (rset.next())
			{
				...
				final L2Skill skill = SkillTable.getInstance().getInfo(rset.getInt("skill_id"),
						rset.getInt("skill_level"));
				if (skill == null)
					continue;
	 ...
	 * L2PcInstance, check if it is not in the same party</li> <li>Check if the
	 * L2PcInstance has Karma</li> <li>If the attacker is a L2PcInstance, check
	 * if it is not in the same siege clan (Attacker, Defender)</li><BR>
	 * <BR>
	 */
	@Override
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (target instanceof L2DoorInstance)
		{
			boolean isCastle = (((L2DoorInstance) target).getCastle() != null
					&& ((L2DoorInstance) target).getCastle().getCastleId() > 0 && ((L2DoorInstance) target).getCastle()
					.getSiege().getIsInProgress());
			boolean isFort = (((L2DoorInstance) target).getFort() != null
					&& ((L2DoorInstance) target).getFort().getFortId() > 0
					&& ((L2DoorInstance) target).getFort().getSiege().getIsInProgress() && !((L2DoorInstance) target)
					.getIsCommanderDoor());
			if ((!isCastle && !isFort)
					&& (((L2DoorInstance) target).isUnlockable() && skill.getSkillType() != L2SkillType.UNLOCK))
				return false;
		}
		...
		if ((skill.getId() == 13 || skill.getId() == 299 || skill.getId() == 448)
				&& ((!SiegeManager.getInstance().checkIfOkToSummon(this, false) && !FortSiegeManager.getInstance()
		...
		switch (sklTargetType)
		{
			...
			case TARGET_CLAN: // For such skills, checkPvpSkill() is called from
								// L2Skill.getTargetList()
			case TARGET_PARTY_CLAN: // For such skills, checkPvpSkill() is
									// called from L2Skill.getTargetList()
			case TARGET_AURA:
			case TARGET_FRONT_AURA:
			case TARGET_BEHIND_AURA:
			case TARGET_GROUND:
		...
		if ((sklTargetType == SkillTargetType.TARGET_HOLY && !checkIfOkToCastSealOfRule(CastleManager.getInstance()
				.getCastle(this), false, skill))
				|| (sklTargetType == SkillTargetType.TARGET_FLAGPOLE && !checkIfOkToCastFlagDisplay(FortManager
				...
				|| (sklType == L2SkillType.SUMMON_FRIEND && !(checkSummonerStatus(this) && checkSummonTargetStatus(
						target, this))))
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			abortCast();
	...
	public boolean checkPvpSkill(L2Object target, L2Skill skill, boolean srcIsSummon)
	{
		...
		if (target != null && // target not null and
				...
				!(isInDuel() && ((L2PcInstance) target).getDuelId() == getDuelId()) && !isInsideZone(ZONE_PVP) && // Pc
																													// is
																													// not
																													// in
																													// PvP
	 ...
	 * This is only
	 * done by the calling of setActiveClass() method as that should be the only
	 * way to do so.
	 * 
	 * @param int classId
	...
	public boolean modifySubClass(int classIndex, int newClassId)
	{
		...
		try
		{
			...
			{
				_log.log(Level.WARNING, "Could not modify sub class for " + getName() + " to class index " + classIndex
						+ ": " + e.getMessage(), e);
	 ...
	 * while indexes 1-3 specifies the character's sub-classes respectively. <br>
	 * <br>
	...
	public boolean setActiveClass(int classIndex)
	{
		...
		try
		{
			...
			else
			{
				...
				{
					_log.log(Level.WARNING, "Could not switch " + getName() + "'s sub class to class index "
							+ classIndex + ": " + e.getMessage(), e);
					return false;
				}
			}
	...
	public void startWarnUserTakeBreak()
	{
		if (_taskWarnUserTakeBreak == null)
			_taskWarnUserTakeBreak = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(
					new WarnUserTakeBreak(), 7200000, 7200000);
	}
	...
	public void onPlayerEnter()
	{
		...
		if (SevenSigns.getInstance().isSealValidationPeriod() || SevenSigns.getInstance().isCompResultsPeriod())
		{
			if (!isGM()
					&& isIn7sDungeon()
					&& SevenSigns.getInstance().getPlayerCabal(getObjectId()) != SevenSigns.getInstance()
	 ...
	 * <li>Inventory contains item <li>Item owner id == this.owner id <li>It
	 * isnt pet control item while mounting pet or pet summoned <li>It isnt
	 * active enchant item <li>It isnt cursed weapon/item <li>It isnt wear item
	 * <br>
	 * 
	 * @param objectId
	 *            : item object id
	 ...
	 * position was also striped. The
	 * stripped code was moved into fishing.java. In my opinion it makes more
	 * sense for it to be there
	 * since all other skill related checks were also there. Last but not least,
	 * moving the zone check
	 * there, fixed a bug where baits would always be consumed no matter if
	 * fishing actualy took place.
	 * startFishing() now takes up 3 arguments, wich are acurately described as
	 * being the hook landing
	 * coordinates.
	 */
	...
	public void setCurrentPetSkill(L2Skill currentSkill, boolean ctrlPressed, boolean shiftPressed)
	{
		...
		if (Config.DEBUG)
			_log.info("Setting current Pet skill: " + currentSkill.getName() + " (ID: " + currentSkill.getId()
					+ ") for " + getName() + ".");
	...
	public void setQueuedSkill(L2Skill queuedSkill, boolean ctrlPressed, boolean shiftPressed)
	{
		...
		if (Config.DEBUG)
			_log.info("Setting queued skill: " + queuedSkill.getName() + " (ID: " + queuedSkill.getId() + ") for "
					+ getName() + ".");
	...
	public void startFameTask(long delay, int fameFixRate)
	{
		if (getLevel() < 40 || getClassId().level() < 2)
			return;
		if (_fameTask == null)
			_fameTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new FameTask(fameFixRate), delay,
					delay);
	}
	...
	public void startVitalityTask()
	{
		...
		{
			_vitalityTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new VitalityTask(this), 1000,
					60000);
		}
	}
	...
	public void calculateDeathPenaltyBuffLevel(L2Character killer)
	{
		if ((getKarma() > 0 || Rnd.get(1, 100) <= Config.DEATH_PENALTY_CHANCE) && !(killer instanceof L2PcInstance)
				&& !(this.isGM()) && !(this.getCharmOfLuck() && killer.isRaid()) && !isPhoenixBlessed() && !isLucky()
	...
	public static boolean checkSummonerStatus(L2PcInstance summonerChar)
	{
		...
		if (!TvTEvent.onEscapeUse(summonerChar.getObjectId()) || !DMEvent.onEscapeUse(summonerChar.getObjectId())
				|| !LMEvent.onEscapeUse(summonerChar.getObjectId()))
		{
			summonerChar
	...
	public static boolean checkSummonTargetStatus(L2Object target, L2PcInstance summonerChar)
	{
		...
		if (!TvTEvent.onEscapeUse(targetChar.getObjectId()) || !DMEvent.onEscapeUse(targetChar.getObjectId())
		...
		if (summonerChar.getInstanceId() > 0)
		{
			...
			{
				summonerChar
						.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_MAY_NOT_SUMMON_FROM_YOUR_CURRENT_LOCATION));
				return false;
			}
		}
		...
		// because currently this is not working in L2J we do not allowing
		// summoning
		if (summonerChar.isIn7sDungeon())
		{
			...
			if (SevenSigns.getInstance().isSealValidationPeriod())
			{
				...
				{
					summonerChar.sendPacket(SystemMessage.getSystemMessage(
							SystemMessageId.YOUR_TARGET_IS_IN_AN_AREA_WHICH_BLOCKS_SUMMONING));
					return false;
				}
			}
			else
	...
	public void checkItemRestriction()
	{
		for (int i = 0; i < Inventory.PAPERDOLL_TOTALSLOTS; i++)
		{
			...
			if (equippedItem != null
					&& (!equippedItem.getItem().checkCondition(this, this, false) || (isInOlympiadMode() && equippedItem
							.isOlyRestrictedItem())))
			{
	...
	protected synchronized void startFeed(int npcId)
	{
		...
		if (getPet() != null)
		{
			...
			if (!isDead())
			{
				_mountFeedTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new FeedTask(), 10000,
						10000);
			}
		}
		else if (_canFeed)
		{
			...
			SetupGauge sg = new SetupGauge(3, getCurrentFeed() * 10000 / getFeedConsume(), getMaxFeed() * 10000
					/ getFeedConsume());
			sendPacket(sg);
			if (!isDead())
			{
	...
	{
		return _canFeed ? (getCurrentFeed() < (getPetData(getMountNpcId()).getHungry_limit() / 100f * getPetLevelData(
				getMountNpcId()).getPetMaxFeed())) : false;
	}
	...
	public boolean teleportBookmarkCondition(int type)
	{
		...
		else if (this.isInWater())
		{
			...
			return false;
				...
				&& (this.isInsideZone(ZONE_SIEGE) || this.isInsideZone(ZONE_CLANHALL) || this.isInsideZone(ZONE_JAIL)
						|| this.isInsideZone(ZONE_CASTLE) || this.isInsideZone(ZONE_NOSUMMONFRIEND) || this
						.isInsideZone(ZONE_FORT)))
		{
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_CANNOT_USE_MY_TELEPORTS_TO_REACH_THIS_AREA));
			return false;
		}
		...
		try
		{
			...
			if (list != null && list.size() > 0)
			{
				...
				PreparedStatement statement2 = con
						.prepareStatement("INSERT INTO character_recipeshoplist (charId, Recipeid, Price, Pos) VALUES (?, ?, ?, ?)");
	...
	private void restoreRecipeShopList()
	{
		...
		try
		{
			con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con
					.prepareStatement("SELECT Recipeid,Price FROM character_recipeshoplist WHERE charId=? ORDER BY Pos ASC");
			statement.setInt(1, getObjectId());
			ResultSet rset = statement.executeQuery();
	...
	public boolean canMakeSocialAction()
	{
		if (getPrivateStoreType() == 0 && getActiveRequester() == null && !isAlikeDead()
				...
				&& !AttackStanceTaskManager.getInstance().getAttackStanceTask(this) && !isInOlympiadMode())
		{
			return true;
		}
		else
	...
	{
		if (TvTEvent.isPlayerParticipant(this.getObjectId()) || DMEvent.isPlayerParticipant(this.getObjectId())
