...
public class L2ClanHallManagerInstance extends L2MerchantInstance
{
		...
		else if (condition == COND_OWNER)
		{
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					if (getClanHall().getFunction(ClanHall.FUNC_TELEPORT) == null)
						...
						html.setFile(player.getHtmlPrefix(), "data/html/clanHallManager/tele"
				...
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "data/html/clanHallManager/support"
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									html.setFile(player.getHtmlPrefix(),
											"data/html/clanHallManager/functions-apply_confirmed.htm");
									if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null)
									{
										...
										{
											html.setFile(player.getHtmlPrefix(),
													"data/html/clanHallManager/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player.getHtmlPrefix(),
													"data/html/clanHallManager/functions-cancel_confirmed.htm");
											break;
										case 20:
			...
			else if (actualCommand.equalsIgnoreCase("support_back"))
			{
				...
				if (getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() == 0)
					return;
				html.setFile(player.getHtmlPrefix(),
						"data/html/clanHallManager/support" + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl()
								+ ".htm");
	...
	private void doTeleport(L2PcInstance player, int val)
	{
		...
		if (list != null)
		{
			...
			{
				if (Config.DEBUG)
					_log.warning("Teleporting player " + player.getName() + " for CH to new location: "
