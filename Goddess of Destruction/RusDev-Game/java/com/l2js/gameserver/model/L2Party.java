...
import com.l2js.gameserver.instancemanager.DuelManager;
...
import com.l2js.gameserver.model.entity.DimensionalRift;
import com.l2js.gameserver.network.SystemMessageId;
import com.l2js.gameserver.network.serverpackets.CreatureSay;
import com.l2js.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import com.l2js.gameserver.network.serverpackets.ExCloseMPCC;
import com.l2js.gameserver.network.serverpackets.ExOpenMPCC;
...
import com.l2js.gameserver.network.serverpackets.ExSetPartyLooting;
import com.l2js.gameserver.network.serverpackets.L2GameServerPacket;
import com.l2js.gameserver.network.serverpackets.PartyMemberPosition;
import com.l2js.gameserver.network.serverpackets.PartySmallWindowAdd;
import com.l2js.gameserver.network.serverpackets.PartySmallWindowAll;
import com.l2js.gameserver.network.serverpackets.PartySmallWindowDelete;
import com.l2js.gameserver.network.serverpackets.PartySmallWindowDeleteAll;
...
public class L2Party
{
	 ...
	 * @see com.l2js.gameserver.model.actor.instance.L2PcInstance#isRequestExpired()
	 */
