	...
	protected void runImpl()
	{
		...
		switch (_actionId)
		{
			...
			case 73:
				...
				//GOD 
				case 78: // tactic 1 
					activeChar.sendPacket(new ExTacticalSign(target.getObjectId(), 1)); 
					break; 
				case 79: // tactic 2 
					activeChar.sendPacket(new ExTacticalSign(target.getObjectId(), 2)); 
					break; 
				case 80: // tactic 3 
					activeChar.sendPacket(new ExTacticalSign(target.getObjectId(), 3)); 
					break; 
				case 81: // tactic 4 
					activeChar.sendPacket(new ExTacticalSign(target.getObjectId(), 4)); 
					break; 
				case 82: // tactic 1 
					activeChar.sendPacket(new ExTacticalSign(target.getObjectId(), 1)); 
					break; 
