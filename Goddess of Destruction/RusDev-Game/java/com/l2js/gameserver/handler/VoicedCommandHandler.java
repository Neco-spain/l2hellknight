...
import com.l2js.gameserver.handler.voicedcommandhandlers.*;
...
public class VoicedCommandHandler
{
	...
	private VoicedCommandHandler()
	{
		...
		if (Config.DM_ALLOW_VOICED_COMMAND)
			registerVoicedCommandHandler(new DMVoicedInfo());
		...
		if (Config.LM_ALLOW_VOICED_COMMAND)
			registerVoicedCommandHandler(new LMVoicedInfo());
		...
		_log.info("Loaded " + size() + " VoicedHandlers");
	}
