@echo off
cls
title RusDev - SQL Account Manager
color 17
java -Djava.util.logging.config.file=console.cfg -cp ./../libs/*;RusDev-login.jar com.l2js.accountmanager.SQLAccountManager 2> NUL
if %errorlevel% == 0 (
echo.
...
echo.
echo An error has ocurred while running the RusDev Account Manager!
echo.
