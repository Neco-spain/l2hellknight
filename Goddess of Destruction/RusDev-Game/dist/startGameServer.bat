...
color 0C
:start
echo Starting RusDev Game Server.
echo.
REM -------------------------------------
REM Default parameters for a basic server.
java -Djava.util.logging.manager=com.l2js.util.L2LogManager -Xms1024m -Xmx1024m -cp ./../libs/*;RusDev-game.jar com.l2js.gameserver.GameServer
REM
