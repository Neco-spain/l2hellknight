...
public abstract class Playable extends Creature
{
	...
	public void doAttack(Creature target)
	{
		...
		if((this.isSummon() || this.isPet()) && target.isPlayer() && target.getPlayer() == this.getPlayer())
		{
	...
	public void doCast(final Skill skill, final Creature target, boolean forceUse)
	{
		...
		if((this.isSummon() || this.isPet()) && skill.isOffensive() && target.isPlayer() && target.getPlayer() == this.getPlayer())
		{
	...
	public void callSkill(Skill skill, List<Creature> targets, boolean useActionSkills)
	{
		...
		if(useActionSkills && !skill.altUse() && !skill.getSkillType().equals(SkillType.BEAST_FEED))
			for(Creature target : targets)
			{
				...
				if(target.isPlayable() && target != getPet() && !((this.isSummon() || this.isPet()) && target == player))
				{
