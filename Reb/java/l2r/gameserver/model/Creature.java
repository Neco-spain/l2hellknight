...
import l2r.gameserver.network.serverpackets.MagicSkillCanceled;
...
public abstract class Creature extends GameObject
{
	...
	public void altUseSkill(Skill skill, Creature target)
	{
		...
		if(disallowSkill) {
			this.getPlayer().sendMessage(getPlayer().getLang().equals("ru") ? "Действие запрещено" : "Action is not allowed");
			return;
		}
