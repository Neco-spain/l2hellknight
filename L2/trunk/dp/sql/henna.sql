...
CREATE TABLE `henna` (
  `symbol_id` smallint(5) NOT NULL default '0',
  `symbol_name` varchar(45) default NULL,
  `dye_id` smallint(5) NOT NULL,
  `dye_amount` smallint(5) NOT NULL,
  `price` int(11) NOT NULL,
  `stat_INT` smallint(3) NOT NULL,
  `stat_STR` smallint(3) NOT NULL,
  `stat_CON` smallint(3) NOT NULL,
  `stat_MEM` smallint(3) NOT NULL,
  `stat_DEX` smallint(3) NOT NULL,
  `stat_WIT` smallint(3) NOT NULL,
