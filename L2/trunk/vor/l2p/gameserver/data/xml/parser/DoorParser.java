    ...
    throws Exception
  {
    for (Iterator iterator = rootElement.elementIterator(); iterator.hasNext(); )
    {
      ...
      if ("door".equals(doorElement.getName()))
      {
        ...
        for (Iterator i = doorElement.elementIterator(); i.hasNext(); )
        {
          ...
          } else if ("ai_params".equals(n.getName()))
          {
            ...
            for (aiParamsIterator = n.elementIterator(); aiParamsIterator.hasNext(); )
            {
        ...
        ((DoorHolder)getHolder()).addTemplate(template);
      }
    }
  }
}