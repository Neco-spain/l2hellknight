  ...
  implements Iterable<UnitMember>
{
  ...
  public static long EXPELLED_MEMBER_PENALTY = Config.CLAN_PENALTY * 60 * 60 * 1000L;
  ...
  public int createSubPledge(Player player, int pledgeType, UnitMember leader, String name)
  {
    ...
    case 100:
    case 200:
      if (getReputationScore() < Config.CLAN_CREATE_ROYAL)
      {
        player.sendPacket(Msg.THE_CLAN_REPUTATION_SCORE_IS_TOO_LOW);
        return -128;
      }
      incReputation(-Config.CLAN_CREATE_ROYAL, false, "SubunitCreate");
      break;
    case 1001:
    case 1002:
    case 2001:
    case 2002:
      if (getReputationScore() < Config.CLAN_CREATE_KNIGHT)
      {
        player.sendPacket(Msg.THE_CLAN_REPUTATION_SCORE_IS_TOO_LOW);
        return -128;
      }
      incReputation(-Config.CLAN_CREATE_KNIGHT, false, "SubunitCreate");
    }
  ...
  public int getSubPledgeLimit(int pledgeType)
  {
    ...
    {
    case 0:
      limit = Config.CLAN_MAX_MAIN0;
      break;
    case 1:
      limit = Config.CLAN_MAX_MAIN1;
      break;
    case 2:
      limit = Config.CLAN_MAX_MAIN2;
      break;
    case 3:
      limit = Config.CLAN_MAX_MAIN3;
      break;
    case 4:
      limit = Config.CLAN_MAX_MAIN4;
      break;
    case 5:
      limit = Config.CLAN_MAX_MAIN5;
      break;
    case 6:
      limit = Config.CLAN_MAX_MAIN6;
      break;
    case 7:
      limit = Config.CLAN_MAX_MAIN7;
      break;
    case 8:
      limit = Config.CLAN_MAX_MAIN8;
      break;
    case 9:
      limit = Config.CLAN_MAX_MAIN9;
      break;
    case 10:
      limit = Config.CLAN_MAX_MAIN10;
      break;
    case 11:
      limit = Config.CLAN_MAX_MAIN11;
      break;
    default:
      limit = 40;
    }
    ...
    {
    case -1:
      limit = Config.CLAN_MAX_ACADEM;
      break;
    case 100:
    case 200:
      if (getLevel() >= 11)
        limit = Config.CLAN_MAX_ROYAL_IN_LEVEL_11;
      else
        limit = Config.CLAN_MAX_ROYAL;
      break;
    case 1001:
    case 1002:
      if (getLevel() >= 9)
        limit = Config.CLAN_MAX_KNIGHT12_IN_LEVEL_9;
      else
        limit = Config.CLAN_MAX_KNIGHT12;
      break;
    case 2001:
    case 2002:
      if (getLevel() >= 10)
        limit = Config.CLAN_MAX_KNIGHT34_IN_LEVEL_10;
      else {
        limit = Config.CLAN_MAX_KNIGHT34;
      }
    }
    return limit;
  }
