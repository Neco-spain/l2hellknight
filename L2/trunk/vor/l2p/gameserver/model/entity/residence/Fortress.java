...
public class Fortress extends Residence
{
  ...
  private static final long REWARD_CYCLE = Config.FS_BLOOD_OATH_CYCLE;
  ...
  public void chanceCycle()
  {
    ...
    if (getPaidCycle() % REWARD_CYCLE == 0L)
    {
      setPaidCycle(0);
      setRewardCount(getRewardCount() + Config.FS_BLOOD_OATH_COUNT);
