  ...
  implements IAdminCommandHandler
{
  ...
  private void removeSkillsPage(Player activeChar)
  {
    ...
    for (Skill element : skills)
      replyMSG.append(new StringBuilder().append("<tr><td width=80><a action=\"bypass -h admin_remove_skill ").append(element.getId()).append("\">").append(element.getName()).append("</a></td><td width=60>").append(element.getLevel()).append("</td><td width=40>").append(element.getId()).append("</td></tr>").toString());
