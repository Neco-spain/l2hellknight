...
public final class NpcTemplate extends CharTemplate
{
  ...
  public void addSkill(Skill skill)
  {
    ...
    case 5:
      ...
      if (skill.hasEffects()) {
        for (EffectTemplate eff : skill.getEffectTemplates()) {
          ...
          {
          case 1:
            _stunSkills = ((Skill[])(Skill[])ArrayUtils.add(_stunSkills, skill));
            added = true;
            break;
          case 2:
          case 3:
          case 4:
          case 5:
            _dotSkills = ((Skill[])(Skill[])ArrayUtils.add(_dotSkills, skill));
            added = true;
          }
        }
      }
      if (added) break;
      _damageSkills = ((Skill[])(Skill[])ArrayUtils.add(_damageSkills, skill)); break;
    case 6:
    case 7:
    case 8:
    case 9:
    ...
    case 15:
    case 16:
      _debuffSkills = ((Skill[])(Skill[])ArrayUtils.add(_debuffSkills, skill));
      break;
    case 17:
      _buffSkills = ((Skill[])(Skill[])ArrayUtils.add(_buffSkills, skill));
      break;
    case 18:
      _stunSkills = ((Skill[])(Skill[])ArrayUtils.add(_stunSkills, skill));
      break;
    ...
    case 20:
    case 21:
      _healSkills = ((Skill[])(Skill[])ArrayUtils.add(_healSkills, skill));
      break;
    }
  }
