...
public class Log
{
  ...
  public static final void add(String text, String cat)
  {
    ...
    try
    {
      File file = new File(new StringBuilder().append("log/game/").append(cat != null ? cat : "_all").append(".txt").toString());
  ...
  public static final void addEvent(L2PcInstance pc, String text) {
    ...
    new File("log/game").mkdirs();
    File file = new File(new StringBuilder().append("log/game/actions_").append(filedate).append(".txt").toString());
