...
public class AdminFightCalculator
  implements IAdminCommandHandler
{
  ...
  private void handleShow(String params, L2PcInstance activeChar)
  {
    ...
    int hp1 = (int)(Formulas.calcHpRegen(npc1) * 100000.0D / npc1.getRegeneratePeriod());

    double maxHp2 = npc2.getMaxHp();
    int hp2 = (int)(Formulas.calcHpRegen(npc2) * 100000.0D / npc2.getRegeneratePeriod());
    ...
    if (tdmg2 - hp1 > 1)
      replyMSG.append("<td>" + (int)(100.0D * maxHp1 / (tdmg2 - hp1)) + " sec</td>");
    else
      replyMSG.append("<td>never</td>");
    if (tdmg1 - hp2 > 1)
      replyMSG.append("<td>" + (int)(100.0D * maxHp2 / (tdmg1 - hp2)) + " sec</td>");
    else
      replyMSG.append("<td>never</td>");
    replyMSG.append("</tr>");
    replyMSG.append("</table>");
