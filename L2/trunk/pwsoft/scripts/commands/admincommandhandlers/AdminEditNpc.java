  ...
  implements IAdminCommandHandler
{
  ...
  private void editShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      ...
      activeChar.sendAdmResultMessage(new StringBuilder().append("Updated price for ").append(item.getName()).append(" in Trade List ").append(tradeListID).toString());
  ...
  private void delShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      ...
      activeChar.sendAdmResultMessage(new StringBuilder().append("Deleted ").append(ItemTable.getInstance().getTemplate(itemID).getName()).append(" from Trade List ").append(tradeListID).toString());
      showShopList(activeChar, tradeListID, 1);
      return;
    }
  ...
  private void addShopItem(L2PcInstance activeChar, String[] args)
  {
    ...
    if (args.length > 3)
    {
      ...
      activeChar.sendAdmResultMessage(new StringBuilder().append("Added ").append(newItem.getItem().getName()).append(" to Trade List ").append(tradeList.getListId()).toString());
      showShopList(activeChar, tradeListID, 1);
      return;
    }
  ...
  private void showShop(L2PcInstance activeChar, int merchantID)
  {
    ...
    if (tradeLists == null)
    {
      activeChar.sendAdmResultMessage(new StringBuilder().append("Unknown npc template ID").append(merchantID).toString());
      return;
    }
    ...
    try
    {
      ...
      if (commandSplit.length > 4)
      {
        for (int i = 0; i < commandSplit.length - 3; i++)
          tv.append(new StringBuilder().append(" ").append(commandSplit[(i + 4)]).toString());
      }
  ...
  private void showNpcDropList(L2PcInstance activeChar, int npcId)
  {
    ...
    if (npcData == null)
    {
      activeChar.sendAdmResultMessage(new StringBuilder().append("unknown npc template id").append(npcId).toString());
      return;
    }
