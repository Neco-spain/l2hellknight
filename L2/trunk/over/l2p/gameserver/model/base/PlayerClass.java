...
public enum PlayerClass
{
  ...
  Troopier(Race.kamael, ClassType.Fighter, ClassLevel.Second), 
  ...
  private static final Set<PlayerClass> subclasseSet6;
  ...
  public final Set<PlayerClass> getAvailableSubclasses()
  {
    ...
    if ((_level == ClassLevel.Third) || (_level == ClassLevel.Fourth))
    {
      ...
      switch (1.$SwitchMap$l2p$gameserver$model$base$Race[_race.ordinal()])
      {
      case 1:
  ...
  public static boolean areClassesComportable(PlayerClass c1, PlayerClass c2)
  {
    ...
    if (((c1.isOfRace(Race.elf)) && (c2.isOfRace(Race.darkelf))) || ((c1.isOfRace(Race.darkelf)) && (c2.isOfRace(Race.elf))))
      return false;
    if ((c1 == Overlord) || (c1 == Warsmith) || (c2 == Overlord) || (c2 == Warsmith)) {
      return false;
    }
  ...
  static
  {
    ...
    subclasseSet6 = EnumSet.of(Inspector);

    subclassSetMap = new EnumMap(PlayerClass.class);

    kamaelSubclassSet = getSet(Race.kamael, ClassLevel.Third);
