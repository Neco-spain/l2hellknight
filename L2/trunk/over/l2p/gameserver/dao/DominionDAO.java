...
public class DominionDAO
{
  ...
  public void select(Dominion dominion)
  {
    ...
    try
    {
      ...
      statement = con.prepareStatement("SELECT lord_object_id, wards FROM dominion WHERE id=?");
  ...
  private void update0(Dominion dominion)
  {
    ...
    {
      con = DatabaseFactory.getInstance().getConnection();
      statement = con.prepareStatement("UPDATE dominion SET lord_object_id=?, wards=? WHERE id=?");
