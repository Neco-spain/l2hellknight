...
public class Version
{
  ...
  public Version(Class<?> c)
  {
    ...
    {
      _log.error(new StringBuilder().append("Unable to get soft information\nFile name '").append(jarName == null ? "null" : jarName.getAbsolutePath()).append("' isn't a valid jar").toString(), e);
    }
  }
