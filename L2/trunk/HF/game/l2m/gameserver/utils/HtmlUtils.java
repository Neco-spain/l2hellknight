...
public class HtmlUtils
{
  ...
  {
    return String.format("<button value=\"%s\" action=\"%s\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=%d height=%d fore=\"L2UI_CT1.Button_DF_Small\">", new Object[] { value, action, Integer.valueOf(width), Integer.valueOf(height) });
  }
}