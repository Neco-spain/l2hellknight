...
import l2m.gameserver.network.serverpackets.PledgeShowMemberListAll;
...
import l2m.gameserver.network.serverpackets.PledgeSkillListAdd;
  ...
  implements Iterable<UnitMember>
{
  ...
  public static long EXPELLED_MEMBER_PENALTY = aConfig.get("ExpelledMemberPenalty", 1440) * 60 * 1000L;
  public static long LEAVED_ALLY_PENALTY = aConfig.get("PenaltyLeaveAllinace", 1440) * 60 * 1000L;
  public static long DISSOLVED_ALLY_PENALTY = aConfig.get("PenaltyDeleteAllinance", 1440) * 60 * 1000L;
