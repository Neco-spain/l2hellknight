...
public class Bonus
{
  ...
  private double rateXp = 1.0D;
  private double rateSp = 1.0D;
  private double questRewardRate = 1.0D;
  private double questDropRate = 1.0D;
  private double dropAdena = 1.0D;
  private double dropItems = 1.0D;
  private double dropSpoil = 1.0D;
