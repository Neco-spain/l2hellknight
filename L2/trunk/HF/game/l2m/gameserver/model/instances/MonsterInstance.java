...
import l2m.gameserver.model.AggroList.HateInfo;
...
public class MonsterInstance extends NpcInstance
{
  ...
  {
    return (getTemplate().rewardExp > 0L) && (getTemplate().level <= Config.ALT_CHAMPION_TOP_LEVEL) && (getTemplate().level >= Config.ALT_CHAMPION_LOW_LEVEL);
  }
  ...
  public void rollRewards(Map.Entry<RewardType, RewardList> entry, Creature lastAttacker, Creature topDamager)
  {
    ...
    default:
      ...
      if ((getChampion() == 1) && (Config.ALT_CHAMPION_1_CHANGE_ITEM > 0.0D) && (Config.ALT_CHAMPION_1_CHANGE_ITEM > Rnd.get(100)))
        dropItem(activePlayer, Config.ALT_CHAMPION_1_ITEM, Rnd.get(1, Config.ALT_CHAMPION_1_ITEM_COUNT));
      if ((getChampion() != 2) || (Config.ALT_CHAMPION_2_CHANGE_ITEM <= 0.0D) || (Config.ALT_CHAMPION_2_CHANGE_ITEM <= Rnd.get(100)))
        break;
      dropItem(activePlayer, Config.ALT_CHAMPION_2_ITEM, Rnd.get(1, Config.ALT_CHAMPION_2_ITEM_COUNT));
    }
  }
