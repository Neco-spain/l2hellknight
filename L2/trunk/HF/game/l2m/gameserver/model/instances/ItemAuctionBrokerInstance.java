...
public final class ItemAuctionBrokerInstance extends NpcInstance
{
  ...
  {
    String filename = "itemauction/itembroker-" + val + ".htm";
    ...
    if (params[0].equals("auction"))
    {
      ...
      if (params[1].equals("cancel"))
      {
        if (params.length == 3)
        {
          ...
          ItemAuction auction = _instance.getAuction(auctionId);
          if (auction != null)
        ...
        {
          ItemAuction[] auctions = _instance.getAuctionsByBidder(player.getObjectId());
