...
import l2m.gameserver.model.base.ClassType;
import l2m.gameserver.model.base.PlayerClass;
...
import l2m.gameserver.network.serverpackets.PledgeReceiveSubPledgeCreated;
...
public final class VillageMasterInstance extends NpcInstance
{
  ...
  public void levelUpClan(Player player)
  {
    ...
    case 4:
      ...
      increaseClanLevel = true; break;
    case 5:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_6) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_6))
        break;
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_6, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 6:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_7) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_7))
        break;
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_7, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 7:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_8) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_8))
        break;
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_7, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 8:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_9) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_9) && (player.getInventory().destroyItemByItemId(9910, Config.CLAN_BLOOD_OATHS_COUNT))) {
        break;
      }
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_9, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 9:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_10) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_10) && (player.getInventory().destroyItemByItemId(9911, Config.CLAN_BLOOD_PLEDGES_COUNT))) {
        break;
      }
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_10, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 10:
      if ((clan.getReputationScore() >= Config.CLAN_LEVEL_COST_11) && (clan.getAllSize() >= Config.CLAN_LEVEL_REQUIREMENT_11) && (clan.getCastle() > 0))
        break;
      ...
      if (dominion.getLordObjectId() != player.getObjectId())
        break;
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_11, false, "LvlUpClan");
