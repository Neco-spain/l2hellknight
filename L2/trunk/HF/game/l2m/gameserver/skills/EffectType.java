...
import l2m.gameserver.skills.effects.EffectAddSkills;
import l2m.gameserver.skills.effects.EffectAgathionRes;
import l2m.gameserver.skills.effects.EffectAggression;
import l2m.gameserver.skills.effects.EffectBetray;
import l2m.gameserver.skills.effects.EffectBlessNoblesse;
import l2m.gameserver.skills.effects.EffectBlockStat;
import l2m.gameserver.skills.effects.EffectBluff;
import l2m.gameserver.skills.effects.EffectBuff;
import l2m.gameserver.skills.effects.EffectCPDamPercent;
import l2m.gameserver.skills.effects.EffectCallSkills;
import l2m.gameserver.skills.effects.EffectCharge;
import l2m.gameserver.skills.effects.EffectCharmOfCourage;
import l2m.gameserver.skills.effects.EffectCombatPointHealOverTime;
import l2m.gameserver.skills.effects.EffectConsumeSoulsOverTime;
import l2m.gameserver.skills.effects.EffectCubic;
import l2m.gameserver.skills.effects.EffectCurseOfLifeFlow;
import l2m.gameserver.skills.effects.EffectDamOverTime;
import l2m.gameserver.skills.effects.EffectDamOverTimeLethal;
import l2m.gameserver.skills.effects.EffectDebuffImmunity;
import l2m.gameserver.skills.effects.EffectDestroySummon;
import l2m.gameserver.skills.effects.EffectDisarm;
import l2m.gameserver.skills.effects.EffectDiscord;
import l2m.gameserver.skills.effects.EffectDispelEffects;
import l2m.gameserver.skills.effects.EffectEnervation;
import l2m.gameserver.skills.effects.EffectFakeDeath;
import l2m.gameserver.skills.effects.EffectFear;
import l2m.gameserver.skills.effects.EffectGrow;
import l2m.gameserver.skills.effects.EffectHPDamPercent;
import l2m.gameserver.skills.effects.EffectHate;
import l2m.gameserver.skills.effects.EffectHeal;
import l2m.gameserver.skills.effects.EffectHealBlock;
import l2m.gameserver.skills.effects.EffectHealCPPercent;
import l2m.gameserver.skills.effects.EffectHealOverTime;
import l2m.gameserver.skills.effects.EffectHealPercent;
import l2m.gameserver.skills.effects.EffectHourglass;
import l2m.gameserver.skills.effects.EffectImmobilize;
import l2m.gameserver.skills.effects.EffectInterrupt;
import l2m.gameserver.skills.effects.EffectInvisible;
import l2m.gameserver.skills.effects.EffectInvulnerable;
import l2m.gameserver.skills.effects.EffectLDManaDamOverTime;
import l2m.gameserver.skills.effects.EffectLockInventory;
import l2m.gameserver.skills.effects.EffectMPDamPercent;
import l2m.gameserver.skills.effects.EffectManaDamOverTime;
import l2m.gameserver.skills.effects.EffectManaHeal;
import l2m.gameserver.skills.effects.EffectManaHealOverTime;
import l2m.gameserver.skills.effects.EffectManaHealPercent;
import l2m.gameserver.skills.effects.EffectMeditation;
import l2m.gameserver.skills.effects.EffectMute;
import l2m.gameserver.skills.effects.EffectMuteAll;
import l2m.gameserver.skills.effects.EffectMuteAttack;
import l2m.gameserver.skills.effects.EffectMutePhisycal;
import l2m.gameserver.skills.effects.EffectNegateEffects;
import l2m.gameserver.skills.effects.EffectNegateMusic;
import l2m.gameserver.skills.effects.EffectParalyze;
import l2m.gameserver.skills.effects.EffectPetrification;
import l2m.gameserver.skills.effects.EffectRandomHate;
import l2m.gameserver.skills.effects.EffectRelax;
import l2m.gameserver.skills.effects.EffectRemoveTarget;
import l2m.gameserver.skills.effects.EffectRoot;
import l2m.gameserver.skills.effects.EffectSalvation;
import l2m.gameserver.skills.effects.EffectServitorShare;
import l2m.gameserver.skills.effects.EffectSilentMove;
import l2m.gameserver.skills.effects.EffectSleep;
import l2m.gameserver.skills.effects.EffectStun;
import l2m.gameserver.skills.effects.EffectSymbol;
import l2m.gameserver.skills.effects.EffectTemplate;
import l2m.gameserver.skills.effects.EffectTransformation;
import l2m.gameserver.skills.effects.EffectUnAggro;
