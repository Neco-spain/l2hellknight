...
public class SystemMessage extends L2GameServerPacket
{
  ...
  {
    args.add(new Arg(0, StringUtils.defaultString(text), null));
    return this;
  }

  public SystemMessage addNumber(int number)
  {
    args.add(new Arg(1, Integer.valueOf(number), null));
    return this;
  }

  public SystemMessage addNumber(long number)
  {
    args.add(new Arg(6, Long.valueOf(number), null));
    return this;
  }
  ...
  {
    args.add(new Arg(11, new Integer(id), null));
    return this;
  }

  public SystemMessage addNpcName(int id)
  {
    args.add(new Arg(2, new Integer(1000000 + id), null));
    return this;
  }

  public SystemMessage addItemName(int id)
  {
    args.add(new Arg(3, Integer.valueOf(id), null));
    return this;
  }

  public SystemMessage addZoneName(Location loc)
  {
    args.add(new Arg(7, loc, null));
    return this;
  }

  public SystemMessage addSkillName(int id, int level)
  {
    args.add(new Arg(4, new int[] { id, level }, null));
    return this;
  }

  public SystemMessage addElemntal(int type)
  {
    args.add(new Arg(9, Integer.valueOf(type), null));
    return this;
  }

  public SystemMessage addSystemString(int type)
  {
    args.add(new Arg(13, Integer.valueOf(type), null));
    return this;
  }

  public SystemMessage addInstanceName(int type)
  {
    args.add(new Arg(10, Integer.valueOf(type), null));
    return this;
  }

  public SystemMessage addFortId(int number)
  {
    args.add(new Arg(5, Integer.valueOf(number), null));
    return this;
  }
  ...
  protected final void writeImpl()
  {
    ...
    for (Arg e : args)
    {
      ...
      case 13:
        ...
        break;
      case 4:
        int[] skill = (int[])(int[])e.obj;
        writeD(skill[0]);
        writeD(skill[1]);
        break;
      case 6:
        writeQ(((Long)e.obj).longValue());
        break;
      case 7:
