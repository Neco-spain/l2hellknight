...
import l2m.gameserver.data.xml.holder.EnchantItemHolder;
...
import l2m.gameserver.network.serverpackets.ExPutEnchantTargetItemResult;
...
public class RequestExTryToPutEnchantTargetItem extends L2GameClientPacket
{
  ...
  private static void doPutOld(Player activeChar, ItemInstance itemToEnchant, ItemInstance scroll)
  {
    ...
    int ENCHANT_MAX_LEVEL = itemType == 0 ? Config.ENCHANT_MAX_WEAPON : itemType == 2 ? Config.ENCHANT_MAX_JEWELRY : Config.ENCHANT_MAX_ARMOR;
    boolean fail = false;
    switch (itemToEnchant.getItemId())
    {
    case 13539:
      if (itemToEnchant.getEnchantLevel() < Config.ENCHANT_MAX_MASTER_YOGI_STAFF) break;
      fail = true; break;
    case 21580:
      if (itemToEnchant.getEnchantLevel() < 9) break;
      fail = true; break;
    default:
      if (itemToEnchant.getEnchantLevel() < ENCHANT_MAX_LEVEL) break;
      fail = true;
    }
