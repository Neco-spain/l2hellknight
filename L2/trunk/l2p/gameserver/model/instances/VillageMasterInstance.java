...
public final class VillageMasterInstance extends NpcInstance
{
  ...
  public void levelUpClan(Player player)
  {
    ...
    case 7:
      ...
      increaseClanLevel = true; break;
    case 8:
      if ((clan.getReputationScore() < Config.CLAN_LEVEL_COST_9) || (clan.getAllSize() < Config.CLAN_LEVEL_REQUIREMENT_9) || 
        (!player.getInventory().destroyItemByItemId(9910, Config.CLAN_BLOOD_OATHS_COUNT)))
        break;
      clan.incReputation(-1 * Config.CLAN_LEVEL_COST_9, false, "LvlUpClan");
      increaseClanLevel = true; break;
    case 9:
      if ((clan.getReputationScore() < Config.CLAN_LEVEL_COST_10) || (clan.getAllSize() < Config.CLAN_LEVEL_REQUIREMENT_10) || 
        (!player.getInventory().destroyItemByItemId(9911, Config.CLAN_BLOOD_PLEDGES_COUNT)))
        break;
