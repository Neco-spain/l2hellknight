...
public final class SubClass
{
    ...
    private long _exp = Experience.LEVEL[Config.NEW_SUBCLASS_LVL];
    private int _sp = 0;
    private byte _level = Config.NEW_SUBCLASS_LVL;
    ...
    public void setLevel(byte levelValue)
    {
        ...
        else if (levelValue < Config.NEW_SUBCLASS_LVL)
            levelValue = Config.NEW_SUBCLASS_LVL;
    ...
    {
        if (getLevel() == Config.NEW_SUBCLASS_LVL)
            return;
