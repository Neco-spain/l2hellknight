...
public class Valakas extends L2AttackableAIScript implements Runnable
{
	private int i_ai0 = 0;
	private int i_ai1 = 0;
	private int i_ai2 = 0;
	...
	public Valakas(int id, String name, String descr)
	{
		...
		else
		{
			if(status == FIGHTING)
			{
				...
				startQuestTimer("1001", (long)(Config.Valakas_Wait_Time), null, null);
	...
	public String onAggroRangeEnter(L2NpcInstance npc, L2PcInstance player, boolean isPet)
	{
		...
		if (status == FIGHTING && !npc.isInvul())
		{
			getRandomSkill(npc);
		}
		else
