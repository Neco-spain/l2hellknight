    ...
    protected void attachEffect(Node n, Object template, Condition attachCond)
    {
        ...
        if (attrs.getNamedItem("time") != null)
        {
		 ...
		 if (attrs.getNamedItem("name").getNodeValue().equalsIgnoreCase("buff"))
			 ...
			 else if (1199 < time && time < 1501) time = (int)((float)time * Config.BUFF_TIME_MULTIPLIER);
			 else if (299 < time && time < 481) time = (int)((float)time * Config.SPIRIT_TIME_MULTIPLIER);
