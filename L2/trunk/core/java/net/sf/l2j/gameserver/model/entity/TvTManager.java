...
public class TvTManager
{
  ...
  public void scheduleEventStart()
  {
    try
    {
      ...
      this._task = new TvTEventStartTask(nextStartTime.getTimeInMillis());
  ...
  public void startReg()
  {
    ...
    else
    {
      ...
      this._task.setStartTime(System.currentTimeMillis() + 60000L * Config.TVT_EVENT_PARTICIPATION_TIME);
      ThreadPoolManager.getInstance().executeTask(this._task);
    }
  }
  ...
  public void startEvent()
  {
    ...
    else
    {
      ...
      this._task.setStartTime(System.currentTimeMillis() + 60000L * Config.TVT_EVENT_RUNNING_TIME);
      ThreadPoolManager.getInstance().executeTask(this._task);
    }
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      int delay = (int)Math.round((this._startTime - System.currentTimeMillis()) / 1000.0D);
