  ...
  implements IUserCommandHandler
{
  ...
  public boolean useUserCommand(int id, L2PcInstance activeChar)
  {
    ...
    if ((activeChar.isCastingNow()) || (activeChar.isMovementDisabled()) || (activeChar.isMuted()) || (activeChar.isAlikeDead()) || (activeChar.isInOlympiadMode()) || (activeChar.isAfraid()) || (activeChar.isSitting()))
    {
      return false;
    }
    ...
    activeChar.setSkillCastEndTime(10 + GameTimeController.getGameTicks() + unstuckTimer / 100);
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      try
      {
        _activeChar.teleToLocation(MapRegionTable.TeleportWhereType.Town); } catch (Throwable e) {
