...
public class L2SepulcherMonsterInstance extends L2MonsterInstance
{
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      broadcastPacket(new CreatureSay(_activeChar.getObjectId(), 0, _activeChar.getName(), "\u043F\u0440\u043E\u0441\u0442\u0438 \u043C\u0435\u043D\u044F!!"));
    }
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      broadcastPacket(new CreatureSay(_activeChar.getObjectId(), 0, _activeChar.getName(), "\u0411\u043E\u043B\u044C\u0448\u043E\u0435 \u0441\u043F\u0430\u0441\u0438\u0431\u043E \u0437\u0430 \u0441\u043F\u0430\u0441\u0435\u043D\u0438\u0435."));
      if (_victimShout != null)
      {
        _victimShout.cancel(true);
      }
