...
public final class Benom extends Quest
{
  ...
  private static final FastMap<Integer, Location> BENON_WALK_ROUTES = new FastMap();
  ...
  public Benom(int questId, String name, String descr)
  {
    ...
    long benomTeleporterSpawn = siegeDate - currentTime - 86400000L;
    long benomRaidRoomSpawn = siegeDate - currentTime - 86400000L;
  ...
  public String onAdvEvent(String event, L2NpcInstance npc, L2PcInstance player)
  {
    ...
    else if (event.equalsIgnoreCase("BenomRaidRoomSpawn"))
    {
      ...
      {
        _Benom = addSpawn(29054, 12047, -49211, -3009, 0, false, 0);
      }
      ...
      if (statusBoss == 0)
      {
        ...
        {
        case 0:
          _Benom = addSpawn(29054, 11025, -49152, -537, 0, false, 0);
          BenomIsSpawned = 1;
        ...
        startQuestTimer("BenomSpawnEffect", 100L, _Benom, null);
        startQuestTimer("BenomBossDespawn", 5400000L, _Benom, null);
      ...
      else if (event.equalsIgnoreCase("BenomSpawnEffect"))
      {
        ...
        startQuestTimer("BenomWalk", 5000L, npc, null);
        BenomWalkRouteStep = 0;
      }
      else if (event.equalsIgnoreCase("Attacking"))
      {
        FastList NumPlayers = new FastList();
        ...
        if (NumPlayers.size() > 0) {
          ...
          startQuestTimer("Attacking", 2000L, npc, player);
        } else if (NumPlayers.size() == 0) {
          startQuestTimer("BenomWalkFinish", 2000L, npc, null);
        }
      } else if (event.equalsIgnoreCase("BenomWalkFinish"))
      {
        ...
        npc.setWalking();
        BenomWalkRouteStep = 0;
        startQuestTimer("BenomWalk", 2200L, npc, null);
      }
      else if (event.equalsIgnoreCase("BenomWalk")) {
        if (BenomWalkRouteStep == 33)
        {
          BenomWalkRouteStep = 0;
          startQuestTimer("BenomWalk", 100L, npc, null);
        }
        else
        {
          startQuestTimer("Talk", 100L, npc, null);
          switch (BenomWalkRouteStep)
          {
          case 14:
            startQuestTimer("DoorOpen", 15000L, null, null);
            startQuestTimer("DoorClose", 23000L, null, null);
            break;
          case 32:
            startQuestTimer("DoorOpen", 500L, null, null);
            startQuestTimer("DoorClose", 4000L, null, null);
          }
  ...
  public String onAggroRangeEnter(L2NpcInstance npc, L2PcInstance player, boolean isPet)
  {
    ...
    startQuestTimer("Attacking", 100L, npc, player);
