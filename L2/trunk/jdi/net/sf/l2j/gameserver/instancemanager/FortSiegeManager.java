...
public class FortSiegeManager
{
  ...
  private final void load()
  {
    try
    {
      ...
      for (Fort fort : FortManager.getInstance().getForts())
      {
        ...
        _commanderSpawnList.put(Integer.valueOf(fort.getFortId()), _commanderSpawns);
        ...
        _flagList.put(Integer.valueOf(fort.getFortId()), _flagSpawns);
      }
    }
    catch (Exception e)
    {
  ...
  {
    if (_commanderSpawnList.containsKey(Integer.valueOf(_fortId))) {
      return (FastList)_commanderSpawnList.get(Integer.valueOf(_fortId));
    }
    return null;
  }
  ...
  {
    if (_flagList.containsKey(Integer.valueOf(_fortId))) {
      return (FastList)_flagList.get(Integer.valueOf(_fortId));
    }
    return null;
  }
  ...
  public class SiegeSpawn { Location _location;
    ...
    public SiegeSpawn(int fort_id, int x, int y, int z, int heading, int npc_id) { _fortId = fort_id;
