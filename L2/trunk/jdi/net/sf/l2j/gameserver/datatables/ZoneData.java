          ...
          else
          {
            try
            {
              ...
              else if (zoneShape.equals("NPoly"))
              {
                ...
                while (rset.next())
                {
                  fl_x.add(Integer.valueOf(rset.getInt("x")));
                  fl_y.add(Integer.valueOf(rset.getInt("y")));
                }
                ...
                if ((fl_x.size() == fl_y.size()) && (fl_x.size() > 2))
                {
                  ...
                  for (int i = 0; i < fl_x.size(); i++) { aX[i] = ((Integer)fl_x.get(i)).intValue(); aY[i] = ((Integer)fl_y.get(i)).intValue();
                  }
