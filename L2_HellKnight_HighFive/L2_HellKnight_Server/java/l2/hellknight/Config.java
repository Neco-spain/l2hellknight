...
public final class Config
{
    ...
    public static final String VOTEREWARD_CONFIG_FILE = "./config/ServerSetting/votereward.properties";
	...
	public static final int L2JMOD_CHAMPION_ENABLE_AURA = 0;
	...
	public static boolean RESTRICT_ZONE;
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				try
				{
					...
					RESTRICT_ZONE = Boolean.parseBoolean(CommunityBoard.getProperty("RestrictCommunityBoard", "False"));
	...
	public static boolean setParameterValue(String pName, String pValue)
	{
		...
		else if (pName.equalsIgnoreCase("RestrictCommunityBoard")) RESTRICT_ZONE = Boolean.parseBoolean(pValue);
