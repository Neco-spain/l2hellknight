...
from l2.hellknight.gameserver.model.actor.instance import L2ServitorInstance
...
def rebuildMainHtml(st) :
	...
	MAIN_HTML_MESSAGE += "<br><font color=\"303030\">L2Arcadia</font>"
