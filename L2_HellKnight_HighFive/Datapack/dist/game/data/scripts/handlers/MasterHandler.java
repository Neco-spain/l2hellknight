...
import handlers.bypasshandlers.PremiumAc;
...
import handlers.voicedcommandhandlers.CastleVCmd;
import handlers.voicedcommandhandlers.ChangePassword;
import handlers.voicedcommandhandlers.ChatAdmin;
import handlers.voicedcommandhandlers.Debug;
import handlers.voicedcommandhandlers.Hellbound;
import handlers.voicedcommandhandlers.Lang;
import handlers.voicedcommandhandlers.NoExp;
...
import handlers.voicedcommandhandlers.VotePanel;
...
import l2.hellknight.gameserver.handler.ActionShiftHandler;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] _handlers = 
	{
		...
		},
		{
			...
			(ExternalConfig.NOXPGAIN_ENABLED ? NoExp.class : null),
			(Config.TVT_ALLOW_VOICED_COMMAND ? TvTVoicedInfo.class : null),
			(ExternalConfig.TVT_ROUND_ALLOW_VOICED_COMMAND ? TvTRoundVoicedInfo.class : null),
