...
import l2.hellknight.gameserver.ItemsAutoDestroy;
...
import l2.hellknight.gameserver.ai.L2PlayerAI;
import l2.hellknight.gameserver.ai.L2SummonAI;
import l2.hellknight.gameserver.cache.HtmCache;
import l2.hellknight.gameserver.cache.WarehouseCacheManager;
import l2.hellknight.gameserver.communitybbs.BB.Forum;
import l2.hellknight.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import l2.hellknight.gameserver.datatables.ClassListData;
import l2.hellknight.gameserver.datatables.EnchantGroupsData;
import l2.hellknight.gameserver.datatables.ExperienceTable;
import l2.hellknight.gameserver.datatables.FishData;
...
import l2.hellknight.gameserver.datatables.RecipeData;
...
import l2.hellknight.gameserver.instancemanager.HandysBlockCheckerManager;
...
import l2.hellknight.gameserver.model.L2Account;
...
import l2.hellknight.gameserver.model.L2ContactList;
import l2.hellknight.gameserver.model.L2EnchantSkillLearn;
import l2.hellknight.gameserver.model.L2Macro;
import l2.hellknight.gameserver.model.L2ManufactureItem;
import l2.hellknight.gameserver.model.L2ManufactureList;
import l2.hellknight.gameserver.model.L2Object;
import l2.hellknight.gameserver.model.L2Party;
import l2.hellknight.gameserver.model.L2Party.messageType;
import l2.hellknight.gameserver.model.L2PetData;
import l2.hellknight.gameserver.model.L2PetLevelData;
import l2.hellknight.gameserver.model.L2PremiumItem;
import l2.hellknight.gameserver.model.L2Radar;
import l2.hellknight.gameserver.model.L2RecipeList;
import l2.hellknight.gameserver.model.L2Request;
...
import l2.hellknight.gameserver.model.L2UIKeysSettings;
...
import l2.hellknight.gameserver.model.MacroList;
import l2.hellknight.gameserver.model.PartyMatchRoom;
import l2.hellknight.gameserver.model.PartyMatchRoomList;
import l2.hellknight.gameserver.model.PartyMatchWaitingList;
import l2.hellknight.gameserver.model.ShortCuts;
import l2.hellknight.gameserver.model.TerritoryWard;
import l2.hellknight.gameserver.model.TimeStamp;
import l2.hellknight.gameserver.model.TradeList;
import l2.hellknight.gameserver.model.actor.L2Attackable;
import l2.hellknight.gameserver.model.actor.L2Character;
import l2.hellknight.gameserver.model.actor.L2Decoy;
...
import l2.hellknight.gameserver.model.actor.L2Vehicle;
import l2.hellknight.gameserver.model.actor.appearance.PcAppearance;
import l2.hellknight.gameserver.model.actor.knownlist.PcKnownList;
import l2.hellknight.gameserver.model.actor.position.PcPosition;
import l2.hellknight.gameserver.model.actor.stat.PcStat;
import l2.hellknight.gameserver.model.actor.status.PcStatus;
import l2.hellknight.gameserver.model.actor.templates.L2PcTemplate;
import l2.hellknight.gameserver.model.base.ClassId;
import l2.hellknight.gameserver.model.base.ClassLevel;
import l2.hellknight.gameserver.model.base.PlayerClass;
import l2.hellknight.gameserver.model.base.Race;
import l2.hellknight.gameserver.model.base.Sex;
import l2.hellknight.gameserver.model.base.SubClass;
...
import l2.hellknight.gameserver.model.fishing.L2Fish;
...
import l2.hellknight.gameserver.model.itemcontainer.PcFreight;
import l2.hellknight.gameserver.model.itemcontainer.PcInventory;
import l2.hellknight.gameserver.model.itemcontainer.PcRefund;
import l2.hellknight.gameserver.model.itemcontainer.PcWarehouse;
import l2.hellknight.gameserver.model.itemcontainer.PetInventory;
...
import l2.hellknight.gameserver.model.skills.l2skills.L2SkillSiegeFlag;
import l2.hellknight.gameserver.model.skills.l2skills.L2SkillSummon;
import l2.hellknight.gameserver.model.skills.l2skills.L2SkillTrap;
...
import l2.hellknight.gameserver.model.zone.type.L2NoRestartZone;
...
import l2.hellknight.gameserver.network.serverpackets.ExDominionWarStart;
import l2.hellknight.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import l2.hellknight.gameserver.network.serverpackets.ExFishingEnd;
...
import l2.hellknight.gameserver.network.serverpackets.ExNotifyPremiumItem;  // Add PI by pmq
...
import l2.hellknight.gameserver.network.serverpackets.ExSpawnEmitter;
...
import l2.hellknight.gameserver.network.serverpackets.ExUseSharedGroupItem;
...
import l2.hellknight.gameserver.network.serverpackets.FriendStatusPacket;
import l2.hellknight.gameserver.network.serverpackets.GameGuardQuery;
import l2.hellknight.gameserver.network.serverpackets.GetOnVehicle;
...
import l2.hellknight.gameserver.network.serverpackets.LeaveWorld;
import l2.hellknight.gameserver.network.serverpackets.MagicSkillUse;
import l2.hellknight.gameserver.network.serverpackets.NicknameChanged;
import l2.hellknight.gameserver.network.serverpackets.NpcHtmlMessage;
import l2.hellknight.gameserver.network.serverpackets.ObservationMode;
import l2.hellknight.gameserver.network.serverpackets.ObservationReturn;
import l2.hellknight.gameserver.network.serverpackets.PartySmallWindowUpdate;
import l2.hellknight.gameserver.network.serverpackets.PetInventoryUpdate;
import l2.hellknight.gameserver.network.serverpackets.PlaySound;
import l2.hellknight.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import l2.hellknight.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreListBuy;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreListSell;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreManageListSell;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import l2.hellknight.gameserver.network.serverpackets.PrivateStoreMsgSell;
import l2.hellknight.gameserver.network.serverpackets.RecipeShopMsg;
import l2.hellknight.gameserver.network.serverpackets.RecipeShopSellList;
import l2.hellknight.gameserver.network.serverpackets.RelationChanged;
import l2.hellknight.gameserver.network.serverpackets.Ride;
import l2.hellknight.gameserver.network.serverpackets.ServerClose;
import l2.hellknight.gameserver.network.serverpackets.SetupGauge;
import l2.hellknight.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import l2.hellknight.gameserver.network.serverpackets.SkillList;
import l2.hellknight.gameserver.network.serverpackets.Snoop;
...
import l2.hellknight.gameserver.network.serverpackets.TargetSelected;
import l2.hellknight.gameserver.network.serverpackets.TargetUnselected;
import l2.hellknight.gameserver.network.serverpackets.TradeDone;
import l2.hellknight.gameserver.network.serverpackets.TradeOtherDone;
import l2.hellknight.gameserver.network.serverpackets.TradeStart;
...
import l2.hellknight.gameserver.util.FloodProtectors;
import l2.hellknight.gameserver.util.PlayerEventStatus;
...
public final class L2PcInstance extends L2Playable
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		{
			if (target.isPlayer() && isPKProtected((L2PcInstance) target)) 
			{
	...
	//vote reward
	private long _lastVoteHopzone;
	private long _lastVoteTopzone;
   ...
   //vote reward
	public void setLastVoteHopzone(long lastVoteHopzone)
	{
		_lastVoteHopzone = System.currentTimeMillis();
	}
	
	public void setLastVoteTopzone(long lastVoteTopzone)
	{
		_lastVoteTopzone = System.currentTimeMillis();
	}
	...
	private List<Long> _pKsCounter = new FastList<>();
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.actor.L2Character#enableSkill(l2.hellknight.gameserver.model.skills.L2Skill)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2.hellknight.gameserver.model.actor.L2Character#checkDoCastConditions(l2.hellknight.gameserver.model.skills.L2Skill)
	 */
	@Override
	...
	{
		if (ExternalConfig.SHOP_MIN_RANGE_FROM_NPC > 0 || ExternalConfig.SHOP_MIN_RANGE_FROM_PLAYER > 0)
		{
	 ...
	 * @param killer
	 * @see l2.hellknight.gameserver.model.actor.L2Playable#doDie(l2.hellknight.gameserver.model.actor.L2Character)
	 */
	@Override
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			if (killer.isPlayer() && isInsideZone(L2Character.ZONE_PVP) && !isInSiege() && ExternalConfig.RANK_ARENA_ENABLED)
			{
				...
				if (!killIp.equals(DeathIp) || ExternalConfig.RANK_ARENA_ACCEPT_SAME_IP || !killer.isGM() && !isGM())
				{
			...
			// Rank Arena
			if (ExternalConfig.RANK_ARENA_ENABLED && killer instanceof L2PcInstance && isInsideZone(L2Character.ZONE_PVP) && !isInSiege() && !TvTEvent.isPlayerParticipant(getObjectId()) && !TvTRoundEvent.isPlayerParticipant(getObjectId()))
			{
				if(!killer.isGM() && !isGM())
				{
					ArenaLeaderboard.getInstance().onKill(killer.getObjectId(), killer.getName());
			...
			// Rank TvT
			if (ExternalConfig.RANK_TVT_ENABLED && killer instanceof L2PcInstance && TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(getObjectId()) && !TvTRoundEvent.isPlayerParticipant(getObjectId()))
			{
				if(!killer.isGM() && !isGM())
				{
	...
	public void increasePkKillsAndKarma(L2Character target)
	{
        ...
        if (ExternalConfig.L2JMOD_PUNISH_PK_PLAYER_IF_PKS_OVER > 0) {
            // Remove expired PKs
            for (final Long pKTime : _pKsCounter) {
                if (System.currentTimeMillis() - pKTime.longValue() >
                ExternalConfig.L2JMOD_PK_MONITOR_PERIOD * 1000) {
            ...
            if (_pKsCounter.size() > ExternalConfig.L2JMOD_PUNISH_PK_PLAYER_IF_PKS_OVER) {
                if ("jail".equals(ExternalConfig.L2JMOD_PK_PUNISHMENT_TYPE)) {
                    setPunishLevel(PunishLevel.JAIL,
                            (int) (ExternalConfig.L2JMOD_PK_PUNISHMENT_PERIOD / 60));
	...
	//vote reward
	public void updateLastVoteHopzone()
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
	...
	public void updateLastVoteTopzone()
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
	...
	private static L2PcInstance restore(int objectId)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			while (rset.next())
			{
				...
				player.setLastVoteHopzone(rset.getLong("lastVoteHopzone"));
				player.setLastVoteTopzone(rset.getLong("lastVoteTopzone"));
				...
				player.setgame_points(rset.getLong("game_points"));
	...
	private void storeCharBase()
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			statement.setLong(54,getgame_points());
	...
	public boolean useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (target != this && target.isPlayer() && skill.isOffensive() && isPKProtected((L2PcInstance) target)) 
		{
			setIsCastingNow(false);
			sendMessage("You cannot attack player with too low level.");
			sendPacket(ActionFailed.STATIC_PACKET);
	 ...
	 * target's lvl is above is not protected if in mutual war with attacker's
	 * clan or if in siege zone or pvp zone.
	 * 
	 * @param target attack target
	 * @return true if target is PK protected, otherwise false
	 */
	public boolean isPKProtected(L2PcInstance target) 
	{
	    if (ExternalConfig.L2JMOD_DISABLE_ATTACK_IF_LVL_DIFFERENCE_OVER > 0 && target != null) 
	    {
	        if (target.isInsideZone(L2Character.ZONE_SIEGE) 
	        	|| target.isInsideZone(L2Character.ZONE_PVP) 
	        	|| (getClan() != null && target.getClan() != null && target.getClan().isAtWarWith(getClanId()))) 
	        {
	            return false;
	        }
	        ...
	        if (target.getPvpFlag() == 0 
	        	&& target.getKarma() == 0 
	        	&& target.getLevel() + ExternalConfig.L2JMOD_DISABLE_ATTACK_IF_LVL_DIFFERENCE_OVER < getLevel()) 
	        {
	            return true;
	        }
	    }
	...
	//vote reward
	public long getLastVoteHopzone()
	{
		return _lastVoteHopzone;
	}
	
	public long getLastVoteTopzone()
	{
		return _lastVoteTopzone;
	}
	...
	/**
	 * @see l2.hellknight.gameserver.model.actor.L2Character#isMovementDisabled()
	 */
	@Override
	...
	*/
	...
	public void deacreaseSkillLevel(int id)
	{
		int nextLevel = -1;
	...
	{
		return (isSitting()) ? ExternalConfig.SHOP_MIN_RANGE_FROM_PLAYER : 0;
	}
	...
	public void setgame_points(long gamePoints)
	{
		_game_points = gamePoints;
	}
    ...
    {
     stopAdventBonusTask();
     sendPacket(new ExLoveckyMgnTimeChange(getAdventTime(), false));
    }
}
