...
import l2.hellknight.gameserver.model.L2RecipeInstance;
import l2.hellknight.gameserver.model.L2RecipeList;
import l2.hellknight.gameserver.model.L2RecipeStatInstance;
import l2.hellknight.gameserver.model.TempItem;
...
import l2.hellknight.gameserver.network.serverpackets.RecipeBookItemList;
import l2.hellknight.gameserver.network.serverpackets.RecipeItemMakeInfo;
import l2.hellknight.gameserver.network.serverpackets.RecipeShopItemInfo;
	...
	private static class RecipeItemMaker implements Runnable
	{
		...
		private void finishCrafting()
		{
			...
			else if (Rnd.get(100) < _recipeList.getSuccessRate())
			{
				...
				if (ExternalConfig.RANK_CRAFT_ENABLED && _target != _player && _recipeList.getSuccessRate() < 100)
