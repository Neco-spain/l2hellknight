...
public class SpawnTable
{
	...
	private void fillSpawnTable()
	{
		...
		{
			PreparedStatement statement = con.prepareStatement("SELECT count, npc_templateid, locx, locy, locz, randomx, randomy, heading, respawn_delay, loc_id, periodOfDay FROM spawnlist");
