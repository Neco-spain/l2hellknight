...
{
	private static Map<Integer, int[][]> SPAWN_POINTS = new FastMap<Integer, int[][]>();
	...
	static
	{
		...
		SPAWN_POINTS.put(22341, new int[][]
			{	
				{ -27136, 250938, -3523 }, { -29658, 252897, -3523 },	{ -27237, 251943, -3527 }, { -28868, 250113, -3479 }
			});
		// Keymaster
		SPAWN_POINTS.put(22361, new int[][]
			{	
				{ 14091, 250533, -1940 },	{ 15762, 252440, -2015 },	{ 19836, 256212, -2090 },	{ 21940, 254107, -2010 },	{ 17299, 252943, -2015 }
			});
		// Typhoon
		SPAWN_POINTS.put(25539, new int[][]
			{	
				{ -20641, 255370, -3235 }, { -16157, 250993, -3058 },	{ -18269, 250721, -3151 }, { -16532, 254864, -3223 },	{ -19055, 253489, -3440 }, 
				{ -9684, 254256, -3148 },  { -6209, 251924, -3189 },	{ -10547, 251359, -2929 }, { -7254, 254997, -3261 }, { -4883, 253171, -3322 }
			});
		// Mutated Elpy
		SPAWN_POINTS.put(25604, new int[][]
		{
			{ -46080, 246368, -14183 }, { -44816, 246368, -14183 }, { -44224, 247440, -14184 },
			{ -44896, 248464, -14183 }, { -46064, 248544, -14183}, { -46720, 247424, -14183 }
		});
	}
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded NPC: Random Spawn");
	}
}