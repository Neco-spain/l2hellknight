package zone_scripts.KamalokaRim;
...
public class RimKamaloka extends Quest
{
	...
	//6
	private static final int RESET_HOUR = Config.RESET_HOUR;
	//30
	private static final int RESET_MIN = Config.RESET_MIN;
	//10
	private static final int LOCK_TIME = Config.LOCK_TIME;
	//20
	private static final int DURATION = Config.DURATION;
	//5
	private static final int EMPTY_DESTROY_TIME = Config.EMPTY_DESTROY_TIME;
	//10
	private static final int EXIT_TIME = Config.EXIT_TIME;
	//5
	private static final int MAX_LEVEL_DIFFERENCE = Config.MAX_LEVEL_DIFFERENCE;
	//30
	private static final int RESPAWN_DELAY = Config.RESPAWN_DELAY;
	//10000
	private static final int DESPAWN_DELAY = Config.DESPAWN_DELAY;
	...
	{
		new RimKamaloka(-1, qn, "zone_scripts");
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Kamaloka: Rim Kamaloka");
	}
}
