package zone_scripts.Pailaka.PailakaSongOfIceAndFire;
...
public class PailakaSongOfIceAndFire extends Quest
{
	...
	private static final int MIN_LEVEL = Config.PSOIAF_MIN_LVL; //36
	private static final int MAX_LEVEL = Config.PSOIAF_MAX_LVL; //42
	private static final int EXIT_TIME = Config.PSOIAF_EXIT_TIME; //5
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Pailaka: Song Of Ice And Fire");
	}
}