package zone_scripts.Hellbound.Beleth;
...
public class Beleth extends L2AttackableAIScript
{
	...
	public String onAttack(L2Npc npc, L2PcInstance player, int damage, boolean isPet)
	{
		if (npc.getNpcId() == 29118 || npc.getNpcId() == 29119)
		{
			if (npc.getObjectId() == allowObjectId && !attacked)
			{
				...
				_zone.broadcastPacket(new CreatureSay(fakeBeleth.getObjectId(), 0, fakeBeleth.getName(), "Find Me !"));
			}
			if (Rnd.get(100) < 40)
				return null;
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Hellbound: Beleth");
	}
}