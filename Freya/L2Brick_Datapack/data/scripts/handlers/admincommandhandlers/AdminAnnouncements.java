...
import l2.brick.gameserver.taskmanager.AutoAnnounceTaskManager.AutoAnnouncement;
...
public class AdminAnnouncements implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_critannounce"))
		{
			...
			if (Config.GM_CRITANNOUNCER_NAME && text.length() > 0)
				text = activeChar.getName() + ": " + text;
			
			CreatureSay cs = new CreatureSay(activeChar.getObjectId(), Say2.CRITICAL_ANNOUNCE, "", text);
