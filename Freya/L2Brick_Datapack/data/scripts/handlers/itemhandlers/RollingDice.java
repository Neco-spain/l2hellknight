...
public class RollingDice implements IItemHandler
{
	...
	public void useItem(L2Playable playable, L2ItemInstance item, boolean forceUse)
	{
		...
		if (itemId == 4625 || itemId == 4626 || itemId == 4627 || itemId == 4628)
		{
			...
			Scenkos.toSelfAndKnownPlayers(activeChar, new Dice(activeChar.getObjectId(), item.getItemId(), number, activeChar.getX() - 30, activeChar.getY() - 30, activeChar.getZ()));
			...
			if (activeChar.isInsideZone(L2Character.ZONE_PEACE))
				Scenkos.toKnownPlayers(activeChar, sm);
