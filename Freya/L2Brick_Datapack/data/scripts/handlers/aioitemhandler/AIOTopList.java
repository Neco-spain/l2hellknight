...
public class AIOTopList implements IAIOItemHandler
{
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.handler.IAIOItemHandler#getBypass()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2.brick.gameserver.handler.IAIOItemHandler#onBypassUse(l2.brick.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
