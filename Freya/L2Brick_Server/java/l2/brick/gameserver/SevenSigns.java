...
import l2.brick.gameserver.model.AutoSpawnHandler.AutoSpawnInstance;
import l2.brick.gameserver.model.L2World;
import l2.brick.gameserver.model.actor.instance.L2PcInstance;
import l2.brick.gameserver.model.entity.Castle;
import l2.brick.gameserver.model.quest.Quest;
import l2.brick.gameserver.network.SystemMessageId;
import l2.brick.gameserver.network.serverpackets.SSQInfo;
...
public class SevenSigns
{
	...
	public static final String SEVEN_SIGNS_DATA_FILE = "config/InGameEvents/feature.properties";
	...
	public void giveCPMult(int StrifeOwner)
	{
		...
		for (L2PcInstance character : L2World.getInstance().getAllPlayersArray())
		{
			if (character == null)
				continue;
