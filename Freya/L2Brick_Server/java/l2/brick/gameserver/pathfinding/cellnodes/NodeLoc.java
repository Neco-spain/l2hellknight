 ...
 */
package l2.brick.gameserver.pathfinding.cellnodes;
...
public class NodeLoc extends AbstractNodeLoc
{
	...
	/**
	 * @see l2.brick.gameserver.pathfinding.AbstractNodeLoc#getX()
	 */
	@Override
	public int getX()
	{
	...
	/**
	 * @see l2.brick.gameserver.pathfinding.AbstractNodeLoc#getY()
	 */
	@Override
	public int getY()
	{
	...
	/**
	 * @see l2.brick.gameserver.pathfinding.AbstractNodeLoc#getZ()
	 */
	@Override
	public short getZ()
	{
	...
	/**
	 * @see l2.brick.gameserver.pathfinding.AbstractNodeLoc#getNodeX()
	 */
	@Override
	public int getNodeX()
	{
	...
	/**
	 * @see l2.brick.gameserver.pathfinding.AbstractNodeLoc#getNodeY()
	 */
	@Override
	public int getNodeY()
	{
