...
import l2.brick.gameserver.model.zone.type.L2DerbyTrackZone;
import l2.brick.gameserver.model.zone.type.L2PeaceZone;
			...
			//synchronized (_visibleObjects)
			{
				for(L2Object o: vObj)
				{
					if (o instanceof L2Attackable)
					{
						...
						if (mob.hasAI())
						{
							mob.getAI().setIntention(l2.brick.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
