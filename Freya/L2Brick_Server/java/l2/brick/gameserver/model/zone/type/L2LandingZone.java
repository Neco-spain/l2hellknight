...
public class L2LandingZone extends L2ZoneType
{
	...
	/**
	 * @see l2.brick.gameserver.model.zone.L2ZoneType#onDieInside(l2.brick.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see l2.brick.gameserver.model.zone.L2ZoneType#onReviveInside(l2.brick.gameserver.model.actor.L2Character)
	 */
	@Override
