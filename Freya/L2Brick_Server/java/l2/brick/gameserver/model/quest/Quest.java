...
import l2.brick.gameserver.model.actor.instance.L2TrapInstance;
...
import l2.brick.gameserver.network.serverpackets.NpcQuestHtmlMessage;
import l2.brick.gameserver.scripting.ManagedScript;
import l2.brick.gameserver.scripting.ScriptManager;
...
public class Quest extends ManagedScript
{
	...
	public static enum QuestEventType
	{
		...
		ON_ITEM_USE(true); // when player uses an item
