...
import l2.brick.gameserver.MonsterRace;
...
import l2.brick.gameserver.model.actor.knownlist.RaceManagerKnownList;
import l2.brick.gameserver.network.SystemMessageId;
import l2.brick.gameserver.network.serverpackets.ActionFailed;
import l2.brick.gameserver.network.serverpackets.DeleteObject;
...
import l2.brick.gameserver.network.serverpackets.MonRaceInfo;
...
public class L2RaceManagerInstance extends L2Npc
{
	...
	protected void broadcast(L2GameServerPacket pkt)
	{
		...
		{
			if (!manager.isDead()) Scenkos.toKnownPlayers(manager, pkt);
		}
	}
