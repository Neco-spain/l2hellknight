...
import l2.brick.gameserver.model.multisell.Entry;
import l2.brick.gameserver.model.multisell.Ingredient;
import l2.brick.gameserver.model.multisell.ListContainer;
...
import l2.brick.gameserver.network.serverpackets.MultiSellList;
	...
	public final void separateAndSend(int listId, L2PcInstance player, L2Npc npc, boolean inventoryOnly)
	{
		...
		if (template == null)
		{
			if(player.isUsingAIOItemMultisell())
				_log.warning("AIOItem [MultiSell]: Cannot find list: "+listId);
			else
