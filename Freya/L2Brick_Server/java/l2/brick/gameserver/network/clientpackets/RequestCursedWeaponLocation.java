...
import l2.brick.gameserver.model.CursedWeapon;
import l2.brick.gameserver.model.actor.L2Character;
import l2.brick.gameserver.network.serverpackets.ExCursedWeaponLocation;
import l2.brick.gameserver.network.serverpackets.ExCursedWeaponLocation.CursedWeaponInfo;
...
public final class RequestCursedWeaponLocation extends L2GameClientPacket
{
	...
	/**
	 * @see l2.brick.util.network.BaseRecievePacket.ClientBasePacket#runImpl()
	 */
	@Override
