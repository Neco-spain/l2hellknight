...
public final class SystemMessageId
{
	...
	/**
	 * ID: 3038<br>
	 * Message: You cannot mount a steed while you holding a flag.
	 * male guards do, so beware.
	 */
	public static final SystemMessageId YOU_CANNOT_MOUNT_A_STEED_WHILE_HOLDING_A_FLAG;
	...
	static
	{
		YOU_CANNOT_MOUNT_A_STEED_WHILE_HOLDING_A_FLAG = new SystemMessageId(3038);
		//Bot Button
		...
		FEMALE_GUARDS_NOTICE_BETTER_THAN_MALE = new SystemMessageId(2775);
		...
		EARNED_ITEM = new SystemMessageId(6506);
