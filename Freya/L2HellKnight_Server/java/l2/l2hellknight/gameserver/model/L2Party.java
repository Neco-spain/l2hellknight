...
import l2.hellknight.gameserver.model.entity.DimensionalRift;
import l2.hellknight.gameserver.model.entity.underground_coliseum.UCPoint;
import l2.hellknight.gameserver.model.entity.underground_coliseum.UCTeam;
import l2.hellknight.gameserver.model.entity.underground_coliseum.UCWaiting;
import l2.hellknight.gameserver.network.SystemMessageId;
import l2.hellknight.gameserver.network.serverpackets.CreatureSay;
import l2.hellknight.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import l2.hellknight.gameserver.network.serverpackets.ExCloseMPCC;
import l2.hellknight.gameserver.network.serverpackets.ExOpenMPCC;
import l2.hellknight.gameserver.network.serverpackets.ExPartyPetWindowAdd;
import l2.hellknight.gameserver.network.serverpackets.ExPartyPetWindowDelete;
import l2.hellknight.gameserver.network.serverpackets.ExSetPartyLooting;
import l2.hellknight.gameserver.network.serverpackets.L2GameServerPacket;
import l2.hellknight.gameserver.network.serverpackets.PartyMemberPosition;
import l2.hellknight.gameserver.network.serverpackets.PartySmallWindowAdd;
import l2.hellknight.gameserver.network.serverpackets.PartySmallWindowAll;
import l2.hellknight.gameserver.network.serverpackets.PartySmallWindowDelete;
import l2.hellknight.gameserver.network.serverpackets.PartySmallWindowDeleteAll;
...
public class L2Party
{
	 ...
	 * @see l2.hellknight.gameserver.model.actor.instance.L2PcInstance#isRequestExpired()
	 */
