...
import l2.hellknight.gameserver.model.zone.L2SpawnZone;
import l2.hellknight.gameserver.model.zone.L2ZoneType;
import l2.hellknight.gameserver.model.zone.form.ZoneCuboid;
import l2.hellknight.gameserver.model.zone.form.ZoneCylinder;
import l2.hellknight.gameserver.model.zone.form.ZoneNPoly;
import l2.hellknight.gameserver.model.zone.type.L2ArenaZone;
					...
					if ("list".equalsIgnoreCase(n.getNodeName()))
					{
						...
						for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
						{
							if ("zone".equalsIgnoreCase(d.getNodeName()))
							{
								...
								try
								{
									newZone = Class.forName("l2.hellknight.gameserver.model.zone.type.L2" + zoneType);
								}
