...
public class GeoEngine extends GeoData
{
	...
	//Public Methods
	/**
	 * @see l2.hellknight.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#getSpawnHeight(int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#canSeeTarget(L2Object, Point3D)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#canSeeTarget(l2.hellknight.gameserver.model.L2Object, l2.hellknight.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#canSeeTargetDebug(l2.hellknight.gameserver.model.actor.instance.L2PcInstance, l2.hellknight.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#moveCheck(int, int, int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2.hellknight.gameserver.GeoData#addGeoDataBug(l2.hellknight.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
