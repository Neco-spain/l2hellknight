...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		Class<?>[] parameters = {int.class, Class.forName("l2.hellknight.gameserver.templates.L2NpcTemplate")};
		_constructor = Class.forName("l2.hellknight.gameserver.model.actor.instance." + implementationName + "Instance").getConstructor(parameters);
	}
