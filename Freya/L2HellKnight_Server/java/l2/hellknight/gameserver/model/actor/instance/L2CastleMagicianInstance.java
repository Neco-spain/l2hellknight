...
import l2.hellknight.gameserver.datatables.SubPledgeSkillTree.SubUnitSkill;
...
public class L2CastleMagicianInstance extends L2NpcInstance implements L2SquadTrainer
{
	...
	/* (non-Javadoc)
	 * @see l2.hellknight.gameserver.model.actor.L2SquadTrainer#showSubUnitSkillList(l2.hellknight.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
