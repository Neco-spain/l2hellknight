...
public class Die extends L2GameServerPacket
{
	...
	public Die(L2Character cha)
	{
		...
		_canTeleport = !((cha instanceof L2PcInstance && ((TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(_charObjId)) || (TvTRoundEvent.isStarted() && TvTRoundEvent.isPlayerParticipant(_charObjId)))) || (LMEvent.isStarted() && LMEvent.isPlayerParticipant(_charObjId)) || (DM.isStarted() && DM.isPlayerParticipant(_charObjId)) ||cha.isPendingRevive());
