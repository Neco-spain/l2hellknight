...
@setlocal
COLOR 17
TITLE L2Brick Compiler


:: CORE & DATAPACK folders:
SET CORE_DIR=..\L2Brick_Server
SET DP_DIR=..\L2Brick_DataPack
SET CP_DIR=..\L2Brick_Community
SET L2J_UNV_ZIP_NAME=L2Brick.zip
:: EXAMPLE PATH
...
:full_pack
IF %DEBUG% == 1 GOTO fp1
IF EXIST %L2J_BRICK_ZIP_NAME% DEL %L2J_BRICK_ZIP_NAME%

IF NOT EXIST 7za.exe GOTO c1
7za.exe a %L2J_BRICK_ZIP_NAME% ..\builds\core\Core.zip ..\builds\community\L2Brick-community.zip ..\builds\datapack\DataPack.zip>NUL
GOTO fp1

:c1
IF NOT EXIST bin\7za.exe GOTO end
bin\7za.exe a %L2J_BRICK_ZIP_NAME% ..\builds\core\Core.zip ..\builds\community\L2Brick-community.zip ..\builds\datapack\DataPack.zip>NUL
GOTO fp1
