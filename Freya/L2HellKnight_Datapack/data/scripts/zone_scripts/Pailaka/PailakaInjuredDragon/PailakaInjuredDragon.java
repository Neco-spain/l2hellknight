...
public class PailakaInjuredDragon extends Quest 
{
	...
	private static final int MIN_LEVEL   = Config.PID_MIN_LVL; //73
	private static final int MAX_LEVEL   = Config.PID_MAX_LVL; //77
	private static final int MAX_SUMMON_LEVEL = Config.PID_MAX_LVL_SUMMON; //80
	private static final int EXIT_TIME   = Config.PID_EXIT_TIME; //5
	...
	public static void main(String[] args)
	{
		...
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.info("Loaded Pailaka: Injured Dragon");
	}
}
