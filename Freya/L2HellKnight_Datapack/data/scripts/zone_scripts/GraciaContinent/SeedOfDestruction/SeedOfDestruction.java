package zone_scripts.GraciaContinent.SeedOfDestruction;
...
public class SeedOfDestruction extends Quest
{
	...
	private static final int MIN_PLAYERS = Config.MINIMUM_SOD_PLAYERS;
	private static final int MAX_PLAYERS = Config.MAXIMUM_SOD_PLAYERS;
	private static final int MAX_DEVICESPAWNEDMOBCOUNT = Config.PREVENT_TO_MUCH_SPAWN_MOBS;
	private static final boolean debug = Config.TEST_SEED_OF_DESTRUCTION;
	private static final int EXIT_TIME = Config.EXIT_TIME_SOD; //exit time
	...
	private static final int[][] SQUARE_SPAWNS_STATIC = {
		{ 18776, -245729, 217075, -12208, 0 }, { 32528, -246367, 216720, -12231, 0 },
		{ 32601, -245820, 220921, -12091, 0 }
	};
	private static final int[][] FORT_PORTALS = {
		{ 18696,-251079,209589,-11965,16384}, { 18696,-249728,209585,-11965,16384}
	};
	private static final int[][] THRONE_PORTALS = {
		{ 18696,-248776,209587,-11965,16384}, { 18696,-248784,206331,-11967,16384},
		{ 18696,-252021,206328,-11965,16384}, { 18696,-252028,209584,-11965,16384}
	};
	...
	protected void spawnState(SODWorld world)
	{
		...
		switch(world.status)
		{
			case 0:
				...
				break;
			case 1:
				ExShowScreenMessage message1 = new ExShowScreenMessage(1,0,5,0,1,0,0,false,10000,1,"Kill them all in one! Nobody is allowed to survive!");
			...
			case 3:
				...
				return;
			case 4:
				ExShowScreenMessage message2 = new ExShowScreenMessage(1,0,5,0,1,0,0,false,10000,1,"Obelisk below and we trapped, we have killed. To them !!!!!");
		...
		if (tmpworld instanceof SODWorld)
		{
			...
			else if (world.status <= 8 && npc.getNpcId() == TIADA)
			{
				if (npc.getCurrentHp() < (npc.getMaxHp() / 2))
				{
					if (_numAtk < 1)
					{
						ExShowScreenMessage message3 = new ExShowScreenMessage(1,0,5,0,1,0,0,false,10000,1,"Attention! Enemy. not destroyed at PORTALS!!");
	...
	{
		new SeedOfDestruction(-1,qn,"zone_scripts/GraciaContinent");
		if (Config.ENABLE_LOADING_INFO_FOR_SCRIPTS)
			_log.config("Loaded Gracia Area: Seed Of Destruction");
	}
}